...
type Consent struct {
	...
	AdUserData enums.ConsentStatusEnum_ConsentStatus `protobuf:"varint,1,opt,name=ad_user_data,json=adUserData,proto3,enum=google.ads.googleads.v25.enums.ConsentStatusEnum_ConsentStatus" json:"ad_user_data,omitempty"`
	// This represents consent for ad personalization.
	// This can only be set for OfflineUserDataJobService and UserDataService.
	AdPersonalization enums.ConsentStatusEnum_ConsentStatus `protobuf:"varint,2,opt,name=ad_personalization,json=adPersonalization,proto3,enum=google.ads.googleads.v25.enums.ConsentStatusEnum_ConsentStatus" json:"ad_personalization,omitempty"`
...
var file_common_consent_proto_rawDesc = string([]byte{
	...
	0x32, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x43, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x74,
	...
	0x73, 0x2e, 0x76, 0x32, 0x35, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x42, 0x0c, 0x43, 0x6f,
...
var file_common_consent_proto_goTypes = []any{
	(*Consent)(nil), // 0: google.ads.googleads.v25.common.Consent
	(enums.ConsentStatusEnum_ConsentStatus)(0), // 1: google.ads.googleads.v25.enums.ConsentStatusEnum.ConsentStatus
}
var file_common_consent_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.common.Consent.ad_user_data:type_name -> google.ads.googleads.v25.enums.ConsentStatusEnum.ConsentStatus
	1, // 1: google.ads.googleads.v25.common.Consent.ad_personalization:type_name -> google.ads.googleads.v25.enums.ConsentStatusEnum.ConsentStatus
