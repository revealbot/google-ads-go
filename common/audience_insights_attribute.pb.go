...
func (*DynamicLineupAttributeMetadata_SampleChannel) Descriptor() ([]byte, []int) {
	return file_common_audience_insights_attribute_proto_rawDescGZIP(), []int{8, 0}
}
...
const file_common_audience_insights_attribute_proto_rawDesc = "" +
	"\n" +
	...
	"#com.google.ads.googleads.v19.commonB\x1eAudienceInsightsAttributeProtoP\x01ZEgithub.com/revealbot/google-ads-go/common;common\xa2\x02\x03GAA\xaa\x02\x1fGoogle.Ads.GoogleAds.V19.Common\xca\x02\x1fGoogle\\Ads\\GoogleAds\\V19\\Common\xea\x02#Google::Ads::GoogleAds::V19::Commonb\x06proto3"
...
var file_common_audience_insights_attribute_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
...
func file_common_audience_insights_attribute_proto_init() {
	...
	file_common_audience_insights_attribute_proto_msgTypes[2].OneofWrappers = []any{
		(*AudienceInsightsTopic_Entity)(nil),
		(*AudienceInsightsTopic_Category)(nil),
	}
	file_common_audience_insights_attribute_proto_msgTypes[8].OneofWrappers = []any{}
	type x struct{}
