...
func init() {
	proto.RegisterType((*Segments)(nil), "google.ads.googleads.v9.common.Segments")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/common/segments.proto", fileDescriptor_de7441e2f6d34df2)
}
