...
func init() {
	proto.RegisterType((*CustomParameter)(nil), "google.ads.googleads.v9.common.CustomParameter")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/common/custom_parameter.proto", fileDescriptor_77e235fc7c2795f5)
}
