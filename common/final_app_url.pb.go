...
type FinalAppUrl struct {
	...
	OsType enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType `protobuf:"varint,1,opt,name=os_type,json=osType,proto3,enum=google.ads.googleads.v23.enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType" json:"os_type,omitempty"`
...
var file_common_final_app_url_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x70, 0x70,
...
var (
	...
	file_common_final_app_url_proto_rawDescData []byte
)

func file_common_final_app_url_proto_rawDescGZIP() []byte {
	file_common_final_app_url_proto_rawDescOnce.Do(func() {
		file_common_final_app_url_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_final_app_url_proto_rawDesc), len(file_common_final_app_url_proto_rawDesc)))
	})
...
var file_common_final_app_url_proto_goTypes = []any{
	(*FinalAppUrl)(nil), // 0: google.ads.googleads.v23.common.FinalAppUrl
	(enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType)(0), // 1: google.ads.googleads.v23.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
}
var file_common_final_app_url_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v23.common.FinalAppUrl.os_type:type_name -> google.ads.googleads.v23.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
...
func file_common_final_app_url_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_final_app_url_proto_rawDesc), len(file_common_final_app_url_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
