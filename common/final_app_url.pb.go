...
type FinalAppUrl struct {
	...
	OsType enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType `protobuf:"varint,1,opt,name=os_type,json=osType,proto3,enum=google.ads.googleads.v25.enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType" json:"os_type,omitempty"`
...
var file_common_final_app_url_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x70, 0x70,
...
var file_common_final_app_url_proto_goTypes = []any{
	(*FinalAppUrl)(nil), // 0: google.ads.googleads.v25.common.FinalAppUrl
	(enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType)(0), // 1: google.ads.googleads.v25.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
}
var file_common_final_app_url_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.common.FinalAppUrl.os_type:type_name -> google.ads.googleads.v25.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
