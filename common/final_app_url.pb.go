...
type FinalAppUrl struct {
	...
	OsType enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType `protobuf:"varint,1,opt,name=os_type,json=osType,proto3,enum=google.ads.googleads.v22.enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType" json:"os_type,omitempty"`
...
var file_common_final_app_url_proto_goTypes = []any{
	(*FinalAppUrl)(nil), // 0: google.ads.googleads.v22.common.FinalAppUrl
	(enums.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType)(0), // 1: google.ads.googleads.v22.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
}
var file_common_final_app_url_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.common.FinalAppUrl.os_type:type_name -> google.ads.googleads.v22.enums.AppUrlOperatingSystemTypeEnum.AppUrlOperatingSystemType
