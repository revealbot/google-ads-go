...
func init() {
	proto.RegisterType((*ExplorerAutoOptimizerSetting)(nil), "google.ads.googleads.v9.common.ExplorerAutoOptimizerSetting")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/common/explorer_auto_optimizer_setting.proto", fileDescriptor_551230aa9e865edb)
}
