...
func init() {
	proto.RegisterType((*DateRange)(nil), "google.ads.googleads.v9.common.DateRange")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/common/dates.proto", fileDescriptor_ed817e38b3e3a4ba)
}
