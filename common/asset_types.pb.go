...
const file_common_asset_types_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"ImageAsset\x12\x17\n" +
	"\x04data\x18\x05 \x01(\fH\x00R\x04data\x88\x01\x01\x12 \n" +
	"\tfile_size\x18\x06 \x01(\x03H\x01R\bfileSize\x88\x01\x01\x12R\n" +
	"\tmime_type\x18\x03 \x01(\x0e25.google.ads.googleads.v19.enums.MimeTypeEnum.MimeTypeR\bmimeType\x12L\n" +
	"\tfull_size\x18\x04 \x01(\v2/.google.ads.googleads.v19.common.ImageDimensionR\bfullSizeB\a\n" +
	"\x05_dataB\f\n" +
	"\n" +
	"_file_size\"\xa4\x01\n" +
	"\x0eImageDimension\x12(\n" +
	"\rheight_pixels\x18\x04 \x01(\x03H\x00R\fheightPixels\x88\x01\x01\x12&\n" +
	"\fwidth_pixels\x18\x05 \x01(\x03H\x01R\vwidthPixels\x88\x01\x01\x12\x15\n" +
	"\x03url\x18\x06 \x01(\tH\x02R\x03url\x88\x01\x01B\x10\n" +
	...
	"\rLeadFormAsset\x12(\n" +
	"\rbusiness_name\x18\n" +
	" \x01(\tB\x03\xe0A\x02R\fbusinessName\x12\x89\x01\n" +
	"\x13call_to_action_type\x18\x11 \x01(\x0e2U.google.ads.googleads.v19.enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionTypeB\x03\xe0A\x02R\x10callToActionType\x12@\n" +
	"\x1acall_to_action_description\x18\x12 \x01(\tB\x03\xe0A\x02R\x17callToActionDescription\x12\x1f\n" +
	"\bheadline\x18\f \x01(\tB\x03\xe0A\x02R\bheadline\x12%\n" +
	"\vdescription\x18\r \x01(\tB\x03\xe0A\x02R\vdescription\x121\n" +
	"\x12privacy_policy_url\x18\x0e \x01(\tB\x03\xe0A\x02R\x10privacyPolicyUrl\x125\n" +
	"\x14post_submit_headline\x18\x0f \x01(\tH\x00R\x12postSubmitHeadline\x88\x01\x01\x12;\n" +
	"\x17post_submit_description\x18\x10 \x01(\tH\x01R\x15postSubmitDescription\x88\x01\x01\x12F\n" +
	"\x06fields\x18\b \x03(\v2..google.ads.googleads.v19.common.LeadFormFieldR\x06fields\x12r\n" +
	"\x16custom_question_fields\x18\x17 \x03(\v2<.google.ads.googleads.v19.common.LeadFormCustomQuestionFieldR\x14customQuestionFields\x12b\n" +
	"\x10delivery_methods\x18\t \x03(\v27.google.ads.googleads.v19.common.LeadFormDeliveryMethodR\x0fdeliveryMethods\x12\xae\x01\n" +
	"\x1fpost_submit_call_to_action_type\x18\x13 \x01(\x0e2i.google.ads.googleads.v19.enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionTypeR\x1apostSubmitCallToActionType\x129\n" +
	"\x16background_image_asset\x18\x14 \x01(\tH\x02R\x14backgroundImageAsset\x88\x01\x01\x12v\n" +
	"\x0edesired_intent\x18\x15 \x01(\x0e2O.google.ads.googleads.v19.enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntentR\rdesiredIntent\x120\n" +
	"\x11custom_disclosure\x18\x16 \x01(\tH\x03R\x10customDisclosure\x88\x01\x01B\x17\n" +
	"\x15_post_submit_headlineB\x1a\n" +
	"\x18_post_submit_descriptionB\x19\n" +
	"\x17_background_image_assetB\x14\n" +
	"\x12_custom_disclosure\"\xba\x02\n" +
	"\rLeadFormField\x12x\n" +
	"\n" +
	"input_type\x18\x01 \x01(\x0e2Y.google.ads.googleads.v19.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputTypeR\tinputType\x12r\n" +
	"\x15single_choice_answers\x18\x02 \x01(\v2<.google.ads.googleads.v19.common.LeadFormSingleChoiceAnswersH\x00R\x13singleChoiceAnswers\x120\n" +
	"\x13has_location_answer\x18\x03 \x01(\bH\x00R\x11hasLocationAnswerB\t\n" +
	"\aanswers\"\x80\x02\n" +
	"\x1bLeadFormCustomQuestionField\x120\n" +
	"\x14custom_question_text\x18\x01 \x01(\tR\x12customQuestionText\x12r\n" +
	"\x15single_choice_answers\x18\x02 \x01(\v2<.google.ads.googleads.v19.common.LeadFormSingleChoiceAnswersH\x00R\x13singleChoiceAnswers\x120\n" +
	"\x13has_location_answer\x18\x03 \x01(\bH\x00R\x11hasLocationAnswerB\t\n" +
	"\aanswers\"7\n" +
	"\x1bLeadFormSingleChoiceAnswers\x12\x18\n" +
	"\aanswers\x18\x01 \x03(\tR\aanswers\"z\n" +
	"\x16LeadFormDeliveryMethod\x12L\n" +
	"\awebhook\x18\x01 \x01(\v20.google.ads.googleads.v19.common.WebhookDeliveryH\x00R\awebhookB\x12\n" +
	"\x10delivery_details\"\xf9\x01\n" +
	"\x0fWebhookDelivery\x129\n" +
	"\x16advertiser_webhook_url\x18\x04 \x01(\tH\x00R\x14advertiserWebhookUrl\x88\x01\x01\x12(\n" +
	"\rgoogle_secret\x18\x05 \x01(\tH\x01R\fgoogleSecret\x88\x01\x01\x129\n" +
	"\x16payload_schema_version\x18\x06 \x01(\x03H\x02R\x14payloadSchemaVersion\x88\x01\x01B\x19\n" +
	"\x17_advertiser_webhook_urlB\x10\n" +
	"\x0e_google_secretB\x19\n" +
	"\x17_payload_schema_version\"\x13\n" +
	"\x11BookOnGoogleAsset\"\x92\a\n" +
	"\x0ePromotionAsset\x12.\n" +
	"\x10promotion_target\x18\x01 \x01(\tB\x03\xe0A\x02R\x0fpromotionTarget\x12\x96\x01\n" +
	"\x11discount_modifier\x18\x02 \x01(\x0e2i.google.ads.googleads.v19.enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierR\x10discountModifier\x122\n" +
	"\x15redemption_start_date\x18\a \x01(\tR\x13redemptionStartDate\x12.\n" +
	"\x13redemption_end_date\x18\b \x01(\tR\x11redemptionEndDate\x12u\n" +
	"\boccasion\x18\t \x01(\x0e2Y.google.ads.googleads.v19.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasionR\boccasion\x12#\n" +
	"\rlanguage_code\x18\n" +
	" \x01(\tR\flanguageCode\x12\x1d\n" +
	"\n" +
	"start_date\x18\v \x01(\tR\tstartDate\x12\x19\n" +
	"\bend_date\x18\f \x01(\tR\aendDate\x12_\n" +
	"\x13ad_schedule_targets\x18\r \x03(\v2/.google.ads.googleads.v19.common.AdScheduleInfoR\x11adScheduleTargets\x12!\n" +
	"\vpercent_off\x18\x03 \x01(\x03H\x00R\n" +
	"percentOff\x12R\n" +
	"\x10money_amount_off\x18\x04 \x01(\v2&.google.ads.googleads.v19.common.MoneyH\x00R\x0emoneyAmountOff\x12'\n" +
	"\x0epromotion_code\x18\x05 \x01(\tH\x01R\rpromotionCode\x12V\n" +
	"\x12orders_over_amount\x18\x06 \x01(\v2&.google.ads.googleads.v19.common.MoneyH\x01R\x10ordersOverAmountB\x0f\n" +
	"\rdiscount_typeB\x13\n" +
	"\x11promotion_trigger\"\xd1\x01\n" +
	"\fCalloutAsset\x12&\n" +
	"\fcallout_text\x18\x01 \x01(\tB\x03\xe0A\x02R\vcalloutText\x12\x1d\n" +
	"\n" +
	"start_date\x18\x02 \x01(\tR\tstartDate\x12\x19\n" +
	"\bend_date\x18\x03 \x01(\tR\aendDate\x12_\n" +
	"\x13ad_schedule_targets\x18\x04 \x03(\v2/.google.ads.googleads.v19.common.AdScheduleInfoR\x11adScheduleTargets\"R\n" +
	"\x16StructuredSnippetAsset\x12\x1b\n" +
	"\x06header\x18\x01 \x01(\tB\x03\xe0A\x02R\x06header\x12\x1b\n" +
	"\x06values\x18\x02 \x03(\tB\x03\xe0A\x02R\x06values\"\x94\x02\n" +
	"\rSitelinkAsset\x12 \n" +
	"\tlink_text\x18\x01 \x01(\tB\x03\xe0A\x02R\blinkText\x12\"\n" +
	"\fdescription1\x18\x02 \x01(\tR\fdescription1\x12\"\n" +
	"\fdescription2\x18\x03 \x01(\tR\fdescription2\x12\x1d\n" +
	"\n" +
	"start_date\x18\x04 \x01(\tR\tstartDate\x12\x19\n" +
	"\bend_date\x18\x05 \x01(\tR\aendDate\x12_\n" +
	"\x13ad_schedule_targets\x18\x06 \x03(\v2/.google.ads.googleads.v19.common.AdScheduleInfoR\x11adScheduleTargets\"G\n" +
	"\rPageFeedAsset\x12\x1e\n" +
	"\bpage_url\x18\x01 \x01(\tB\x03\xe0A\x02R\apageUrl\x12\x16\n" +
	"\x06labels\x18\x02 \x03(\tR\x06labels\"\xad\x04\n" +
	"\x15DynamicEducationAsset\x12\"\n" +
	"\n" +
	"program_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tprogramId\x12\x1f\n" +
	"\vlocation_id\x18\x02 \x01(\tR\n" +
	"locationId\x12&\n" +
	"\fprogram_name\x18\x03 \x01(\tB\x03\xe0A\x02R\vprogramName\x12\x18\n" +
	...
	"\x13contextual_keywords\x18\b \x03(\tR\x12contextualKeywords\x12(\n" +
	"\x10android_app_link\x18\t \x01(\tR\x0eandroidAppLink\x12.\n" +
	"\x13similar_program_ids\x18\n" +
	" \x03(\tR\x11similarProgramIds\x12 \n" +
	"\fios_app_link\x18\v \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\f \x01(\x03R\riosAppStoreId\x12.\n" +
	"\x13thumbnail_image_url\x18\r \x01(\tR\x11thumbnailImageUrl\x12\x1b\n" +
	"\timage_url\x18\x0e \x01(\tR\bimageUrl\"\xef\x01\n" +
	"\x0eMobileAppAsset\x12\x1a\n" +
	"\x06app_id\x18\x01 \x01(\tB\x03\xe0A\x02R\x05appId\x12e\n" +
	"\tapp_store\x18\x02 \x01(\x0e2C.google.ads.googleads.v19.enums.MobileAppVendorEnum.MobileAppVendorB\x03\xe0A\x02R\bappStore\x12 \n" +
	"\tlink_text\x18\x03 \x01(\tB\x03\xe0A\x02R\blinkText\x12\x1d\n" +
	"\n" +
	"start_date\x18\x04 \x01(\tR\tstartDate\x12\x19\n" +
	"\bend_date\x18\x05 \x01(\tR\aendDate\"V\n" +
	"\x11HotelCalloutAsset\x12\x17\n" +
	"\x04text\x18\x01 \x01(\tB\x03\xe0A\x02R\x04text\x12(\n" +
	"\rlanguage_code\x18\x02 \x01(\tB\x03\xe0A\x02R\flanguageCode\"\xc9\x03\n" +
	"\tCallAsset\x12&\n" +
	"\fcountry_code\x18\x01 \x01(\tB\x03\xe0A\x02R\vcountryCode\x12&\n" +
	"\fphone_number\x18\x02 \x01(\tB\x03\xe0A\x02R\vphoneNumber\x12\xa4\x01\n" +
	"\x1fcall_conversion_reporting_state\x18\x03 \x01(\x0e2].google.ads.googleads.v19.enums.CallConversionReportingStateEnum.CallConversionReportingStateR\x1ccallConversionReportingState\x12d\n" +
	"\x16call_conversion_action\x18\x04 \x01(\tB.\xfaA+\n" +
	")googleads.googleapis.com/ConversionActionR\x14callConversionAction\x12_\n" +
	"\x13ad_schedule_targets\x18\x05 \x03(\v2/.google.ads.googleads.v19.common.AdScheduleInfoR\x11adScheduleTargets\"\xfc\x02\n" +
	"\n" +
	"PriceAsset\x12b\n" +
	"\x04type\x18\x01 \x01(\x0e2I.google.ads.googleads.v19.enums.PriceExtensionTypeEnum.PriceExtensionTypeB\x03\xe0A\x02R\x04type\x12\x86\x01\n" +
	"\x0fprice_qualifier\x18\x02 \x01(\x0e2].google.ads.googleads.v19.enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierR\x0epriceQualifier\x12(\n" +
	"\rlanguage_code\x18\x03 \x01(\tB\x03\xe0A\x02R\flanguageCode\x12W\n" +
	"\x0fprice_offerings\x18\x04 \x03(\v2..google.ads.googleads.v19.common.PriceOfferingR\x0epriceOfferings\"\xcb\x02\n" +
	"\rPriceOffering\x12\x1b\n" +
	"\x06header\x18\x01 \x01(\tB\x03\xe0A\x02R\x06header\x12%\n" +
	"\vdescription\x18\x02 \x01(\tB\x03\xe0A\x02R\vdescription\x12A\n" +
	"\x05price\x18\x03 \x01(\v2&.google.ads.googleads.v19.common.MoneyB\x03\xe0A\x02R\x05price\x12g\n" +
	"\x04unit\x18\x04 \x01(\x0e2S.google.ads.googleads.v19.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitR\x04unit\x12 \n" +
	"\tfinal_url\x18\x05 \x01(\tB\x03\xe0A\x02R\bfinalUrl\x12(\n" +
	"\x10final_mobile_url\x18\x06 \x01(\tR\x0efinalMobileUrl\"\x80\x01\n" +
	"\x11CallToActionAsset\x12k\n" +
	"\x0ecall_to_action\x18\x01 \x01(\x0e2E.google.ads.googleads.v19.enums.CallToActionTypeEnum.CallToActionTypeR\fcallToAction\"\xb7\x04\n" +
	"\x16DynamicRealEstateAsset\x12\"\n" +
	"\n" +
	"listing_id\x18\x01 \x01(\tB\x03\xe0A\x02R\tlistingId\x12&\n" +
	"\flisting_name\x18\x02 \x01(\tB\x03\xe0A\x02R\vlistingName\x12\x1b\n" +
	...
	"\rproperty_type\x18\b \x01(\tR\fpropertyType\x12!\n" +
	"\flisting_type\x18\t \x01(\tR\vlistingType\x12/\n" +
	"\x13contextual_keywords\x18\n" +
	" \x03(\tR\x12contextualKeywords\x12'\n" +
	"\x0fformatted_price\x18\v \x01(\tR\x0eformattedPrice\x12(\n" +
	"\x10android_app_link\x18\f \x01(\tR\x0eandroidAppLink\x12 \n" +
	"\fios_app_link\x18\r \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\x0e \x01(\x03R\riosAppStoreId\x12.\n" +
	"\x13similar_listing_ids\x18\x0f \x03(\tR\x11similarListingIds\"\xeb\x04\n" +
	"\x12DynamicCustomAsset\x12\x13\n" +
	"\x02id\x18\x01 \x01(\tB\x03\xe0A\x02R\x02id\x12\x10\n" +
	"\x03id2\x18\x02 \x01(\tR\x03id2\x12\"\n" +
	"\n" +
	"item_title\x18\x03 \x01(\tB\x03\xe0A\x02R\titemTitle\x12#\n" +
	"\ritem_subtitle\x18\x04 \x01(\tR\fitemSubtitle\x12)\n" +
	"\x10item_description\x18\x05 \x01(\tR\x0fitemDescription\x12!\n" +
	"\fitem_address\x18\x06 \x01(\tR\vitemAddress\x12#\n" +
	"\ritem_category\x18\a \x01(\tR\fitemCategory\x12\x14\n" +
	"\x05price\x18\b \x01(\tR\x05price\x12\x1d\n" +
	"\n" +
	"sale_price\x18\t \x01(\tR\tsalePrice\x12'\n" +
	"\x0fformatted_price\x18\n" +
	" \x01(\tR\x0eformattedPrice\x120\n" +
	"\x14formatted_sale_price\x18\v \x01(\tR\x12formattedSalePrice\x12\x1b\n" +
	"\timage_url\x18\f \x01(\tR\bimageUrl\x12/\n" +
	"\x13contextual_keywords\x18\r \x03(\tR\x12contextualKeywords\x12(\n" +
	"\x10android_app_link\x18\x0e \x01(\tR\x0eandroidAppLink\x12 \n" +
	"\fios_app_link\x18\x10 \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\x11 \x01(\x03R\riosAppStoreId\x12\x1f\n" +
	"\vsimilar_ids\x18\x0f \x03(\tR\n" +
	"similarIds\"\x97\x05\n" +
	"\x1cDynamicHotelsAndRentalsAsset\x12$\n" +
	"\vproperty_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"propertyId\x12(\n" +
	"\rproperty_name\x18\x02 \x01(\tB\x03\xe0A\x02R\fpropertyName\x12\x1b\n" +
	...
	"\n" +
	"sale_price\x18\a \x01(\tR\tsalePrice\x12\x1f\n" +
	"\vstar_rating\x18\b \x01(\x03R\n" +
	"starRating\x12\x1a\n" +
	"\bcategory\x18\t \x01(\tR\bcategory\x12/\n" +
	"\x13contextual_keywords\x18\n" +
	" \x03(\tR\x12contextualKeywords\x12\x18\n" +
	"\aaddress\x18\v \x01(\tR\aaddress\x12(\n" +
	"\x10android_app_link\x18\f \x01(\tR\x0eandroidAppLink\x12 \n" +
	"\fios_app_link\x18\r \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\x0e \x01(\x03R\riosAppStoreId\x12'\n" +
	"\x0fformatted_price\x18\x0f \x01(\tR\x0eformattedPrice\x120\n" +
	"\x14formatted_sale_price\x18\x10 \x01(\tR\x12formattedSalePrice\x120\n" +
	"\x14similar_property_ids\x18\x11 \x03(\tR\x12similarPropertyIds\"\xf9\x04\n" +
	"\x13DynamicFlightsAsset\x12*\n" +
	"\x0edestination_id\x18\x01 \x01(\tB\x03\xe0A\x02R\rdestinationId\x12\x1b\n" +
	"\torigin_id\x18\x02 \x01(\tR\boriginId\x122\n" +
	"\x12flight_description\x18\x03 \x01(\tB\x03\xe0A\x02R\x11flightDescription\x12\x1b\n" +
	"\timage_url\x18\x04 \x01(\tR\bimageUrl\x12)\n" +
	"\x10destination_name\x18\x05 \x01(\tR\x0fdestinationName\x12\x1f\n" +
	"\vorigin_name\x18\x06 \x01(\tR\n" +
	"originName\x12!\n" +
	"\fflight_price\x18\a \x01(\tR\vflightPrice\x12*\n" +
	"\x11flight_sale_price\x18\b \x01(\tR\x0fflightSalePrice\x12'\n" +
	"\x0fformatted_price\x18\t \x01(\tR\x0eformattedPrice\x120\n" +
	"\x14formatted_sale_price\x18\n" +
	" \x01(\tR\x12formattedSalePrice\x12(\n" +
	"\x10android_app_link\x18\v \x01(\tR\x0eandroidAppLink\x12 \n" +
	"\fios_app_link\x18\f \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\r \x01(\x03R\riosAppStoreId\x126\n" +
	"\x17similar_destination_ids\x18\x0e \x03(\tR\x15similarDestinationIds\x12%\n" +
	"\x0ecustom_mapping\x18\x0f \x01(\tR\rcustomMapping\"\xa6\x02\n" +
	"\x1aDemandGenCarouselCardAsset\x122\n" +
	"\x15marketing_image_asset\x18\x01 \x01(\tR\x13marketingImageAsset\x12?\n" +
	"\x1csquare_marketing_image_asset\x18\x02 \x01(\tR\x19squareMarketingImageAsset\x12C\n" +
	"\x1eportrait_marketing_image_asset\x18\x03 \x01(\tR\x1bportraitMarketingImageAsset\x12\x1f\n" +
	"\bheadline\x18\x04 \x01(\tB\x03\xe0A\x02R\bheadline\x12-\n" +
	"\x13call_to_action_text\x18\x05 \x01(\tR\x10callToActionText\"\x9c\x05\n" +
	"\x12DynamicTravelAsset\x12*\n" +
	"\x0edestination_id\x18\x01 \x01(\tB\x03\xe0A\x02R\rdestinationId\x12\x1b\n" +
	"\torigin_id\x18\x02 \x01(\tR\boriginId\x12\x19\n" +
	"\x05title\x18\x03 \x01(\tB\x03\xe0A\x02R\x05title\x12)\n" +
	"\x10destination_name\x18\x04 \x01(\tR\x0fdestinationName\x12/\n" +
	"\x13destination_address\x18\x05 \x01(\tR\x12destinationAddress\x12\x1f\n" +
	"\vorigin_name\x18\x06 \x01(\tR\n" +
	"originName\x12\x14\n" +
	"\x05price\x18\a \x01(\tR\x05price\x12\x1d\n" +
	"\n" +
	"sale_price\x18\b \x01(\tR\tsalePrice\x12'\n" +
	"\x0fformatted_price\x18\t \x01(\tR\x0eformattedPrice\x120\n" +
	"\x14formatted_sale_price\x18\n" +
	" \x01(\tR\x12formattedSalePrice\x12\x1a\n" +
	"\bcategory\x18\v \x01(\tR\bcategory\x12/\n" +
	"\x13contextual_keywords\x18\f \x03(\tR\x12contextualKeywords\x126\n" +
	"\x17similar_destination_ids\x18\r \x03(\tR\x15similarDestinationIds\x12\x1b\n" +
	"\timage_url\x18\x0e \x01(\tR\bimageUrl\x12(\n" +
	"\x10android_app_link\x18\x0f \x01(\tR\x0eandroidAppLink\x12 \n" +
	"\fios_app_link\x18\x10 \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\x11 \x01(\x03R\riosAppStoreId\"\xc4\x04\n" +
	"\x11DynamicLocalAsset\x12\x1c\n" +
	"\adeal_id\x18\x01 \x01(\tB\x03\xe0A\x02R\x06dealId\x12 \n" +
	"\tdeal_name\x18\x02 \x01(\tB\x03\xe0A\x02R\bdealName\x12\x1a\n" +
	"\bsubtitle\x18\x03 \x01(\tR\bsubtitle\x12 \n" +
	"\vdescription\x18\x04 \x01(\tR\vdescription\x12\x14\n" +
	"\x05price\x18\x05 \x01(\tR\x05price\x12\x1d\n" +
	"\n" +
	"sale_price\x18\x06 \x01(\tR\tsalePrice\x12\x1b\n" +
	"\timage_url\x18\a \x01(\tR\bimageUrl\x12\x18\n" +
	"\aaddress\x18\b \x01(\tR\aaddress\x12\x1a\n" +
	"\bcategory\x18\t \x01(\tR\bcategory\x12/\n" +
	"\x13contextual_keywords\x18\n" +
	" \x03(\tR\x12contextualKeywords\x12'\n" +
	"\x0fformatted_price\x18\v \x01(\tR\x0eformattedPrice\x120\n" +
	"\x14formatted_sale_price\x18\f \x01(\tR\x12formattedSalePrice\x12(\n" +
	"\x10android_app_link\x18\r \x01(\tR\x0eandroidAppLink\x12(\n" +
	"\x10similar_deal_ids\x18\x0e \x03(\tR\x0esimilarDealIds\x12 \n" +
	"\fios_app_link\x18\x0f \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\x10 \x01(\x03R\riosAppStoreId\"\xf6\x03\n" +
	"\x10DynamicJobsAsset\x12\x1a\n" +
	"\x06job_id\x18\x01 \x01(\tB\x03\xe0A\x02R\x05jobId\x12\x1f\n" +
	"\vlocation_id\x18\x02 \x01(\tR\n" +
	"locationId\x12 \n" +
	"\tjob_title\x18\x03 \x01(\tB\x03\xe0A\x02R\bjobTitle\x12!\n" +
	"\fjob_subtitle\x18\x04 \x01(\tR\vjobSubtitle\x12 \n" +
	"\vdescription\x18\x05 \x01(\tR\vdescription\x12\x1b\n" +
	"\timage_url\x18\x06 \x01(\tR\bimageUrl\x12!\n" +
	"\fjob_category\x18\a \x01(\tR\vjobCategory\x12/\n" +
	"\x13contextual_keywords\x18\b \x03(\tR\x12contextualKeywords\x12\x18\n" +
	"\aaddress\x18\t \x01(\tR\aaddress\x12\x16\n" +
	"\x06salary\x18\n" +
	" \x01(\tR\x06salary\x12(\n" +
	"\x10android_app_link\x18\v \x01(\tR\x0eandroidAppLink\x12&\n" +
	"\x0fsimilar_job_ids\x18\f \x03(\tR\rsimilarJobIds\x12 \n" +
	"\fios_app_link\x18\r \x01(\tR\n" +
	"iosAppLink\x12'\n" +
	"\x10ios_app_store_id\x18\x0e \x01(\x03R\riosAppStoreId\"\xac\x02\n" +
	"\rLocationAsset\x12\x19\n" +
	"\bplace_id\x18\x01 \x01(\tR\aplaceId\x12v\n" +
	"\x1abusiness_profile_locations\x18\x02 \x03(\v28.google.ads.googleads.v19.common.BusinessProfileLocationR\x18businessProfileLocations\x12\x87\x01\n" +
	"\x17location_ownership_type\x18\x03 \x01(\x0e2O.google.ads.googleads.v19.enums.LocationOwnershipTypeEnum.LocationOwnershipTypeR\x15locationOwnershipType\"o\n" +
	"\x17BusinessProfileLocation\x12\x16\n" +
	"\x06labels\x18\x01 \x03(\tR\x06labels\x12\x1d\n" +
	"\n" +
	"store_code\x18\x02 \x01(\tR\tstoreCode\x12\x1d\n" +
	"\n" +
	"listing_id\x18\x03 \x01(\x03R\tlistingId\"s\n" +
	"\x12HotelPropertyAsset\x12\x19\n" +
	"\bplace_id\x18\x01 \x01(\tR\aplaceId\x12#\n" +
	"\rhotel_address\x18\x02 \x01(\tR\fhotelAddress\x12\x1d\n" +
	"\n" +
	"hotel_name\x18\x03 \x01(\tR\thotelName\"\xc8\x03\n" +
	"\x14BusinessMessageAsset\x12\x83\x01\n" +
	"\x10message_provider\x18\x01 \x01(\x0e2S.google.ads.googleads.v19.enums.BusinessMessageProviderEnum.BusinessMessageProviderB\x03\xe0A\x02R\x0fmessageProvider\x12,\n" +
	"\x0fstarter_message\x18\x02 \x01(\tB\x03\xe0A\x02R\x0estarterMessage\x12k\n" +
	"\x0ecall_to_action\x18\x03 \x01(\v2@.google.ads.googleads.v19.common.BusinessMessageCallToActionInfoH\x01R\fcallToAction\x88\x01\x01\x12c\n" +
	"\rwhatsapp_info\x18\x05 \x01(\v2<.google.ads.googleads.v19.common.WhatsappBusinessMessageInfoH\x00R\fwhatsappInfoB\x17\n" +
	"\x15message_provider_dataB\x11\n" +
	"\x0f_call_to_action\"m\n" +
	"\x1bWhatsappBusinessMessageInfo\x12&\n" +
	"\fcountry_code\x18\x01 \x01(\tB\x03\xe0A\x02R\vcountryCode\x12&\n" +
	"\fphone_number\x18\x02 \x01(\tB\x03\xe0A\x02R\vphoneNumber\"\x87\x02\n" +
	"\x1fBusinessMessageCallToActionInfo\x12\xa1\x01\n" +
	"\x18call_to_action_selection\x18\x01 \x01(\x0e2c.google.ads.googleads.v19.enums.BusinessMessageCallToActionTypeEnum.BusinessMessageCallToActionTypeB\x03\xe0A\x02R\x15callToActionSelection\x12@\n" +
	"\x1acall_to_action_description\x18\x02 \x01(\tB\x03\xe0A\x02R\x17callToActionDescription\"=\n" +
	"\x10AppDeepLinkAsset\x12)\n" +
	"\x11app_deep_link_uri\x18\x01 \x01(\tR\x0eappDeepLinkUriB\xef\x01\n" +
	"#com.google.ads.googleads.v19.commonB\x0fAssetTypesProtoP\x01ZEgithub.com/revealbot/google-ads-go/common;common\xa2\x02\x03GAA\xaa\x02\x1fGoogle.Ads.GoogleAds.V19.Common\xca\x02\x1fGoogle\\Ads\\GoogleAds\\V19\\Common\xea\x02#Google::Ads::GoogleAds::V19::Commonb\x06proto3"
...
var file_common_asset_types_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
...
func file_common_asset_types_proto_init() {
	...
	file_common_asset_types_proto_msgTypes[35].OneofWrappers = []any{
