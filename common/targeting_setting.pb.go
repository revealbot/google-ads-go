...
func init() {
	proto.RegisterType((*TargetingSetting)(nil), "google.ads.googleads.v9.common.TargetingSetting")
	proto.RegisterType((*TargetRestriction)(nil), "google.ads.googleads.v9.common.TargetRestriction")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/common/targeting_setting.proto", fileDescriptor_3baab94fe8eabc40)
}
