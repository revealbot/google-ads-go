...
type AssetUsage struct {
	...
	ServedAssetFieldType enums.ServedAssetFieldTypeEnum_ServedAssetFieldType `protobuf:"varint,2,opt,name=served_asset_field_type,json=servedAssetFieldType,proto3,enum=google.ads.googleads.v22.enums.ServedAssetFieldTypeEnum_ServedAssetFieldType" json:"served_asset_field_type,omitempty"`
...
var file_common_asset_usage_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65,
...
var (
	...
	file_common_asset_usage_proto_rawDescData []byte
)

func file_common_asset_usage_proto_rawDescGZIP() []byte {
	file_common_asset_usage_proto_rawDescOnce.Do(func() {
		file_common_asset_usage_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_asset_usage_proto_rawDesc), len(file_common_asset_usage_proto_rawDesc)))
	})
...
var file_common_asset_usage_proto_goTypes = []any{
	(*AssetUsage)(nil), // 0: google.ads.googleads.v22.common.AssetUsage
	(enums.ServedAssetFieldTypeEnum_ServedAssetFieldType)(0), // 1: google.ads.googleads.v22.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType
}
var file_common_asset_usage_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.common.AssetUsage.served_asset_field_type:type_name -> google.ads.googleads.v22.enums.ServedAssetFieldTypeEnum.ServedAssetFieldType
...
func file_common_asset_usage_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_asset_usage_proto_rawDesc), len(file_common_asset_usage_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
