...
var file_common_policy_summary_proto_rawDesc = string([]byte{
...
var (
	...
	file_common_policy_summary_proto_rawDescData []byte
)

func file_common_policy_summary_proto_rawDescGZIP() []byte {
	file_common_policy_summary_proto_rawDescOnce.Do(func() {
		file_common_policy_summary_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_policy_summary_proto_rawDesc), len(file_common_policy_summary_proto_rawDesc)))
	})
...
var file_common_policy_summary_proto_goTypes = []any{
	(*PolicySummary)(nil),                                    // 0: google.ads.googleads.v22.common.PolicySummary
	(*PolicyTopicEntry)(nil),                                 // 1: google.ads.googleads.v22.common.PolicyTopicEntry
	(enums.PolicyReviewStatusEnum_PolicyReviewStatus)(0),     // 2: google.ads.googleads.v22.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	(enums.PolicyApprovalStatusEnum_PolicyApprovalStatus)(0), // 3: google.ads.googleads.v22.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
}
var file_common_policy_summary_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.common.PolicySummary.policy_topic_entries:type_name -> google.ads.googleads.v22.common.PolicyTopicEntry
	2, // 1: google.ads.googleads.v22.common.PolicySummary.review_status:type_name -> google.ads.googleads.v22.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	3, // 2: google.ads.googleads.v22.common.PolicySummary.approval_status:type_name -> google.ads.googleads.v22.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
...
func file_common_policy_summary_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_policy_summary_proto_rawDesc), len(file_common_policy_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
