...
type AssetLinkPrimaryStatusDetails struct {
	...
	Reason *enums.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason `protobuf:"varint,1,opt,name=reason,proto3,enum=google.ads.googleads.v13.enums.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason,oneof" json:"reason,omitempty"`
	// Provides the PrimaryStatus of this status detail.
	Status *enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus `protobuf:"varint,2,opt,name=status,proto3,enum=google.ads.googleads.v13.enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus,oneof" json:"status,omitempty"`
...
var file_common_asset_policy_proto_rawDesc = []byte{
	...
	0x31, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x73, 0x73, 0x65, 0x74, 0x4c, 0x69,
...
var file_common_asset_policy_proto_goTypes = []interface{}{
	(*AdAssetPolicySummary)(nil),                                                         // 0: google.ads.googleads.v13.common.AdAssetPolicySummary
	(*AssetLinkPrimaryStatusDetails)(nil),                                                // 1: google.ads.googleads.v13.common.AssetLinkPrimaryStatusDetails
	(*AssetDisapproved)(nil),                                                             // 2: google.ads.googleads.v13.common.AssetDisapproved
	(*PolicyTopicEntry)(nil),                                                             // 3: google.ads.googleads.v13.common.PolicyTopicEntry
	(enums.PolicyReviewStatusEnum_PolicyReviewStatus)(0),                                 // 4: google.ads.googleads.v13.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	(enums.PolicyApprovalStatusEnum_PolicyApprovalStatus)(0),                             // 5: google.ads.googleads.v13.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
	(enums.AssetLinkPrimaryStatusReasonEnum_AssetLinkPrimaryStatusReason)(0),             // 6: google.ads.googleads.v13.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason
	(enums.AssetLinkPrimaryStatusEnum_AssetLinkPrimaryStatus)(0),                         // 7: google.ads.googleads.v13.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus
	(enums.AssetOfflineEvaluationErrorReasonsEnum_AssetOfflineEvaluationErrorReasons)(0), // 8: google.ads.googleads.v13.enums.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons
}
var file_common_asset_policy_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v13.common.AdAssetPolicySummary.policy_topic_entries:type_name -> google.ads.googleads.v13.common.PolicyTopicEntry
	4, // 1: google.ads.googleads.v13.common.AdAssetPolicySummary.review_status:type_name -> google.ads.googleads.v13.enums.PolicyReviewStatusEnum.PolicyReviewStatus
	5, // 2: google.ads.googleads.v13.common.AdAssetPolicySummary.approval_status:type_name -> google.ads.googleads.v13.enums.PolicyApprovalStatusEnum.PolicyApprovalStatus
	6, // 3: google.ads.googleads.v13.common.AssetLinkPrimaryStatusDetails.reason:type_name -> google.ads.googleads.v13.enums.AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason
	7, // 4: google.ads.googleads.v13.common.AssetLinkPrimaryStatusDetails.status:type_name -> google.ads.googleads.v13.enums.AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus
	2, // 5: google.ads.googleads.v13.common.AssetLinkPrimaryStatusDetails.asset_disapproved:type_name -> google.ads.googleads.v13.common.AssetDisapproved
	8, // 6: google.ads.googleads.v13.common.AssetDisapproved.offline_evaluation_error_reasons:type_name -> google.ads.googleads.v13.enums.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons
