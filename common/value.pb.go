...
var file_common_value_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x33, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x22, 0xc7,
...
var (
	...
	file_common_value_proto_rawDescData []byte
)

func file_common_value_proto_rawDescGZIP() []byte {
	file_common_value_proto_rawDescOnce.Do(func() {
		file_common_value_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_value_proto_rawDesc), len(file_common_value_proto_rawDesc)))
	})
...
var file_common_value_proto_goTypes = []any{
	(*Value)(nil), // 0: google.ads.googleads.v23.common.Value
}
...
func file_common_value_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_value_proto_rawDesc), len(file_common_value_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
