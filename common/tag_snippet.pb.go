...
type TagSnippet struct {
	...
	Type enums.TrackingCodeTypeEnum_TrackingCodeType `protobuf:"varint,1,opt,name=type,proto3,enum=google.ads.googleads.v22.enums.TrackingCodeTypeEnum_TrackingCodeType" json:"type,omitempty"`
	// The format of the web page where the tracking tag and snippet will be
	// installed, for example, HTML.
	PageFormat enums.TrackingCodePageFormatEnum_TrackingCodePageFormat `protobuf:"varint,2,opt,name=page_format,json=pageFormat,proto3,enum=google.ads.googleads.v22.enums.TrackingCodePageFormatEnum_TrackingCodePageFormat" json:"page_format,omitempty"`
...
var file_common_tag_snippet_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x72, 0x61, 0x63,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x72,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x32, 0x2e, 0x43, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0xca, 0x02, 0x1f, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c,
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x32, 0x32, 0x5c, 0x43, 0x6f,
	...
	0x32, 0x32, 0x3a, 0x3a, 0x43, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
})

var (
	file_common_tag_snippet_proto_rawDescOnce sync.Once
	file_common_tag_snippet_proto_rawDescData []byte
)

func file_common_tag_snippet_proto_rawDescGZIP() []byte {
	file_common_tag_snippet_proto_rawDescOnce.Do(func() {
		file_common_tag_snippet_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_common_tag_snippet_proto_rawDesc), len(file_common_tag_snippet_proto_rawDesc)))
	})
...
var file_common_tag_snippet_proto_goTypes = []any{
	(*TagSnippet)(nil), // 0: google.ads.googleads.v22.common.TagSnippet
	(enums.TrackingCodeTypeEnum_TrackingCodeType)(0),             // 1: google.ads.googleads.v22.enums.TrackingCodeTypeEnum.TrackingCodeType
	(enums.TrackingCodePageFormatEnum_TrackingCodePageFormat)(0), // 2: google.ads.googleads.v22.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
}
var file_common_tag_snippet_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.common.TagSnippet.type:type_name -> google.ads.googleads.v22.enums.TrackingCodeTypeEnum.TrackingCodeType
	2, // 1: google.ads.googleads.v22.common.TagSnippet.page_format:type_name -> google.ads.googleads.v22.enums.TrackingCodePageFormatEnum.TrackingCodePageFormat
...
func file_common_tag_snippet_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_common_tag_snippet_proto_rawDesc), len(file_common_tag_snippet_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
