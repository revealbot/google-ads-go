...
func init() {
	proto.RegisterType((*Metrics)(nil), "google.ads.googleads.v9.common.Metrics")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/common/metrics.proto", fileDescriptor_49a6464adb140f27)
}
