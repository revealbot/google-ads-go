...
func init() {
	proto.RegisterType((*KeywordPlanHistoricalMetrics)(nil), "google.ads.googleads.v9.common.KeywordPlanHistoricalMetrics")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/common/keyword_plan_common.proto", fileDescriptor_a4a0af8f3b67dacc)
}
