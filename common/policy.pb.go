...
const file_common_policy_proto_rawDesc = "" +
	...
	"\x1cexempt_policy_violation_keys\x18\x02 \x03(\v23.google.ads.googleads.v19.common.PolicyViolationKeyR\x19exemptPolicyViolationKeys\"\xc8\x02\n" +
	"\x10PolicyTopicEntry\x12\x19\n" +
	"\x05topic\x18\x05 \x01(\tH\x00R\x05topic\x88\x01\x01\x12a\n" +
	"\x04type\x18\x02 \x01(\x0e2M.google.ads.googleads.v19.enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryTypeR\x04type\x12R\n" +
	"\tevidences\x18\x03 \x03(\v24.google.ads.googleads.v19.common.PolicyTopicEvidenceR\tevidences\x12X\n" +
	"\vconstraints\x18\x04 \x03(\v26.google.ads.googleads.v19.common.PolicyTopicConstraintR\vconstraintsB\b\n" +
	"\x06_topic\"\x8a\f\n" +
	"\x13PolicyTopicEvidence\x12e\n" +
	"\fwebsite_list\x18\x03 \x01(\v2@.google.ads.googleads.v19.common.PolicyTopicEvidence.WebsiteListH\x00R\vwebsiteList\x12\\\n" +
	"\ttext_list\x18\x04 \x01(\v2=.google.ads.googleads.v19.common.PolicyTopicEvidence.TextListH\x00R\btextList\x12%\n" +
	"\rlanguage_code\x18\t \x01(\tH\x00R\flanguageCode\x12~\n" +
	"\x15destination_text_list\x18\x06 \x01(\v2H.google.ads.googleads.v19.common.PolicyTopicEvidence.DestinationTextListH\x00R\x13destinationTextList\x12}\n" +
	"\x14destination_mismatch\x18\a \x01(\v2H.google.ads.googleads.v19.common.PolicyTopicEvidence.DestinationMismatchH\x00R\x13destinationMismatch\x12\x84\x01\n" +
	"\x17destination_not_working\x18\b \x01(\v2J.google.ads.googleads.v19.common.PolicyTopicEvidence.DestinationNotWorkingH\x00R\x15destinationNotWorking\x1a \n" +
	"\bTextList\x12\x14\n" +
	...
	"\turl_types\x18\x01 \x03(\x0e2\x7f.google.ads.googleads.v19.enums.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum.PolicyTopicEvidenceDestinationMismatchUrlTypeR\burlTypes\x1a\xaf\x04\n" +
	"\x15DestinationNotWorking\x12&\n" +
	"\fexpanded_url\x18\a \x01(\tH\x01R\vexpandedUrl\x88\x01\x01\x12\x9a\x01\n" +
	"\x06device\x18\x04 \x01(\x0e2\x81\x01.google.ads.googleads.v19.enums.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDeviceR\x06device\x128\n" +
	"\x16last_checked_date_time\x18\b \x01(\tH\x02R\x13lastCheckedDateTime\x88\x01\x01\x12\xb6\x01\n" +
	"\x0edns_error_type\x18\x01 \x01(\x0e2\x8d\x01.google.ads.googleads.v19.enums.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeH\x00R\fdnsErrorType\x12(\n" +
	...
	"\x17country_constraint_list\x18\x01 \x01(\v2L.google.ads.googleads.v19.common.PolicyTopicConstraint.CountryConstraintListH\x00R\x15countryConstraintList\x12|\n" +
	"\x13reseller_constraint\x18\x02 \x01(\v2I.google.ads.googleads.v19.common.PolicyTopicConstraint.ResellerConstraintH\x00R\x12resellerConstraint\x12\x9c\x01\n" +
	"#certificate_missing_in_country_list\x18\x03 \x01(\v2L.google.ads.googleads.v19.common.PolicyTopicConstraint.CountryConstraintListH\x00R\x1fcertificateMissingInCountryList\x12\xab\x01\n" +
	"+certificate_domain_mismatch_in_country_list\x18\x04 \x01(\v2L.google.ads.googleads.v19.common.PolicyTopicConstraint.CountryConstraintListH\x00R&certificateDomainMismatchInCountryList\x1a\xdb\x01\n" +
	"\x15CountryConstraintList\x12=\n" +
	"\x18total_targeted_countries\x18\x03 \x01(\x05H\x00R\x16totalTargetedCountries\x88\x01\x01\x12f\n" +
	"\tcountries\x18\x02 \x03(\v2H.google.ads.googleads.v19.common.PolicyTopicConstraint.CountryConstraintR\tcountriesB\x1b\n" +
	...
	"\x05valueB\xeb\x01\n" +
	"#com.google.ads.googleads.v19.commonB\vPolicyProtoP\x01ZEgithub.com/revealbot/google-ads-go/common;common\xa2\x02\x03GAA\xaa\x02\x1fGoogle.Ads.GoogleAds.V19.Common\xca\x02\x1fGoogle\\Ads\\GoogleAds\\V19\\Common\xea\x02#Google::Ads::GoogleAds::V19::Commonb\x06proto3"
