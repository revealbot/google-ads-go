...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.UserListRuleTypeEnum_UserListRuleType", UserListRuleTypeEnum_UserListRuleType_name, UserListRuleTypeEnum_UserListRuleType_value)
	proto.RegisterType((*UserListRuleTypeEnum)(nil), "google.ads.googleads.v9.enums.UserListRuleTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/user_list_rule_type.proto", fileDescriptor_ab6bdc6957d77178)
}
