...
var file_enums_audience_scope_proto_rawDesc = string([]byte{
...
var (
	...
	file_enums_audience_scope_proto_rawDescData []byte
)

func file_enums_audience_scope_proto_rawDescGZIP() []byte {
	file_enums_audience_scope_proto_rawDescOnce.Do(func() {
		file_enums_audience_scope_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_audience_scope_proto_rawDesc), len(file_enums_audience_scope_proto_rawDesc)))
	})
...
var file_enums_audience_scope_proto_goTypes = []any{
	(AudienceScopeEnum_AudienceScope)(0), // 0: google.ads.googleads.v22.enums.AudienceScopeEnum.AudienceScope
	(*AudienceScopeEnum)(nil),            // 1: google.ads.googleads.v22.enums.AudienceScopeEnum
}
...
func file_enums_audience_scope_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_audience_scope_proto_rawDesc), len(file_enums_audience_scope_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
