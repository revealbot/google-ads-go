...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.BiddingSourceEnum_BiddingSource", BiddingSourceEnum_BiddingSource_name, BiddingSourceEnum_BiddingSource_value)
	proto.RegisterType((*BiddingSourceEnum)(nil), "google.ads.googleads.v9.enums.BiddingSourceEnum")
}
