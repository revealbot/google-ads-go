...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.CalloutPlaceholderFieldEnum_CalloutPlaceholderField", CalloutPlaceholderFieldEnum_CalloutPlaceholderField_name, CalloutPlaceholderFieldEnum_CalloutPlaceholderField_value)
	proto.RegisterType((*CalloutPlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.CalloutPlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/callout_placeholder_field.proto", fileDescriptor_19cbecbc7acebccf)
}
