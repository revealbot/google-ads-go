...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AdGroupStatusEnum_AdGroupStatus", AdGroupStatusEnum_AdGroupStatus_name, AdGroupStatusEnum_AdGroupStatus_value)
	proto.RegisterType((*AdGroupStatusEnum)(nil), "google.ads.googleads.v9.enums.AdGroupStatusEnum")
}
