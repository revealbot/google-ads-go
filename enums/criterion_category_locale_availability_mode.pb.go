...
func init() {
	...
	proto.RegisterType((*CriterionCategoryLocaleAvailabilityModeEnum)(nil), "google.ads.googleads.v9.enums.CriterionCategoryLocaleAvailabilityModeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/criterion_category_locale_availability_mode.proto", fileDescriptor_e20896859340bb97)
}
