...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ConversionActionCategoryEnum_ConversionActionCategory", ConversionActionCategoryEnum_ConversionActionCategory_name, ConversionActionCategoryEnum_ConversionActionCategory_value)
	proto.RegisterType((*ConversionActionCategoryEnum)(nil), "google.ads.googleads.v9.enums.ConversionActionCategoryEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/conversion_action_category.proto", fileDescriptor_f52b4a76978656bc)
}
