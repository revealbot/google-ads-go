...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AppPlaceholderFieldEnum_AppPlaceholderField", AppPlaceholderFieldEnum_AppPlaceholderField_name, AppPlaceholderFieldEnum_AppPlaceholderField_value)
	proto.RegisterType((*AppPlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.AppPlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/app_placeholder_field.proto", fileDescriptor_ef3f89b96bd0a735)
}
