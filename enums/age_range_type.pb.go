...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AgeRangeTypeEnum_AgeRangeType", AgeRangeTypeEnum_AgeRangeType_name, AgeRangeTypeEnum_AgeRangeType_value)
	proto.RegisterType((*AgeRangeTypeEnum)(nil), "google.ads.googleads.v9.enums.AgeRangeTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/age_range_type.proto", fileDescriptor_636b7035419aa909)
}
