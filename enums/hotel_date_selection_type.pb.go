...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.HotelDateSelectionTypeEnum_HotelDateSelectionType", HotelDateSelectionTypeEnum_HotelDateSelectionType_name, HotelDateSelectionTypeEnum_HotelDateSelectionType_value)
	proto.RegisterType((*HotelDateSelectionTypeEnum)(nil), "google.ads.googleads.v9.enums.HotelDateSelectionTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/hotel_date_selection_type.proto", fileDescriptor_17699a09a8cbc4ef)
}
