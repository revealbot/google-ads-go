...
const file_enums_change_status_resource_type_proto_rawDesc = "" +
	"\n" +
	...
	"\"com.google.ads.googleads.v19.enumsB\x1dChangeStatusResourceTypeProtoP\x01ZCgithub.com/revealbot/google-ads-go/enums;enums\xa2\x02\x03GAA\xaa\x02\x1eGoogle.Ads.GoogleAds.V19.Enums\xca\x02\x1eGoogle\\Ads\\GoogleAds\\V19\\Enums\xea\x02\"Google::Ads::GoogleAds::V19::Enumsb\x06proto3"

var (
	file_enums_change_status_resource_type_proto_rawDescOnce sync.Once
	file_enums_change_status_resource_type_proto_rawDescData []byte
)
...
func file_enums_change_status_resource_type_proto_rawDescGZIP() []byte {
	file_enums_change_status_resource_type_proto_rawDescOnce.Do(func() {
		file_enums_change_status_resource_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_change_status_resource_type_proto_rawDesc), len(file_enums_change_status_resource_type_proto_rawDesc)))
	})
...
var file_enums_change_status_resource_type_proto_goTypes = []any{
	(ChangeStatusResourceTypeEnum_ChangeStatusResourceType)(0), // 0: google.ads.googleads.v19.enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType
	(*ChangeStatusResourceTypeEnum)(nil),                       // 1: google.ads.googleads.v19.enums.ChangeStatusResourceTypeEnum
}
...
func file_enums_change_status_resource_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_change_status_resource_type_proto_rawDesc), len(file_enums_change_status_resource_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
