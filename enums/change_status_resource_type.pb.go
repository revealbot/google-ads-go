...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ChangeStatusResourceTypeEnum_ChangeStatusResourceType", ChangeStatusResourceTypeEnum_ChangeStatusResourceType_name, ChangeStatusResourceTypeEnum_ChangeStatusResourceType_value)
	proto.RegisterType((*ChangeStatusResourceTypeEnum)(nil), "google.ads.googleads.v9.enums.ChangeStatusResourceTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/change_status_resource_type.proto", fileDescriptor_01a72a15c4339408)
}
