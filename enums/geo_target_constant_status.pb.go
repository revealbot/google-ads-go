...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.GeoTargetConstantStatusEnum_GeoTargetConstantStatus", GeoTargetConstantStatusEnum_GeoTargetConstantStatus_name, GeoTargetConstantStatusEnum_GeoTargetConstantStatus_value)
	proto.RegisterType((*GeoTargetConstantStatusEnum)(nil), "google.ads.googleads.v9.enums.GeoTargetConstantStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/geo_target_constant_status.proto", fileDescriptor_d4b14155902182d3)
}
