...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FrequencyCapLevelEnum_FrequencyCapLevel", FrequencyCapLevelEnum_FrequencyCapLevel_name, FrequencyCapLevelEnum_FrequencyCapLevel_value)
	proto.RegisterType((*FrequencyCapLevelEnum)(nil), "google.ads.googleads.v9.enums.FrequencyCapLevelEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/frequency_cap_level.proto", fileDescriptor_28da8bcce5499feb)
}
