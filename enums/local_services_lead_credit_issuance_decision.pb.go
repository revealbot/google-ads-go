...
func (LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision) Descriptor() protoreflect.EnumDescriptor {
	return file_enums_local_services_lead_credit_issuance_decision_proto_enumTypes[0].Descriptor()
}

func (LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision) Type() protoreflect.EnumType {
	return &file_enums_local_services_lead_credit_issuance_decision_proto_enumTypes[0]
}
...
func (LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision) EnumDescriptor() ([]byte, []int) {
	return file_enums_local_services_lead_credit_issuance_decision_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *LocalServicesLeadCreditIssuanceDecisionEnum) Reset() {
	*x = LocalServicesLeadCreditIssuanceDecisionEnum{}
	mi := &file_enums_local_services_lead_credit_issuance_decision_proto_msgTypes[0]
...
func (*LocalServicesLeadCreditIssuanceDecisionEnum) Descriptor() ([]byte, []int) {
	return file_enums_local_services_lead_credit_issuance_decision_proto_rawDescGZIP(), []int{0}
}

var File_enums_local_services_lead_credit_issuance_decision_proto protoreflect.FileDescriptor

const file_enums_local_services_lead_credit_issuance_decision_proto_rawDesc = "" +
	"\n" +
	...
	"\"com.google.ads.googleads.v19.enumsB,LocalServicesLeadCreditIssuanceDecisionProtoP\x01ZCgithub.com/revealbot/google-ads-go/enums;enums\xa2\x02\x03GAA\xaa\x02\x1eGoogle.Ads.GoogleAds.V19.Enums\xca\x02\x1eGoogle\\Ads\\GoogleAds\\V19\\Enums\xea\x02\"Google::Ads::GoogleAds::V19::Enumsb\x06proto3"

var (
	file_enums_local_services_lead_credit_issuance_decision_proto_rawDescOnce sync.Once
	file_enums_local_services_lead_credit_issuance_decision_proto_rawDescData []byte
)

func file_enums_local_services_lead_credit_issuance_decision_proto_rawDescGZIP() []byte {
	file_enums_local_services_lead_credit_issuance_decision_proto_rawDescOnce.Do(func() {
		file_enums_local_services_lead_credit_issuance_decision_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_local_services_lead_credit_issuance_decision_proto_rawDesc), len(file_enums_local_services_lead_credit_issuance_decision_proto_rawDesc)))
	})
	return file_enums_local_services_lead_credit_issuance_decision_proto_rawDescData
}

var file_enums_local_services_lead_credit_issuance_decision_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_enums_local_services_lead_credit_issuance_decision_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_enums_local_services_lead_credit_issuance_decision_proto_goTypes = []any{
	(LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision)(0), // 0: google.ads.googleads.v19.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
	(*LocalServicesLeadCreditIssuanceDecisionEnum)(nil),                     // 1: google.ads.googleads.v19.enums.LocalServicesLeadCreditIssuanceDecisionEnum
}
var file_enums_local_services_lead_credit_issuance_decision_proto_depIdxs = []int32{
...
func init() {
	file_enums_local_services_lead_credit_issuance_decision_proto_init()
}
func file_enums_local_services_lead_credit_issuance_decision_proto_init() {
	if File_enums_local_services_lead_credit_issuance_decision_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_local_services_lead_credit_issuance_decision_proto_rawDesc), len(file_enums_local_services_lead_credit_issuance_decision_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_enums_local_services_lead_credit_issuance_decision_proto_goTypes,
		DependencyIndexes: file_enums_local_services_lead_credit_issuance_decision_proto_depIdxs,
		EnumInfos:         file_enums_local_services_lead_credit_issuance_decision_proto_enumTypes,
		MessageInfos:      file_enums_local_services_lead_credit_issuance_decision_proto_msgTypes,
	}.Build()
	File_enums_local_services_lead_credit_issuance_decision_proto = out.File
	file_enums_local_services_lead_credit_issuance_decision_proto_goTypes = nil
	file_enums_local_services_lead_credit_issuance_decision_proto_depIdxs = nil
}
