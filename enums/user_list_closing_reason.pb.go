...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.UserListClosingReasonEnum_UserListClosingReason", UserListClosingReasonEnum_UserListClosingReason_name, UserListClosingReasonEnum_UserListClosingReason_value)
	proto.RegisterType((*UserListClosingReasonEnum)(nil), "google.ads.googleads.v9.enums.UserListClosingReasonEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/user_list_closing_reason.proto", fileDescriptor_5cc89bf8e48e4df0)
}
