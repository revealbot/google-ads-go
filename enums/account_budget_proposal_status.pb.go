...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus", AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus_name, AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus_value)
	proto.RegisterType((*AccountBudgetProposalStatusEnum)(nil), "google.ads.googleads.v9.enums.AccountBudgetProposalStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/account_budget_proposal_status.proto", fileDescriptor_31d21571f8020c17)
}
