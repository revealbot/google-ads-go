...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.TargetingDimensionEnum_TargetingDimension", TargetingDimensionEnum_TargetingDimension_name, TargetingDimensionEnum_TargetingDimension_value)
	proto.RegisterType((*TargetingDimensionEnum)(nil), "google.ads.googleads.v9.enums.TargetingDimensionEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/targeting_dimension.proto", fileDescriptor_a80951e68c59af43)
}
