...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedMappingStatusEnum_FeedMappingStatus", FeedMappingStatusEnum_FeedMappingStatus_name, FeedMappingStatusEnum_FeedMappingStatus_value)
	proto.RegisterType((*FeedMappingStatusEnum)(nil), "google.ads.googleads.v9.enums.FeedMappingStatusEnum")
}
