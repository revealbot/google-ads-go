...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedItemValidationStatusEnum_FeedItemValidationStatus", FeedItemValidationStatusEnum_FeedItemValidationStatus_name, FeedItemValidationStatusEnum_FeedItemValidationStatus_value)
	proto.RegisterType((*FeedItemValidationStatusEnum)(nil), "google.ads.googleads.v9.enums.FeedItemValidationStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/feed_item_validation_status.proto", fileDescriptor_90b408c2fc9af860)
}
