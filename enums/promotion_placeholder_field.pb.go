...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.PromotionPlaceholderFieldEnum_PromotionPlaceholderField", PromotionPlaceholderFieldEnum_PromotionPlaceholderField_name, PromotionPlaceholderFieldEnum_PromotionPlaceholderField_value)
	proto.RegisterType((*PromotionPlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.PromotionPlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/promotion_placeholder_field.proto", fileDescriptor_6ebc27f789789fbe)
}
