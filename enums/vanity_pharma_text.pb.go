...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.VanityPharmaTextEnum_VanityPharmaText", VanityPharmaTextEnum_VanityPharmaText_name, VanityPharmaTextEnum_VanityPharmaText_value)
	proto.RegisterType((*VanityPharmaTextEnum)(nil), "google.ads.googleads.v9.enums.VanityPharmaTextEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/vanity_pharma_text.proto", fileDescriptor_d18ebee01472e81c)
}
