...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.MobileDeviceTypeEnum_MobileDeviceType", MobileDeviceTypeEnum_MobileDeviceType_name, MobileDeviceTypeEnum_MobileDeviceType_value)
	proto.RegisterType((*MobileDeviceTypeEnum)(nil), "google.ads.googleads.v9.enums.MobileDeviceTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/mobile_device_type.proto", fileDescriptor_e8a0b7a9d9304c8a)
}
