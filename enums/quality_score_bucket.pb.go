...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.QualityScoreBucketEnum_QualityScoreBucket", QualityScoreBucketEnum_QualityScoreBucket_name, QualityScoreBucketEnum_QualityScoreBucket_value)
	proto.RegisterType((*QualityScoreBucketEnum)(nil), "google.ads.googleads.v9.enums.QualityScoreBucketEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/quality_score_bucket.proto", fileDescriptor_0cc972712a91136d)
}
