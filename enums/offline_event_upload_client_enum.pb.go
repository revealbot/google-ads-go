...
var file_enums_offline_event_upload_client_enum_proto_rawDesc = string([]byte{
	...
	0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x9f, 0x01, 0x0a, 0x1c, 0x4f, 0x66, 0x66, 0x6c,
...
var (
	...
	file_enums_offline_event_upload_client_enum_proto_rawDescData []byte
)
...
func file_enums_offline_event_upload_client_enum_proto_rawDescGZIP() []byte {
	file_enums_offline_event_upload_client_enum_proto_rawDescOnce.Do(func() {
		file_enums_offline_event_upload_client_enum_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_offline_event_upload_client_enum_proto_rawDesc), len(file_enums_offline_event_upload_client_enum_proto_rawDesc)))
	})
...
var file_enums_offline_event_upload_client_enum_proto_goTypes = []any{
	(OfflineEventUploadClientEnum_OfflineEventUploadClient)(0), // 0: google.ads.googleads.v22.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	(*OfflineEventUploadClientEnum)(nil),                       // 1: google.ads.googleads.v22.enums.OfflineEventUploadClientEnum
}
...
func file_enums_offline_event_upload_client_enum_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_offline_event_upload_client_enum_proto_rawDesc), len(file_enums_offline_event_upload_client_enum_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
