...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ProductConditionEnum_ProductCondition", ProductConditionEnum_ProductCondition_name, ProductConditionEnum_ProductCondition_value)
	proto.RegisterType((*ProductConditionEnum)(nil), "google.ads.googleads.v9.enums.ProductConditionEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/product_condition.proto", fileDescriptor_c9e1b701be07f340)
}
