...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.PolicyApprovalStatusEnum_PolicyApprovalStatus", PolicyApprovalStatusEnum_PolicyApprovalStatus_name, PolicyApprovalStatusEnum_PolicyApprovalStatus_value)
	proto.RegisterType((*PolicyApprovalStatusEnum)(nil), "google.ads.googleads.v9.enums.PolicyApprovalStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/policy_approval_status.proto", fileDescriptor_89d16fa13dd27a67)
}
