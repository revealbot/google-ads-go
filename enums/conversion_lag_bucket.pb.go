...
var file_enums_conversion_lag_bucket_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xbb, 0x04, 0x0a,
...
var (
	...
	file_enums_conversion_lag_bucket_proto_rawDescData []byte
)

func file_enums_conversion_lag_bucket_proto_rawDescGZIP() []byte {
	file_enums_conversion_lag_bucket_proto_rawDescOnce.Do(func() {
		file_enums_conversion_lag_bucket_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_conversion_lag_bucket_proto_rawDesc), len(file_enums_conversion_lag_bucket_proto_rawDesc)))
	})
...
var file_enums_conversion_lag_bucket_proto_goTypes = []any{
	(ConversionLagBucketEnum_ConversionLagBucket)(0), // 0: google.ads.googleads.v25.enums.ConversionLagBucketEnum.ConversionLagBucket
	(*ConversionLagBucketEnum)(nil),                  // 1: google.ads.googleads.v25.enums.ConversionLagBucketEnum
}
...
func file_enums_conversion_lag_bucket_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_conversion_lag_bucket_proto_rawDesc), len(file_enums_conversion_lag_bucket_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
