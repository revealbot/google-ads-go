...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedOriginEnum_FeedOrigin", FeedOriginEnum_FeedOrigin_name, FeedOriginEnum_FeedOrigin_value)
	proto.RegisterType((*FeedOriginEnum)(nil), "google.ads.googleads.v9.enums.FeedOriginEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/feed_origin.proto", fileDescriptor_f14d4faf433a4bcf)
}
