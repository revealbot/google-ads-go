...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.CriterionTypeEnum_CriterionType", CriterionTypeEnum_CriterionType_name, CriterionTypeEnum_CriterionType_value)
	proto.RegisterType((*CriterionTypeEnum)(nil), "google.ads.googleads.v9.enums.CriterionTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/criterion_type.proto", fileDescriptor_f1628c61ea2a470c)
}
