...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel", KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel_name, KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel_value)
	proto.RegisterType((*KeywordPlanCompetitionLevelEnum)(nil), "google.ads.googleads.v9.enums.KeywordPlanCompetitionLevelEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/keyword_plan_competition_level.proto", fileDescriptor_ec400840a79d2b5d)
}
