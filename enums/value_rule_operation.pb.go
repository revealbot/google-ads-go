...
var file_enums_value_rule_operation_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x6c, 0x0a, 0x16, 0x56,
...
var (
	...
	file_enums_value_rule_operation_proto_rawDescData []byte
)

func file_enums_value_rule_operation_proto_rawDescGZIP() []byte {
	file_enums_value_rule_operation_proto_rawDescOnce.Do(func() {
		file_enums_value_rule_operation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_value_rule_operation_proto_rawDesc), len(file_enums_value_rule_operation_proto_rawDesc)))
	})
...
var file_enums_value_rule_operation_proto_goTypes = []any{
	(ValueRuleOperationEnum_ValueRuleOperation)(0), // 0: google.ads.googleads.v19.enums.ValueRuleOperationEnum.ValueRuleOperation
	(*ValueRuleOperationEnum)(nil),                 // 1: google.ads.googleads.v19.enums.ValueRuleOperationEnum
}
...
func file_enums_value_rule_operation_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_value_rule_operation_proto_rawDesc), len(file_enums_value_rule_operation_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
