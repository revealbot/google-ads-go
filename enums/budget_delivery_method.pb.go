...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.BudgetDeliveryMethodEnum_BudgetDeliveryMethod", BudgetDeliveryMethodEnum_BudgetDeliveryMethod_name, BudgetDeliveryMethodEnum_BudgetDeliveryMethod_value)
	proto.RegisterType((*BudgetDeliveryMethodEnum)(nil), "google.ads.googleads.v9.enums.BudgetDeliveryMethodEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/budget_delivery_method.proto", fileDescriptor_e4421b5c65853947)
}
