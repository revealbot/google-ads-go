...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType", UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType_name, UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType_value)
	proto.RegisterType((*UserInterestTaxonomyTypeEnum)(nil), "google.ads.googleads.v9.enums.UserInterestTaxonomyTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/user_interest_taxonomy_type.proto", fileDescriptor_e04e3d2df213d8eb)
}
