...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.WebpageConditionOperatorEnum_WebpageConditionOperator", WebpageConditionOperatorEnum_WebpageConditionOperator_name, WebpageConditionOperatorEnum_WebpageConditionOperator_value)
	proto.RegisterType((*WebpageConditionOperatorEnum)(nil), "google.ads.googleads.v9.enums.WebpageConditionOperatorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/webpage_condition_operator.proto", fileDescriptor_5a1dd2c3bd477ace)
}
