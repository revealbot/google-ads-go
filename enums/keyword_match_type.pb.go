...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.KeywordMatchTypeEnum_KeywordMatchType", KeywordMatchTypeEnum_KeywordMatchType_name, KeywordMatchTypeEnum_KeywordMatchType_value)
	proto.RegisterType((*KeywordMatchTypeEnum)(nil), "google.ads.googleads.v9.enums.KeywordMatchTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/keyword_match_type.proto", fileDescriptor_a897816d2b7faf4d)
}
