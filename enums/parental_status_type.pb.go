...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ParentalStatusTypeEnum_ParentalStatusType", ParentalStatusTypeEnum_ParentalStatusType_name, ParentalStatusTypeEnum_ParentalStatusType_value)
	proto.RegisterType((*ParentalStatusTypeEnum)(nil), "google.ads.googleads.v9.enums.ParentalStatusTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/parental_status_type.proto", fileDescriptor_c10372a54aefea7c)
}
