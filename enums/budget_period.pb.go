...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.BudgetPeriodEnum_BudgetPeriod", BudgetPeriodEnum_BudgetPeriod_name, BudgetPeriodEnum_BudgetPeriod_value)
	proto.RegisterType((*BudgetPeriodEnum)(nil), "google.ads.googleads.v9.enums.BudgetPeriodEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/budget_period.proto", fileDescriptor_77814120f1745531)
}
