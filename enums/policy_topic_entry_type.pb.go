...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.PolicyTopicEntryTypeEnum_PolicyTopicEntryType", PolicyTopicEntryTypeEnum_PolicyTopicEntryType_name, PolicyTopicEntryTypeEnum_PolicyTopicEntryType_value)
	proto.RegisterType((*PolicyTopicEntryTypeEnum)(nil), "google.ads.googleads.v9.enums.PolicyTopicEntryTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/policy_topic_entry_type.proto", fileDescriptor_a036b6be41070f53)
}
