...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ChangeStatusOperationEnum_ChangeStatusOperation", ChangeStatusOperationEnum_ChangeStatusOperation_name, ChangeStatusOperationEnum_ChangeStatusOperation_value)
	proto.RegisterType((*ChangeStatusOperationEnum)(nil), "google.ads.googleads.v9.enums.ChangeStatusOperationEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/change_status_operation.proto", fileDescriptor_c4b2c36118d4ded4)
}
