...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.IncomeRangeTypeEnum_IncomeRangeType", IncomeRangeTypeEnum_IncomeRangeType_name, IncomeRangeTypeEnum_IncomeRangeType_value)
	proto.RegisterType((*IncomeRangeTypeEnum)(nil), "google.ads.googleads.v9.enums.IncomeRangeTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/income_range_type.proto", fileDescriptor_5a68246aed0e9c27)
}
