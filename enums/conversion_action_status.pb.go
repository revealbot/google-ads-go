...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ConversionActionStatusEnum_ConversionActionStatus", ConversionActionStatusEnum_ConversionActionStatus_name, ConversionActionStatusEnum_ConversionActionStatus_value)
	proto.RegisterType((*ConversionActionStatusEnum)(nil), "google.ads.googleads.v9.enums.ConversionActionStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/conversion_action_status.proto", fileDescriptor_ff1eb7eb51c9f116)
}
