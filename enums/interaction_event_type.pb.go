...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.InteractionEventTypeEnum_InteractionEventType", InteractionEventTypeEnum_InteractionEventType_name, InteractionEventTypeEnum_InteractionEventType_value)
	proto.RegisterType((*InteractionEventTypeEnum)(nil), "google.ads.googleads.v9.enums.InteractionEventTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/interaction_event_type.proto", fileDescriptor_f32c9387d1a46d03)
}
