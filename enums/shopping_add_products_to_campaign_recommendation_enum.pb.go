...
var file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xac, 0x02, 0x0a,
...
var (
	...
	file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDescData []byte
)
...
func file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDescGZIP() []byte {
	file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDescOnce.Do(func() {
		file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDesc), len(file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDesc)))
	})
...
var file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_goTypes = []any{
	(ShoppingAddProductsToCampaignRecommendationEnum_Reason)(0), // 0: google.ads.googleads.v25.enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason
	(*ShoppingAddProductsToCampaignRecommendationEnum)(nil),     // 1: google.ads.googleads.v25.enums.ShoppingAddProductsToCampaignRecommendationEnum
}
...
func file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDesc), len(file_enums_shopping_add_products_to_campaign_recommendation_enum_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
