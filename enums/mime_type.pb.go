...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.MimeTypeEnum_MimeType", MimeTypeEnum_MimeType_name, MimeTypeEnum_MimeType_value)
	proto.RegisterType((*MimeTypeEnum)(nil), "google.ads.googleads.v9.enums.MimeTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/mime_type.proto", fileDescriptor_9bdfbc65c31746be)
}
