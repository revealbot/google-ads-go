...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.UserListPrepopulationStatusEnum_UserListPrepopulationStatus", UserListPrepopulationStatusEnum_UserListPrepopulationStatus_name, UserListPrepopulationStatusEnum_UserListPrepopulationStatus_value)
	proto.RegisterType((*UserListPrepopulationStatusEnum)(nil), "google.ads.googleads.v9.enums.UserListPrepopulationStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/user_list_prepopulation_status.proto", fileDescriptor_9ebb4a86044aa037)
}
