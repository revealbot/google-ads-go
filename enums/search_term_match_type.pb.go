...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.SearchTermMatchTypeEnum_SearchTermMatchType", SearchTermMatchTypeEnum_SearchTermMatchType_name, SearchTermMatchTypeEnum_SearchTermMatchType_value)
	proto.RegisterType((*SearchTermMatchTypeEnum)(nil), "google.ads.googleads.v9.enums.SearchTermMatchTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/search_term_match_type.proto", fileDescriptor_7965fd2f3594f3cd)
}
