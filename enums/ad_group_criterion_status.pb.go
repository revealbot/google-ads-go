...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AdGroupCriterionStatusEnum_AdGroupCriterionStatus", AdGroupCriterionStatusEnum_AdGroupCriterionStatus_name, AdGroupCriterionStatusEnum_AdGroupCriterionStatus_value)
	proto.RegisterType((*AdGroupCriterionStatusEnum)(nil), "google.ads.googleads.v9.enums.AdGroupCriterionStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/ad_group_criterion_status.proto", fileDescriptor_c2ee8cdd92377e78)
}
