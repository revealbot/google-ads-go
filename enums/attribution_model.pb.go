...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AttributionModelEnum_AttributionModel", AttributionModelEnum_AttributionModel_name, AttributionModelEnum_AttributionModel_value)
	proto.RegisterType((*AttributionModelEnum)(nil), "google.ads.googleads.v9.enums.AttributionModelEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/attribution_model.proto", fileDescriptor_366fd0c31136d523)
}
