...
const file_enums_distance_bucket_proto_rawDesc = "" +
	"\n" +
	...
	"\vWITHIN_700M\x10\x02\x12\x0e\n" +
	"\n" +
	"WITHIN_1KM\x10\x03\x12\x0e\n" +
	"\n" +
	"WITHIN_5KM\x10\x04\x12\x0f\n" +
	"\vWITHIN_10KM\x10\x05\x12\x0f\n" +
	"\vWITHIN_15KM\x10\x06\x12\x0f\n" +
	"\vWITHIN_20KM\x10\a\x12\x0f\n" +
	"\vWITHIN_25KM\x10\b\x12\x0f\n" +
	"\vWITHIN_30KM\x10\t\x12\x0f\n" +
	"\vWITHIN_35KM\x10\n" +
	"\x12\x0f\n" +
	"\vWITHIN_40KM\x10\v\x12\x0f\n" +
	"\vWITHIN_45KM\x10\f\x12\x0f\n" +
	"\vWITHIN_50KM\x10\r\x12\x0f\n" +
	"\vWITHIN_55KM\x10\x0e\x12\x0f\n" +
	"\vWITHIN_60KM\x10\x0f\x12\x0f\n" +
	"\vWITHIN_65KM\x10\x10\x12\x0f\n" +
	"\vBEYOND_65KM\x10\x11\x12\x13\n" +
	"\x0fWITHIN_0_7MILES\x10\x12\x12\x10\n" +
	"\fWITHIN_1MILE\x10\x13\x12\x11\n" +
	...
	"\"com.google.ads.googleads.v19.enumsB\x13DistanceBucketProtoP\x01ZCgithub.com/revealbot/google-ads-go/enums;enums\xa2\x02\x03GAA\xaa\x02\x1eGoogle.Ads.GoogleAds.V19.Enums\xca\x02\x1eGoogle\\Ads\\GoogleAds\\V19\\Enums\xea\x02\"Google::Ads::GoogleAds::V19::Enumsb\x06proto3"

var (
	file_enums_distance_bucket_proto_rawDescOnce sync.Once
	file_enums_distance_bucket_proto_rawDescData []byte
)

func file_enums_distance_bucket_proto_rawDescGZIP() []byte {
	file_enums_distance_bucket_proto_rawDescOnce.Do(func() {
		file_enums_distance_bucket_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_distance_bucket_proto_rawDesc), len(file_enums_distance_bucket_proto_rawDesc)))
	})
...
var file_enums_distance_bucket_proto_goTypes = []any{
	(DistanceBucketEnum_DistanceBucket)(0), // 0: google.ads.googleads.v19.enums.DistanceBucketEnum.DistanceBucket
	(*DistanceBucketEnum)(nil),             // 1: google.ads.googleads.v19.enums.DistanceBucketEnum
}
...
func file_enums_distance_bucket_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_distance_bucket_proto_rawDesc), len(file_enums_distance_bucket_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
