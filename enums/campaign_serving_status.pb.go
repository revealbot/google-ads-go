...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.CampaignServingStatusEnum_CampaignServingStatus", CampaignServingStatusEnum_CampaignServingStatus_name, CampaignServingStatusEnum_CampaignServingStatus_value)
	proto.RegisterType((*CampaignServingStatusEnum)(nil), "google.ads.googleads.v9.enums.CampaignServingStatusEnum")
}
