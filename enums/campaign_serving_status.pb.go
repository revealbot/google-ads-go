...
var file_enums_campaign_serving_status_proto_rawDesc = string([]byte{
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x90,
	...
	0x32, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1a, 0x43, 0x61, 0x6d, 0x70, 0x61, 0x69,
...
var (
	...
	file_enums_campaign_serving_status_proto_rawDescData []byte
)
...
func file_enums_campaign_serving_status_proto_rawDescGZIP() []byte {
	file_enums_campaign_serving_status_proto_rawDescOnce.Do(func() {
		file_enums_campaign_serving_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_campaign_serving_status_proto_rawDesc), len(file_enums_campaign_serving_status_proto_rawDesc)))
	})
...
var file_enums_campaign_serving_status_proto_goTypes = []any{
	(CampaignServingStatusEnum_CampaignServingStatus)(0), // 0: google.ads.googleads.v23.enums.CampaignServingStatusEnum.CampaignServingStatus
	(*CampaignServingStatusEnum)(nil),                    // 1: google.ads.googleads.v23.enums.CampaignServingStatusEnum
}
...
func file_enums_campaign_serving_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_campaign_serving_status_proto_rawDesc), len(file_enums_campaign_serving_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
