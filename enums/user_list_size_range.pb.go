...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.UserListSizeRangeEnum_UserListSizeRange", UserListSizeRangeEnum_UserListSizeRange_name, UserListSizeRangeEnum_UserListSizeRange_value)
	proto.RegisterType((*UserListSizeRangeEnum)(nil), "google.ads.googleads.v9.enums.UserListSizeRangeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/user_list_size_range.proto", fileDescriptor_3a40c75ce1845965)
}
