...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.TargetCpaOptInRecommendationGoalEnum_TargetCpaOptInRecommendationGoal", TargetCpaOptInRecommendationGoalEnum_TargetCpaOptInRecommendationGoal_name, TargetCpaOptInRecommendationGoalEnum_TargetCpaOptInRecommendationGoal_value)
	proto.RegisterType((*TargetCpaOptInRecommendationGoalEnum)(nil), "google.ads.googleads.v9.enums.TargetCpaOptInRecommendationGoalEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/target_cpa_opt_in_recommendation_goal.proto", fileDescriptor_dc9d21c9a1242949)
}
