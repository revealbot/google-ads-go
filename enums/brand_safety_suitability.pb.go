...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.BrandSafetySuitabilityEnum_BrandSafetySuitability", BrandSafetySuitabilityEnum_BrandSafetySuitability_name, BrandSafetySuitabilityEnum_BrandSafetySuitability_value)
	proto.RegisterType((*BrandSafetySuitabilityEnum)(nil), "google.ads.googleads.v9.enums.BrandSafetySuitabilityEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/brand_safety_suitability.proto", fileDescriptor_74afa050660274a2)
}
