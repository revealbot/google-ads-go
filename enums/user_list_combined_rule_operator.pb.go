...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator", UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator_name, UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator_value)
	proto.RegisterType((*UserListCombinedRuleOperatorEnum)(nil), "google.ads.googleads.v9.enums.UserListCombinedRuleOperatorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/user_list_combined_rule_operator.proto", fileDescriptor_034f708ac8797103)
}
