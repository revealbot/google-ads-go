...
var file_enums_brand_request_rejection_reason_proto_goTypes = []interface{}{
...
func file_enums_brand_request_rejection_reason_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_brand_request_rejection_reason_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
