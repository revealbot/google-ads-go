...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.EducationPlaceholderFieldEnum_EducationPlaceholderField", EducationPlaceholderFieldEnum_EducationPlaceholderField_name, EducationPlaceholderFieldEnum_EducationPlaceholderField_value)
	proto.RegisterType((*EducationPlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.EducationPlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/education_placeholder_field.proto", fileDescriptor_1a3ec5ae50171f23)
}
