...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.TrackingCodePageFormatEnum_TrackingCodePageFormat", TrackingCodePageFormatEnum_TrackingCodePageFormat_name, TrackingCodePageFormatEnum_TrackingCodePageFormat_value)
	proto.RegisterType((*TrackingCodePageFormatEnum)(nil), "google.ads.googleads.v9.enums.TrackingCodePageFormatEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/tracking_code_page_format.proto", fileDescriptor_848931c9545ebcbb)
}
