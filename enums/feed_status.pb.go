...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedStatusEnum_FeedStatus", FeedStatusEnum_FeedStatus_name, FeedStatusEnum_FeedStatus_value)
	proto.RegisterType((*FeedStatusEnum)(nil), "google.ads.googleads.v9.enums.FeedStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/feed_status.proto", fileDescriptor_951faa65c5f1c081)
}
