...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FrequencyCapEventTypeEnum_FrequencyCapEventType", FrequencyCapEventTypeEnum_FrequencyCapEventType_name, FrequencyCapEventTypeEnum_FrequencyCapEventType_value)
	proto.RegisterType((*FrequencyCapEventTypeEnum)(nil), "google.ads.googleads.v9.enums.FrequencyCapEventTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/frequency_cap_event_type.proto", fileDescriptor_efbfc2d312038533)
}
