...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.SearchTermTargetingStatusEnum_SearchTermTargetingStatus", SearchTermTargetingStatusEnum_SearchTermTargetingStatus_name, SearchTermTargetingStatusEnum_SearchTermTargetingStatus_value)
	proto.RegisterType((*SearchTermTargetingStatusEnum)(nil), "google.ads.googleads.v9.enums.SearchTermTargetingStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/search_term_targeting_status.proto", fileDescriptor_7ac067e7cfba810f)
}
