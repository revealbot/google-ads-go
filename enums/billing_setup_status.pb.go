...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.BillingSetupStatusEnum_BillingSetupStatus", BillingSetupStatusEnum_BillingSetupStatus_name, BillingSetupStatusEnum_BillingSetupStatus_value)
	proto.RegisterType((*BillingSetupStatusEnum)(nil), "google.ads.googleads.v9.enums.BillingSetupStatusEnum")
}
