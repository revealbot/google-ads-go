...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ConversionActionTypeEnum_ConversionActionType", ConversionActionTypeEnum_ConversionActionType_name, ConversionActionTypeEnum_ConversionActionType_value)
	proto.RegisterType((*ConversionActionTypeEnum)(nil), "google.ads.googleads.v9.enums.ConversionActionTypeEnum")
}
