...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ConversionActionCountingTypeEnum_ConversionActionCountingType", ConversionActionCountingTypeEnum_ConversionActionCountingType_name, ConversionActionCountingTypeEnum_ConversionActionCountingType_value)
	proto.RegisterType((*ConversionActionCountingTypeEnum)(nil), "google.ads.googleads.v9.enums.ConversionActionCountingTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/conversion_action_counting_type.proto", fileDescriptor_08e0308733589fad)
}
