...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ListingGroupTypeEnum_ListingGroupType", ListingGroupTypeEnum_ListingGroupType_name, ListingGroupTypeEnum_ListingGroupType_value)
	proto.RegisterType((*ListingGroupTypeEnum)(nil), "google.ads.googleads.v9.enums.ListingGroupTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/listing_group_type.proto", fileDescriptor_9396e74fe0a1e231)
}
