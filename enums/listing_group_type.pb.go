...
var file_enums_listing_group_type_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x63, 0x0a, 0x14, 0x4c, 0x69, 0x73,
...
var (
	...
	file_enums_listing_group_type_proto_rawDescData []byte
)

func file_enums_listing_group_type_proto_rawDescGZIP() []byte {
	file_enums_listing_group_type_proto_rawDescOnce.Do(func() {
		file_enums_listing_group_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_listing_group_type_proto_rawDesc), len(file_enums_listing_group_type_proto_rawDesc)))
	})
...
var file_enums_listing_group_type_proto_goTypes = []any{
	(ListingGroupTypeEnum_ListingGroupType)(0), // 0: google.ads.googleads.v22.enums.ListingGroupTypeEnum.ListingGroupType
	(*ListingGroupTypeEnum)(nil),               // 1: google.ads.googleads.v22.enums.ListingGroupTypeEnum
}
...
func file_enums_listing_group_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_listing_group_type_proto_rawDesc), len(file_enums_listing_group_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
