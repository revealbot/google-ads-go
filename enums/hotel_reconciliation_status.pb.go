...
var file_enums_hotel_reconciliation_status_proto_rawDesc = string([]byte{
	...
	0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1e, 0x48, 0x6f, 0x74, 0x65, 0x6c,
...
var (
	...
	file_enums_hotel_reconciliation_status_proto_rawDescData []byte
)
...
func file_enums_hotel_reconciliation_status_proto_rawDescGZIP() []byte {
	file_enums_hotel_reconciliation_status_proto_rawDescOnce.Do(func() {
		file_enums_hotel_reconciliation_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_hotel_reconciliation_status_proto_rawDesc), len(file_enums_hotel_reconciliation_status_proto_rawDesc)))
	})
...
var file_enums_hotel_reconciliation_status_proto_goTypes = []any{
	(HotelReconciliationStatusEnum_HotelReconciliationStatus)(0), // 0: google.ads.googleads.v19.enums.HotelReconciliationStatusEnum.HotelReconciliationStatus
	(*HotelReconciliationStatusEnum)(nil),                        // 1: google.ads.googleads.v19.enums.HotelReconciliationStatusEnum
}
...
func file_enums_hotel_reconciliation_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_hotel_reconciliation_status_proto_rawDesc), len(file_enums_hotel_reconciliation_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
