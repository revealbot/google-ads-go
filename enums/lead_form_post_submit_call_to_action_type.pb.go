...
const file_enums_lead_form_post_submit_call_to_action_type_proto_rawDesc = "" +
	"\n" +
	...
	"\n" +
	"VISIT_SITE\x10\x02\x12\f\n" +
	"\bDOWNLOAD\x10\x03\x12\x0e\n" +
	"\n" +
	"LEARN_MORE\x10\x04\x12\f\n" +
	"\bSHOP_NOW\x10\x05B\x81\x02\n" +
	"\"com.google.ads.googleads.v19.enumsB'LeadFormPostSubmitCallToActionTypeProtoP\x01ZCgithub.com/revealbot/google-ads-go/enums;enums\xa2\x02\x03GAA\xaa\x02\x1eGoogle.Ads.GoogleAds.V19.Enums\xca\x02\x1eGoogle\\Ads\\GoogleAds\\V19\\Enums\xea\x02\"Google::Ads::GoogleAds::V19::Enumsb\x06proto3"

var (
	file_enums_lead_form_post_submit_call_to_action_type_proto_rawDescOnce sync.Once
	file_enums_lead_form_post_submit_call_to_action_type_proto_rawDescData []byte
)
...
func file_enums_lead_form_post_submit_call_to_action_type_proto_rawDescGZIP() []byte {
	file_enums_lead_form_post_submit_call_to_action_type_proto_rawDescOnce.Do(func() {
		file_enums_lead_form_post_submit_call_to_action_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_lead_form_post_submit_call_to_action_type_proto_rawDesc), len(file_enums_lead_form_post_submit_call_to_action_type_proto_rawDesc)))
	})
...
var file_enums_lead_form_post_submit_call_to_action_type_proto_goTypes = []any{
	(LeadFormPostSubmitCallToActionTypeEnum_LeadFormPostSubmitCallToActionType)(0), // 0: google.ads.googleads.v19.enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType
	(*LeadFormPostSubmitCallToActionTypeEnum)(nil),                                 // 1: google.ads.googleads.v19.enums.LeadFormPostSubmitCallToActionTypeEnum
}
...
func file_enums_lead_form_post_submit_call_to_action_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_lead_form_post_submit_call_to_action_type_proto_rawDesc), len(file_enums_lead_form_post_submit_call_to_action_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
