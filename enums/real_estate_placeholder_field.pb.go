...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField", RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField_name, RealEstatePlaceholderFieldEnum_RealEstatePlaceholderField_value)
	proto.RegisterType((*RealEstatePlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.RealEstatePlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/real_estate_placeholder_field.proto", fileDescriptor_c04d0eb05cf0a60d)
}
