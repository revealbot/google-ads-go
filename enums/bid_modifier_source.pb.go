...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.BidModifierSourceEnum_BidModifierSource", BidModifierSourceEnum_BidModifierSource_name, BidModifierSourceEnum_BidModifierSource_value)
	proto.RegisterType((*BidModifierSourceEnum)(nil), "google.ads.googleads.v9.enums.BidModifierSourceEnum")
}
