...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.MonthOfYearEnum_MonthOfYear", MonthOfYearEnum_MonthOfYear_name, MonthOfYearEnum_MonthOfYear_value)
	proto.RegisterType((*MonthOfYearEnum)(nil), "google.ads.googleads.v9.enums.MonthOfYearEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/month_of_year.proto", fileDescriptor_818b466f6f136db3)
}
