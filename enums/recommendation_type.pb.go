...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.RecommendationTypeEnum_RecommendationType", RecommendationTypeEnum_RecommendationType_name, RecommendationTypeEnum_RecommendationType_value)
	proto.RegisterType((*RecommendationTypeEnum)(nil), "google.ads.googleads.v9.enums.RecommendationTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/recommendation_type.proto", fileDescriptor_81cf7cb357477a07)
}
