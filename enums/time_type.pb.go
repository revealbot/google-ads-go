...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.TimeTypeEnum_TimeType", TimeTypeEnum_TimeType_name, TimeTypeEnum_TimeType_value)
	proto.RegisterType((*TimeTypeEnum)(nil), "google.ads.googleads.v9.enums.TimeTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/time_type.proto", fileDescriptor_db98fd16f58bf0c8)
}
