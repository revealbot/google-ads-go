...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.SlotEnum_Slot", SlotEnum_Slot_name, SlotEnum_Slot_value)
	proto.RegisterType((*SlotEnum)(nil), "google.ads.googleads.v9.enums.SlotEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/slot.proto", fileDescriptor_462bd62c3707a42e)
}
