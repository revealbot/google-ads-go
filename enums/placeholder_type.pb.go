...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.PlaceholderTypeEnum_PlaceholderType", PlaceholderTypeEnum_PlaceholderType_name, PlaceholderTypeEnum_PlaceholderType_value)
	proto.RegisterType((*PlaceholderTypeEnum)(nil), "google.ads.googleads.v9.enums.PlaceholderTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/placeholder_type.proto", fileDescriptor_fb2dffc21704d253)
}
