...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AdGroupAdStatusEnum_AdGroupAdStatus", AdGroupAdStatusEnum_AdGroupAdStatus_name, AdGroupAdStatusEnum_AdGroupAdStatus_value)
	proto.RegisterType((*AdGroupAdStatusEnum)(nil), "google.ads.googleads.v9.enums.AdGroupAdStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/ad_group_ad_status.proto", fileDescriptor_137acffc11908561)
}
