...
var file_enums_ad_group_criterion_primary_status_reason_proto_goTypes = []interface{}{
	(AdGroupCriterionPrimaryStatusReasonEnum_AdGroupCriterionPrimaryStatusReason)(0), // 0: google.ads.googleads.v18.enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason
	(*AdGroupCriterionPrimaryStatusReasonEnum)(nil),                                  // 1: google.ads.googleads.v18.enums.AdGroupCriterionPrimaryStatusReasonEnum
}
...
func file_enums_ad_group_criterion_primary_status_reason_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_ad_group_criterion_primary_status_reason_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
