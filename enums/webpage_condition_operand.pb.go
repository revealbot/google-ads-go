...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.WebpageConditionOperandEnum_WebpageConditionOperand", WebpageConditionOperandEnum_WebpageConditionOperand_name, WebpageConditionOperandEnum_WebpageConditionOperand_value)
	proto.RegisterType((*WebpageConditionOperandEnum)(nil), "google.ads.googleads.v9.enums.WebpageConditionOperandEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/webpage_condition_operand.proto", fileDescriptor_bb30d5cf3c48daa9)
}
