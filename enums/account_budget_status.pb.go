...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AccountBudgetStatusEnum_AccountBudgetStatus", AccountBudgetStatusEnum_AccountBudgetStatus_name, AccountBudgetStatusEnum_AccountBudgetStatus_value)
	proto.RegisterType((*AccountBudgetStatusEnum)(nil), "google.ads.googleads.v9.enums.AccountBudgetStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/account_budget_status.proto", fileDescriptor_a2d8514b5c9a0207)
}
