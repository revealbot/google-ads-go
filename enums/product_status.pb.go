...
var file_enums_product_status_proto_goTypes = []interface{}{
	(ProductStatusEnum_ProductStatus)(0), // 0: google.ads.googleads.v18.enums.ProductStatusEnum.ProductStatus
	(*ProductStatusEnum)(nil),            // 1: google.ads.googleads.v18.enums.ProductStatusEnum
}
...
func file_enums_product_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_product_status_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
