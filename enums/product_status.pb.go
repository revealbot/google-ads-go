...
var file_enums_product_status_proto_rawDesc = string([]byte{
...
var (
	...
	file_enums_product_status_proto_rawDescData []byte
)

func file_enums_product_status_proto_rawDescGZIP() []byte {
	file_enums_product_status_proto_rawDescOnce.Do(func() {
		file_enums_product_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_product_status_proto_rawDesc), len(file_enums_product_status_proto_rawDesc)))
	})
...
var file_enums_product_status_proto_goTypes = []any{
	(ProductStatusEnum_ProductStatus)(0), // 0: google.ads.googleads.v25.enums.ProductStatusEnum.ProductStatus
	(*ProductStatusEnum)(nil),            // 1: google.ads.googleads.v25.enums.ProductStatusEnum
}
...
func file_enums_product_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_product_status_proto_rawDesc), len(file_enums_product_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
