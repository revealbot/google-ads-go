...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ProductTypeLevelEnum_ProductTypeLevel", ProductTypeLevelEnum_ProductTypeLevel_name, ProductTypeLevelEnum_ProductTypeLevel_value)
	proto.RegisterType((*ProductTypeLevelEnum)(nil), "google.ads.googleads.v9.enums.ProductTypeLevelEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/product_type_level.proto", fileDescriptor_e043cc8b365cce4a)
}
