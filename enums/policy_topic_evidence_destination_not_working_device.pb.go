...
var file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xa7, 0x01, 0x0a, 0x32,
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x33, 0x50, 0x6f,
...
var (
	...
	file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDescData []byte
)
...
func file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDescGZIP() []byte {
	file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDescOnce.Do(func() {
		file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDesc), len(file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDesc)))
	})
...
var file_enums_policy_topic_evidence_destination_not_working_device_proto_goTypes = []any{
	(PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice)(0), // 0: google.ads.googleads.v22.enums.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum.PolicyTopicEvidenceDestinationNotWorkingDevice
	(*PolicyTopicEvidenceDestinationNotWorkingDeviceEnum)(nil),                                             // 1: google.ads.googleads.v22.enums.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum
}
...
func file_enums_policy_topic_evidence_destination_not_working_device_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDesc), len(file_enums_policy_topic_evidence_destination_not_working_device_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
