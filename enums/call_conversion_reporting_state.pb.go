...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.CallConversionReportingStateEnum_CallConversionReportingState", CallConversionReportingStateEnum_CallConversionReportingState_name, CallConversionReportingStateEnum_CallConversionReportingState_value)
	proto.RegisterType((*CallConversionReportingStateEnum)(nil), "google.ads.googleads.v9.enums.CallConversionReportingStateEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/call_conversion_reporting_state.proto", fileDescriptor_4b610740b7ec432e)
}
