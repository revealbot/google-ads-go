...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.PreferredContentTypeEnum_PreferredContentType", PreferredContentTypeEnum_PreferredContentType_name, PreferredContentTypeEnum_PreferredContentType_value)
	proto.RegisterType((*PreferredContentTypeEnum)(nil), "google.ads.googleads.v9.enums.PreferredContentTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/preferred_content_type.proto", fileDescriptor_77aec66b6fddff76)
}
