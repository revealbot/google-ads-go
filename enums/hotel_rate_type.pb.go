...
var file_enums_hotel_rate_type_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x32, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x12, 0x48, 0x6f, 0x74, 0x65,
...
var (
	...
	file_enums_hotel_rate_type_proto_rawDescData []byte
)

func file_enums_hotel_rate_type_proto_rawDescGZIP() []byte {
	file_enums_hotel_rate_type_proto_rawDescOnce.Do(func() {
		file_enums_hotel_rate_type_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_hotel_rate_type_proto_rawDesc), len(file_enums_hotel_rate_type_proto_rawDesc)))
	})
...
var file_enums_hotel_rate_type_proto_goTypes = []any{
	(HotelRateTypeEnum_HotelRateType)(0), // 0: google.ads.googleads.v23.enums.HotelRateTypeEnum.HotelRateType
	(*HotelRateTypeEnum)(nil),            // 1: google.ads.googleads.v23.enums.HotelRateTypeEnum
}
...
func file_enums_hotel_rate_type_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_hotel_rate_type_proto_rawDesc), len(file_enums_hotel_rate_type_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
