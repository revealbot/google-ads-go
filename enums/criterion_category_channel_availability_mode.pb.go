...
func init() {
	...
	proto.RegisterType((*CriterionCategoryChannelAvailabilityModeEnum)(nil), "google.ads.googleads.v9.enums.CriterionCategoryChannelAvailabilityModeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/criterion_category_channel_availability_mode.proto", fileDescriptor_7f19122d0911e057)
}
