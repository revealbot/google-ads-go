...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.TrackingCodeTypeEnum_TrackingCodeType", TrackingCodeTypeEnum_TrackingCodeType_name, TrackingCodeTypeEnum_TrackingCodeType_value)
	proto.RegisterType((*TrackingCodeTypeEnum)(nil), "google.ads.googleads.v9.enums.TrackingCodeTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/tracking_code_type.proto", fileDescriptor_1b23766bb1613558)
}
