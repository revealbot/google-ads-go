...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ProductChannelExclusivityEnum_ProductChannelExclusivity", ProductChannelExclusivityEnum_ProductChannelExclusivity_name, ProductChannelExclusivityEnum_ProductChannelExclusivity_value)
	proto.RegisterType((*ProductChannelExclusivityEnum)(nil), "google.ads.googleads.v9.enums.ProductChannelExclusivityEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/product_channel_exclusivity.proto", fileDescriptor_50e6b25d94602134)
}
