...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AccountBudgetProposalTypeEnum_AccountBudgetProposalType", AccountBudgetProposalTypeEnum_AccountBudgetProposalType_name, AccountBudgetProposalTypeEnum_AccountBudgetProposalType_value)
	proto.RegisterType((*AccountBudgetProposalTypeEnum)(nil), "google.ads.googleads.v9.enums.AccountBudgetProposalTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/account_budget_proposal_type.proto", fileDescriptor_e4054eac1d8ee3ce)
}
