...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason", FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason_name, FeedItemQualityDisapprovalReasonEnum_FeedItemQualityDisapprovalReason_value)
	proto.RegisterType((*FeedItemQualityDisapprovalReasonEnum)(nil), "google.ads.googleads.v9.enums.FeedItemQualityDisapprovalReasonEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/feed_item_quality_disapproval_reason.proto", fileDescriptor_530ed7377f60bcff)
}
