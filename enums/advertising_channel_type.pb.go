...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AdvertisingChannelTypeEnum_AdvertisingChannelType", AdvertisingChannelTypeEnum_AdvertisingChannelType_name, AdvertisingChannelTypeEnum_AdvertisingChannelType_value)
	proto.RegisterType((*AdvertisingChannelTypeEnum)(nil), "google.ads.googleads.v9.enums.AdvertisingChannelTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/advertising_channel_type.proto", fileDescriptor_5ca0623e213c8eb5)
}
