...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedMappingCriterionTypeEnum_FeedMappingCriterionType", FeedMappingCriterionTypeEnum_FeedMappingCriterionType_name, FeedMappingCriterionTypeEnum_FeedMappingCriterionType_value)
	proto.RegisterType((*FeedMappingCriterionTypeEnum)(nil), "google.ads.googleads.v9.enums.FeedMappingCriterionTypeEnum")
}
