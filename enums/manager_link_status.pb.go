...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.ManagerLinkStatusEnum_ManagerLinkStatus", ManagerLinkStatusEnum_ManagerLinkStatus_name, ManagerLinkStatusEnum_ManagerLinkStatus_value)
	proto.RegisterType((*ManagerLinkStatusEnum)(nil), "google.ads.googleads.v9.enums.ManagerLinkStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/manager_link_status.proto", fileDescriptor_d32c2897d7859b1c)
}
