...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.BudgetStatusEnum_BudgetStatus", BudgetStatusEnum_BudgetStatus_name, BudgetStatusEnum_BudgetStatus_value)
	proto.RegisterType((*BudgetStatusEnum)(nil), "google.ads.googleads.v9.enums.BudgetStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/budget_status.proto", fileDescriptor_d40ae52141cda825)
}
