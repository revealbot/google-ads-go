...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.GeoTargetingRestrictionEnum_GeoTargetingRestriction", GeoTargetingRestrictionEnum_GeoTargetingRestriction_name, GeoTargetingRestrictionEnum_GeoTargetingRestriction_value)
	proto.RegisterType((*GeoTargetingRestrictionEnum)(nil), "google.ads.googleads.v9.enums.GeoTargetingRestrictionEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/geo_targeting_restriction.proto", fileDescriptor_b286afe291ca7a3b)
}
