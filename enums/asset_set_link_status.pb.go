...
var file_enums_asset_set_link_status_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x66, 0x0a, 0x16,
	...
	0x73, 0x2e, 0x76, 0x32, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x17, 0x41, 0x73, 0x73,
...
var (
	...
	file_enums_asset_set_link_status_proto_rawDescData []byte
)

func file_enums_asset_set_link_status_proto_rawDescGZIP() []byte {
	file_enums_asset_set_link_status_proto_rawDescOnce.Do(func() {
		file_enums_asset_set_link_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_asset_set_link_status_proto_rawDesc), len(file_enums_asset_set_link_status_proto_rawDesc)))
	})
...
var file_enums_asset_set_link_status_proto_goTypes = []any{
	(AssetSetLinkStatusEnum_AssetSetLinkStatus)(0), // 0: google.ads.googleads.v23.enums.AssetSetLinkStatusEnum.AssetSetLinkStatus
	(*AssetSetLinkStatusEnum)(nil),                 // 1: google.ads.googleads.v23.enums.AssetSetLinkStatusEnum
}
...
func file_enums_asset_set_link_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_asset_set_link_status_proto_rawDesc), len(file_enums_asset_set_link_status_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
