...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval", KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval_name, KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval_value)
	proto.RegisterType((*KeywordPlanForecastIntervalEnum)(nil), "google.ads.googleads.v9.enums.KeywordPlanForecastIntervalEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/keyword_plan_forecast_interval.proto", fileDescriptor_3006cd39703dad17)
}
