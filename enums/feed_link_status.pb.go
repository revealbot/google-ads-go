...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedLinkStatusEnum_FeedLinkStatus", FeedLinkStatusEnum_FeedLinkStatus_name, FeedLinkStatusEnum_FeedLinkStatus_value)
	proto.RegisterType((*FeedLinkStatusEnum)(nil), "google.ads.googleads.v9.enums.FeedLinkStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/feed_link_status.proto", fileDescriptor_220be290d1e4ef70)
}
