...
var file_enums_ad_group_primary_status_reason_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x1f, 0x41, 0x64, 0x47, 0x72, 0x6f,
...
var file_enums_ad_group_primary_status_reason_proto_goTypes = []interface{}{
	(AdGroupPrimaryStatusReasonEnum_AdGroupPrimaryStatusReason)(0), // 0: google.ads.googleads.v18.enums.AdGroupPrimaryStatusReasonEnum.AdGroupPrimaryStatusReason
	(*AdGroupPrimaryStatusReasonEnum)(nil),                         // 1: google.ads.googleads.v18.enums.AdGroupPrimaryStatusReasonEnum
}
...
func file_enums_ad_group_primary_status_reason_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_enums_ad_group_primary_status_reason_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
