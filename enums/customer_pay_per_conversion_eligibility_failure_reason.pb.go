...
var file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xd1, 0x02,
	...
	0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x35, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d,
...
var (
	...
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescData []byte
)
...
func file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescGZIP() []byte {
	file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescOnce.Do(func() {
		file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc), len(file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc)))
	})
...
var file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_goTypes = []any{
	(CustomerPayPerConversionEligibilityFailureReasonEnum_CustomerPayPerConversionEligibilityFailureReason)(0), // 0: google.ads.googleads.v19.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason
	(*CustomerPayPerConversionEligibilityFailureReasonEnum)(nil),                                               // 1: google.ads.googleads.v19.enums.CustomerPayPerConversionEligibilityFailureReasonEnum
}
...
func file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc), len(file_enums_customer_pay_per_conversion_eligibility_failure_reason_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
