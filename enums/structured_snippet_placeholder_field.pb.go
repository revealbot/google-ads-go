...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.StructuredSnippetPlaceholderFieldEnum_StructuredSnippetPlaceholderField", StructuredSnippetPlaceholderFieldEnum_StructuredSnippetPlaceholderField_name, StructuredSnippetPlaceholderFieldEnum_StructuredSnippetPlaceholderField_value)
	proto.RegisterType((*StructuredSnippetPlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.StructuredSnippetPlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/structured_snippet_placeholder_field.proto", fileDescriptor_997bec349c946d49)
}
