...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory", GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory_name, GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory_value)
	proto.RegisterType((*GoogleAdsFieldCategoryEnum)(nil), "google.ads.googleads.v9.enums.GoogleAdsFieldCategoryEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/google_ads_field_category.proto", fileDescriptor_7a2203e6b4ff88dd)
}
