...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.MessagePlaceholderFieldEnum_MessagePlaceholderField", MessagePlaceholderFieldEnum_MessagePlaceholderField_name, MessagePlaceholderFieldEnum_MessagePlaceholderField_value)
	proto.RegisterType((*MessagePlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.MessagePlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/message_placeholder_field.proto", fileDescriptor_524e7aae95a8a6af)
}
