...
var file_enums_device_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0x76, 0x0a,
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x0b, 0x44, 0x65,
...
var (
	...
	file_enums_device_proto_rawDescData []byte
)

func file_enums_device_proto_rawDescGZIP() []byte {
	file_enums_device_proto_rawDescOnce.Do(func() {
		file_enums_device_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_device_proto_rawDesc), len(file_enums_device_proto_rawDesc)))
	})
...
var file_enums_device_proto_goTypes = []any{
	(DeviceEnum_Device)(0), // 0: google.ads.googleads.v19.enums.DeviceEnum.Device
	(*DeviceEnum)(nil),     // 1: google.ads.googleads.v19.enums.DeviceEnum
}
...
func file_enums_device_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_device_proto_rawDesc), len(file_enums_device_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
