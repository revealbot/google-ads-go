...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.DeviceEnum_Device", DeviceEnum_Device_name, DeviceEnum_Device_value)
	proto.RegisterType((*DeviceEnum)(nil), "google.ads.googleads.v9.enums.DeviceEnum")
}
