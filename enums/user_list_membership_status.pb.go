...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.UserListMembershipStatusEnum_UserListMembershipStatus", UserListMembershipStatusEnum_UserListMembershipStatus_name, UserListMembershipStatusEnum_UserListMembershipStatus_value)
	proto.RegisterType((*UserListMembershipStatusEnum)(nil), "google.ads.googleads.v9.enums.UserListMembershipStatusEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/user_list_membership_status.proto", fileDescriptor_14fcc396189ed519)
}
