...
var file_enums_sk_ad_network_coarse_conversion_value_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x22, 0xa2, 0x01, 0x0a,
	...
	0x31, 0x39, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x42, 0x25, 0x53, 0x6b, 0x41, 0x64, 0x4e, 0x65,
...
var (
	...
	file_enums_sk_ad_network_coarse_conversion_value_proto_rawDescData []byte
)
...
func file_enums_sk_ad_network_coarse_conversion_value_proto_rawDescGZIP() []byte {
	file_enums_sk_ad_network_coarse_conversion_value_proto_rawDescOnce.Do(func() {
		file_enums_sk_ad_network_coarse_conversion_value_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_sk_ad_network_coarse_conversion_value_proto_rawDesc), len(file_enums_sk_ad_network_coarse_conversion_value_proto_rawDesc)))
	})
...
var file_enums_sk_ad_network_coarse_conversion_value_proto_goTypes = []any{
	(SkAdNetworkCoarseConversionValueEnum_SkAdNetworkCoarseConversionValue)(0), // 0: google.ads.googleads.v19.enums.SkAdNetworkCoarseConversionValueEnum.SkAdNetworkCoarseConversionValue
	(*SkAdNetworkCoarseConversionValueEnum)(nil),                               // 1: google.ads.googleads.v19.enums.SkAdNetworkCoarseConversionValueEnum
}
...
func file_enums_sk_ad_network_coarse_conversion_value_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_sk_ad_network_coarse_conversion_value_proto_rawDesc), len(file_enums_sk_ad_network_coarse_conversion_value_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
