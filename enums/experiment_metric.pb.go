...
const file_enums_experiment_metric_proto_rawDesc = "" +
	"\n" +
	...
	"\vIMPRESSIONS\x10\x03\x12\b\n" +
	"\x04COST\x10\x04\x12$\n" +
	" CONVERSIONS_PER_INTERACTION_RATE\x10\x05\x12\x17\n" +
	"\x13COST_PER_CONVERSION\x10\x06\x12\x1e\n" +
	"\x1aCONVERSIONS_VALUE_PER_COST\x10\a\x12\x0f\n" +
	"\vAVERAGE_CPC\x10\b\x12\a\n" +
	"\x03CTR\x10\t\x12\x1b\n" +
	"\x17INCREMENTAL_CONVERSIONS\x10\n" +
	"\x12\x19\n" +
	"\x15COMPLETED_VIDEO_VIEWS\x10\v\x12\x15\n" +
	"\x11CUSTOM_ALGORITHMS\x10\f\x12\x0f\n" +
	"\vCONVERSIONS\x10\r\x12\x14\n" +
	"\x10CONVERSION_VALUE\x10\x0eB\xef\x01\n" +
	"\"com.google.ads.googleads.v19.enumsB\x15ExperimentMetricProtoP\x01ZCgithub.com/revealbot/google-ads-go/enums;enums\xa2\x02\x03GAA\xaa\x02\x1eGoogle.Ads.GoogleAds.V19.Enums\xca\x02\x1eGoogle\\Ads\\GoogleAds\\V19\\Enums\xea\x02\"Google::Ads::GoogleAds::V19::Enumsb\x06proto3"

var (
	file_enums_experiment_metric_proto_rawDescOnce sync.Once
	file_enums_experiment_metric_proto_rawDescData []byte
)

func file_enums_experiment_metric_proto_rawDescGZIP() []byte {
	file_enums_experiment_metric_proto_rawDescOnce.Do(func() {
		file_enums_experiment_metric_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_enums_experiment_metric_proto_rawDesc), len(file_enums_experiment_metric_proto_rawDesc)))
	})
...
var file_enums_experiment_metric_proto_goTypes = []any{
	(ExperimentMetricEnum_ExperimentMetric)(0), // 0: google.ads.googleads.v19.enums.ExperimentMetricEnum.ExperimentMetric
	(*ExperimentMetricEnum)(nil),               // 1: google.ads.googleads.v19.enums.ExperimentMetricEnum
}
...
func file_enums_experiment_metric_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_enums_experiment_metric_proto_rawDesc), len(file_enums_experiment_metric_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
