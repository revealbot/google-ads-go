...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.DayOfWeekEnum_DayOfWeek", DayOfWeekEnum_DayOfWeek_name, DayOfWeekEnum_DayOfWeek_value)
	proto.RegisterType((*DayOfWeekEnum)(nil), "google.ads.googleads.v9.enums.DayOfWeekEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/day_of_week.proto", fileDescriptor_e8f57aab9f85f172)
}
