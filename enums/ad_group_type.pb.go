...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.AdGroupTypeEnum_AdGroupType", AdGroupTypeEnum_AdGroupType_name, AdGroupTypeEnum_AdGroupType_value)
	proto.RegisterType((*AdGroupTypeEnum)(nil), "google.ads.googleads.v9.enums.AdGroupTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/ad_group_type.proto", fileDescriptor_8c46b57a6e6d6241)
}
