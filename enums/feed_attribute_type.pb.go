...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.FeedAttributeTypeEnum_FeedAttributeType", FeedAttributeTypeEnum_FeedAttributeType_name, FeedAttributeTypeEnum_FeedAttributeType_value)
	proto.RegisterType((*FeedAttributeTypeEnum)(nil), "google.ads.googleads.v9.enums.FeedAttributeTypeEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/feed_attribute_type.proto", fileDescriptor_d63f2bf2722bc1cb)
}
