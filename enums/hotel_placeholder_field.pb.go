...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.enums.HotelPlaceholderFieldEnum_HotelPlaceholderField", HotelPlaceholderFieldEnum_HotelPlaceholderField_name, HotelPlaceholderFieldEnum_HotelPlaceholderField_value)
	proto.RegisterType((*HotelPlaceholderFieldEnum)(nil), "google.ads.googleads.v9.enums.HotelPlaceholderFieldEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/enums/hotel_placeholder_field.proto", fileDescriptor_78e68f4dfc7cb4e5)
}
