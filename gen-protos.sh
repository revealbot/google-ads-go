...
PROTOS_ENUMS=googleapis/google/ads/googleads/v25/enums/*.proto
PROTOS_ERRORS=googleapis/google/ads/googleads/v25/errors/*.proto
...
function compile_protos() {
    ...
    for file in $PROTOS; do
        ...
        # GO_PACKAGE="\"github.com/revealbot/google-ads-go/protos/google/ads/googleads/v25/$PACKAGE\""
