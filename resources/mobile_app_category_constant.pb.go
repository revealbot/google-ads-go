...
func init() {
	proto.RegisterType((*MobileAppCategoryConstant)(nil), "google.ads.googleads.v9.resources.MobileAppCategoryConstant")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/mobile_app_category_constant.proto", fileDescriptor_900bf8ccc40dca73)
}
