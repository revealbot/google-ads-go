...
func init() {
	proto.RegisterType((*UserInterest)(nil), "google.ads.googleads.v9.resources.UserInterest")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/user_interest.proto", fileDescriptor_0e4da83d83489504)
}
