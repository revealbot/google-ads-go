...
type ProductCategoryConstant struct {
	...
	Level enums.ProductCategoryLevelEnum_ProductCategoryLevel `protobuf:"varint,4,opt,name=level,proto3,enum=google.ads.googleads.v18.enums.ProductCategoryLevelEnum_ProductCategoryLevel" json:"level,omitempty"`
	// Output only. State of the product category.
	State enums.ProductCategoryStateEnum_ProductCategoryState `protobuf:"varint,5,opt,name=state,proto3,enum=google.ads.googleads.v18.enums.ProductCategoryStateEnum_ProductCategoryState" json:"state,omitempty"`
...
var file_resources_product_category_constant_proto_goTypes = []interface{}{
	(*ProductCategoryConstant)(nil),                             // 0: google.ads.googleads.v18.resources.ProductCategoryConstant
	(*ProductCategoryConstant_ProductCategoryLocalization)(nil), // 1: google.ads.googleads.v18.resources.ProductCategoryConstant.ProductCategoryLocalization
	(enums.ProductCategoryLevelEnum_ProductCategoryLevel)(0),    // 2: google.ads.googleads.v18.enums.ProductCategoryLevelEnum.ProductCategoryLevel
	(enums.ProductCategoryStateEnum_ProductCategoryState)(0),    // 3: google.ads.googleads.v18.enums.ProductCategoryStateEnum.ProductCategoryState
}
var file_resources_product_category_constant_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v18.resources.ProductCategoryConstant.level:type_name -> google.ads.googleads.v18.enums.ProductCategoryLevelEnum.ProductCategoryLevel
	3, // 1: google.ads.googleads.v18.resources.ProductCategoryConstant.state:type_name -> google.ads.googleads.v18.enums.ProductCategoryStateEnum.ProductCategoryState
	1, // 2: google.ads.googleads.v18.resources.ProductCategoryConstant.localizations:type_name -> google.ads.googleads.v18.resources.ProductCategoryConstant.ProductCategoryLocalization
