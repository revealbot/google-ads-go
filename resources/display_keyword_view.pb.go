...
func init() {
	proto.RegisterType((*DisplayKeywordView)(nil), "google.ads.googleads.v9.resources.DisplayKeywordView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/display_keyword_view.proto", fileDescriptor_f06b5bf38ab93938)
}
