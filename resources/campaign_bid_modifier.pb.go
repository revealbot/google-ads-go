...
func init() {
	proto.RegisterType((*CampaignBidModifier)(nil), "google.ads.googleads.v9.resources.CampaignBidModifier")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/campaign_bid_modifier.proto", fileDescriptor_f7b70b68df78a4e1)
}
