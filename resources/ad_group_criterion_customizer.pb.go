...
type AdGroupCriterionCustomizer struct {
	...
	Status enums.CustomizerValueStatusEnum_CustomizerValueStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v23.enums.CustomizerValueStatusEnum_CustomizerValueStatus" json:"status,omitempty"`
...
var file_resources_ad_group_criterion_customizer_proto_rawDesc = string([]byte{
	...
	0x32, 0x33, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x36, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x33, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x63, 0x75,
...
var (
	...
	file_resources_ad_group_criterion_customizer_proto_rawDescData []byte
)
...
func file_resources_ad_group_criterion_customizer_proto_rawDescGZIP() []byte {
	file_resources_ad_group_criterion_customizer_proto_rawDescOnce.Do(func() {
		file_resources_ad_group_criterion_customizer_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_ad_group_criterion_customizer_proto_rawDesc), len(file_resources_ad_group_criterion_customizer_proto_rawDesc)))
	})
...
var file_resources_ad_group_criterion_customizer_proto_goTypes = []any{
	(*AdGroupCriterionCustomizer)(nil),                         // 0: google.ads.googleads.v23.resources.AdGroupCriterionCustomizer
	(enums.CustomizerValueStatusEnum_CustomizerValueStatus)(0), // 1: google.ads.googleads.v23.enums.CustomizerValueStatusEnum.CustomizerValueStatus
	(*common.CustomizerValue)(nil),                             // 2: google.ads.googleads.v23.common.CustomizerValue
}
var file_resources_ad_group_criterion_customizer_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v23.resources.AdGroupCriterionCustomizer.status:type_name -> google.ads.googleads.v23.enums.CustomizerValueStatusEnum.CustomizerValueStatus
	2, // 1: google.ads.googleads.v23.resources.AdGroupCriterionCustomizer.value:type_name -> google.ads.googleads.v23.common.CustomizerValue
...
func file_resources_ad_group_criterion_customizer_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_ad_group_criterion_customizer_proto_rawDesc), len(file_resources_ad_group_criterion_customizer_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
