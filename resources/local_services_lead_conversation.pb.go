...
type LocalServicesLeadConversation struct {
	...
	// SMS, etc.
	ConversationChannel enums.LocalServicesLeadConversationTypeEnum_ConversationType `protobuf:"varint,3,opt,name=conversation_channel,json=conversationChannel,proto3,enum=google.ads.googleads.v23.enums.LocalServicesLeadConversationTypeEnum_ConversationType" json:"conversation_channel,omitempty"`
	// Output only. Type of participant in the lead conversation, ADVERTISER or
	// CONSUMER.
	ParticipantType enums.LocalServicesParticipantTypeEnum_ParticipantType `protobuf:"varint,4,opt,name=participant_type,json=participantType,proto3,enum=google.ads.googleads.v23.enums.LocalServicesParticipantTypeEnum_ParticipantType" json:"participant_type,omitempty"`
...
var file_resources_local_services_lead_conversation_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x32, 0x33, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x50,
	...
	0x32, 0x33, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x22, 0x4c, 0x6f,
...
var file_resources_local_services_lead_conversation_proto_goTypes = []any{
	(*LocalServicesLeadConversation)(nil),                             // 0: google.ads.googleads.v23.resources.LocalServicesLeadConversation
	(*PhoneCallDetails)(nil),                                          // 1: google.ads.googleads.v23.resources.PhoneCallDetails
	(*MessageDetails)(nil),                                            // 2: google.ads.googleads.v23.resources.MessageDetails
	(enums.LocalServicesLeadConversationTypeEnum_ConversationType)(0), // 3: google.ads.googleads.v23.enums.LocalServicesLeadConversationTypeEnum.ConversationType
	(enums.LocalServicesParticipantTypeEnum_ParticipantType)(0),       // 4: google.ads.googleads.v23.enums.LocalServicesParticipantTypeEnum.ParticipantType
}
var file_resources_local_services_lead_conversation_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v23.resources.LocalServicesLeadConversation.conversation_channel:type_name -> google.ads.googleads.v23.enums.LocalServicesLeadConversationTypeEnum.ConversationType
	4, // 1: google.ads.googleads.v23.resources.LocalServicesLeadConversation.participant_type:type_name -> google.ads.googleads.v23.enums.LocalServicesParticipantTypeEnum.ParticipantType
	1, // 2: google.ads.googleads.v23.resources.LocalServicesLeadConversation.phone_call_details:type_name -> google.ads.googleads.v23.resources.PhoneCallDetails
	2, // 3: google.ads.googleads.v23.resources.LocalServicesLeadConversation.message_details:type_name -> google.ads.googleads.v23.resources.MessageDetails
