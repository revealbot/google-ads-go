...
type DataLink struct {
	...
	Type enums.DataLinkTypeEnum_DataLinkType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v18.enums.DataLinkTypeEnum_DataLinkType" json:"type,omitempty"`
	// Output only. The status of the data link.
	Status enums.DataLinkStatusEnum_DataLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v18.enums.DataLinkStatusEnum_DataLinkStatus" json:"status,omitempty"`
	// Data linked to this account.
	//
	// Types that are assignable to DataLinkEntity:
	//
...
func (m *DataLink) GetDataLinkEntity() isDataLink_DataLinkEntity {
	if m != nil {
		return m.DataLinkEntity
	}
	return nil
}

func (x *DataLink) GetYoutubeVideo() *YoutubeVideoIdentifier {
	if x, ok := x.GetDataLinkEntity().(*DataLink_YoutubeVideo); ok {
...
var file_resources_data_link_proto_rawDesc = []byte{
	...
	0x31, 0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6c, 0x69,
	...
	0x2e, 0x76, 0x31, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4c,
...
var (
	...
	file_resources_data_link_proto_rawDescData = file_resources_data_link_proto_rawDesc
)

func file_resources_data_link_proto_rawDescGZIP() []byte {
	file_resources_data_link_proto_rawDescOnce.Do(func() {
		file_resources_data_link_proto_rawDescData = protoimpl.X.CompressGZIP(file_resources_data_link_proto_rawDescData)
	})
...
var file_resources_data_link_proto_goTypes = []interface{}{
	(*DataLink)(nil),                             // 0: google.ads.googleads.v18.resources.DataLink
	(*YoutubeVideoIdentifier)(nil),               // 1: google.ads.googleads.v18.resources.YoutubeVideoIdentifier
	(enums.DataLinkTypeEnum_DataLinkType)(0),     // 2: google.ads.googleads.v18.enums.DataLinkTypeEnum.DataLinkType
	(enums.DataLinkStatusEnum_DataLinkStatus)(0), // 3: google.ads.googleads.v18.enums.DataLinkStatusEnum.DataLinkStatus
}
var file_resources_data_link_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v18.resources.DataLink.type:type_name -> google.ads.googleads.v18.enums.DataLinkTypeEnum.DataLinkType
	3, // 1: google.ads.googleads.v18.resources.DataLink.status:type_name -> google.ads.googleads.v18.enums.DataLinkStatusEnum.DataLinkStatus
	1, // 2: google.ads.googleads.v18.resources.DataLink.youtube_video:type_name -> google.ads.googleads.v18.resources.YoutubeVideoIdentifier
...
func file_resources_data_link_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_resources_data_link_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_resources_data_link_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*YoutubeVideoIdentifier); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_resources_data_link_proto_msgTypes[0].OneofWrappers = []interface{}{
		(*DataLink_YoutubeVideo)(nil),
	}
	file_resources_data_link_proto_msgTypes[1].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_resources_data_link_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_resources_data_link_proto_rawDesc = nil
