...
type DataLink struct {
	...
	Type enums.DataLinkTypeEnum_DataLinkType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v22.enums.DataLinkTypeEnum_DataLinkType" json:"type,omitempty"`
	// Output only. The status of the data link.
	Status enums.DataLinkStatusEnum_DataLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.DataLinkStatusEnum_DataLinkStatus" json:"status,omitempty"`
...
var file_resources_data_link_proto_rawDesc = string([]byte{
	...
	0x32, 0x32, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6c, 0x69,
	...
	0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4c,
...
var file_resources_data_link_proto_goTypes = []any{
	(*DataLink)(nil),                             // 0: google.ads.googleads.v22.resources.DataLink
	(*YoutubeVideoIdentifier)(nil),               // 1: google.ads.googleads.v22.resources.YoutubeVideoIdentifier
	(enums.DataLinkTypeEnum_DataLinkType)(0),     // 2: google.ads.googleads.v22.enums.DataLinkTypeEnum.DataLinkType
	(enums.DataLinkStatusEnum_DataLinkStatus)(0), // 3: google.ads.googleads.v22.enums.DataLinkStatusEnum.DataLinkStatus
}
var file_resources_data_link_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v22.resources.DataLink.type:type_name -> google.ads.googleads.v22.enums.DataLinkTypeEnum.DataLinkType
	3, // 1: google.ads.googleads.v22.resources.DataLink.status:type_name -> google.ads.googleads.v22.enums.DataLinkStatusEnum.DataLinkStatus
	1, // 2: google.ads.googleads.v22.resources.DataLink.youtube_video:type_name -> google.ads.googleads.v22.resources.YoutubeVideoIdentifier
