...
type DataLink struct {
	...
	Type enums.DataLinkTypeEnum_DataLinkType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v25.enums.DataLinkTypeEnum_DataLinkType" json:"type,omitempty"`
	// Output only. The status of the data link.
	Status enums.DataLinkStatusEnum_DataLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v25.enums.DataLinkStatusEnum_DataLinkStatus" json:"status,omitempty"`
	...
	//
	// Types that are valid to be assigned to DataLinkMetadata:
	//
	//	*DataLink_YoutubeLinkMetadata
	DataLinkMetadata isDataLink_DataLinkMetadata `protobuf_oneof:"data_link_metadata"`
...
func (x *DataLink) GetDataLinkMetadata() isDataLink_DataLinkMetadata {
	if x != nil {
		return x.DataLinkMetadata
	}
	return nil
}

func (x *DataLink) GetYoutubeLinkMetadata() *YoutubeLinkMetadata {
	if x != nil {
		if x, ok := x.DataLinkMetadata.(*DataLink_YoutubeLinkMetadata); ok {
			return x.YoutubeLinkMetadata
		}
	}
	return nil
}
...
type isDataLink_DataLinkMetadata interface {
	isDataLink_DataLinkMetadata()
}

type DataLink_YoutubeLinkMetadata struct {
	// Immutable. Metadata for a YouTube link.
	YoutubeLinkMetadata *YoutubeLinkMetadata `protobuf:"bytes,7,opt,name=youtube_link_metadata,json=youtubeLinkMetadata,proto3,oneof"`
}

func (*DataLink_YoutubeLinkMetadata) isDataLink_DataLinkMetadata() {}
...
type YoutubeLinkMetadata struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	...
	// value with “UC” prefix. For example, "UCK8sQmJBp8GCxrOtXWBpyEA".
	BrandChannelId *string `protobuf:"bytes,1,opt,name=brand_channel_id,json=brandChannelId,proto3,oneof" json:"brand_channel_id,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}

func (x *YoutubeLinkMetadata) Reset() {
	*x = YoutubeLinkMetadata{}
	mi := &file_resources_data_link_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *YoutubeLinkMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*YoutubeLinkMetadata) ProtoMessage() {}

func (x *YoutubeLinkMetadata) ProtoReflect() protoreflect.Message {
	mi := &file_resources_data_link_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use YoutubeLinkMetadata.ProtoReflect.Descriptor instead.
func (*YoutubeLinkMetadata) Descriptor() ([]byte, []int) {
	return file_resources_data_link_proto_rawDescGZIP(), []int{2}
}

func (x *YoutubeLinkMetadata) GetBrandChannelId() string {
	if x != nil && x.BrandChannelId != nil {
		return *x.BrandChannelId
	}
	return ""
}
...
var file_resources_data_link_proto_rawDesc = string([]byte{
	...
	0x32, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x64, 0x61, 0x74, 0x61, 0x5f, 0x6c, 0x69,
	...
	0x22, 0x87, 0x06, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x4e, 0x0a,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x48, 0x02, 0x52, 0x0d, 0x70,
	...
	0x03, 0x20, 0x01, 0x28, 0x03, 0x42, 0x03, 0xe0, 0x41, 0x03, 0x48, 0x03, 0x52, 0x0a, 0x64, 0x61,
	...
	0x2e, 0x76, 0x32, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x4c,
	...
	,
	...
	0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x0d, 0x44, 0x61, 0x74, 0x61,
	0x4c, 0x69, 0x6e, 0x6b, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x4b, 0x67, 0x6f, 0x6f,
...
var file_resources_data_link_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_resources_data_link_proto_goTypes = []any{
	(*DataLink)(nil),                             // 0: google.ads.googleads.v25.resources.DataLink
	(*YoutubeVideoIdentifier)(nil),               // 1: google.ads.googleads.v25.resources.YoutubeVideoIdentifier
	(*YoutubeLinkMetadata)(nil),                  // 2: google.ads.googleads.v25.resources.YoutubeLinkMetadata
	(enums.DataLinkTypeEnum_DataLinkType)(0),     // 3: google.ads.googleads.v25.enums.DataLinkTypeEnum.DataLinkType
	(enums.DataLinkStatusEnum_DataLinkStatus)(0), // 4: google.ads.googleads.v25.enums.DataLinkStatusEnum.DataLinkStatus
}
var file_resources_data_link_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v25.resources.DataLink.type:type_name -> google.ads.googleads.v25.enums.DataLinkTypeEnum.DataLinkType
	4, // 1: google.ads.googleads.v25.resources.DataLink.status:type_name -> google.ads.googleads.v25.enums.DataLinkStatusEnum.DataLinkStatus
	1, // 2: google.ads.googleads.v25.resources.DataLink.youtube_video:type_name -> google.ads.googleads.v25.resources.YoutubeVideoIdentifier
	2, // 3: google.ads.googleads.v25.resources.DataLink.youtube_link_metadata:type_name -> google.ads.googleads.v25.resources.YoutubeLinkMetadata
...
func file_resources_data_link_proto_init() {
	...
	file_resources_data_link_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*DataLink_YoutubeLinkMetadata)(nil),
	}
	file_resources_data_link_proto_msgTypes[1].OneofWrappers = []any{}
	file_resources_data_link_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
