...
type LocalServicesEmployee struct {
	...
	Status enums.LocalServicesEmployeeStatusEnum_LocalServicesEmployeeStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.LocalServicesEmployeeStatusEnum_LocalServicesEmployeeStatus" json:"status,omitempty"`
	// Output only. Employee type.
	Type enums.LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v22.enums.LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType" json:"type,omitempty"`
...
var file_resources_local_services_employee_proto_rawDesc = string([]byte{
	...
	0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x53, 0x65, 0x72,
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32,
	0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x55, 0x6e, 0x69, 0x76,
...
var (
	...
	file_resources_local_services_employee_proto_rawDescData []byte
)
...
func file_resources_local_services_employee_proto_rawDescGZIP() []byte {
	file_resources_local_services_employee_proto_rawDescOnce.Do(func() {
		file_resources_local_services_employee_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_local_services_employee_proto_rawDesc), len(file_resources_local_services_employee_proto_rawDesc)))
	})
...
var file_resources_local_services_employee_proto_goTypes = []any{
	(*LocalServicesEmployee)(nil), // 0: google.ads.googleads.v22.resources.LocalServicesEmployee
	(*UniversityDegree)(nil),      // 1: google.ads.googleads.v22.resources.UniversityDegree
	(*Residency)(nil),             // 2: google.ads.googleads.v22.resources.Residency
	(*Fellowship)(nil),            // 3: google.ads.googleads.v22.resources.Fellowship
	(enums.LocalServicesEmployeeStatusEnum_LocalServicesEmployeeStatus)(0), // 4: google.ads.googleads.v22.enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus
	(enums.LocalServicesEmployeeTypeEnum_LocalServicesEmployeeType)(0),     // 5: google.ads.googleads.v22.enums.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType
}
var file_resources_local_services_employee_proto_depIdxs = []int32{
	4, // 0: google.ads.googleads.v22.resources.LocalServicesEmployee.status:type_name -> google.ads.googleads.v22.enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus
	5, // 1: google.ads.googleads.v22.resources.LocalServicesEmployee.type:type_name -> google.ads.googleads.v22.enums.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType
	1, // 2: google.ads.googleads.v22.resources.LocalServicesEmployee.university_degrees:type_name -> google.ads.googleads.v22.resources.UniversityDegree
	2, // 3: google.ads.googleads.v22.resources.LocalServicesEmployee.residencies:type_name -> google.ads.googleads.v22.resources.Residency
	3, // 4: google.ads.googleads.v22.resources.LocalServicesEmployee.fellowships:type_name -> google.ads.googleads.v22.resources.Fellowship
...
func file_resources_local_services_employee_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_local_services_employee_proto_rawDesc), len(file_resources_local_services_employee_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
