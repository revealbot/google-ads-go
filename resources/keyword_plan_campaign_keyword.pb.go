...
type KeywordPlanCampaignKeyword struct {
	...
	MatchType enums.KeywordMatchTypeEnum_KeywordMatchType `protobuf:"varint,5,opt,name=match_type,json=matchType,proto3,enum=google.ads.googleads.v25.enums.KeywordMatchTypeEnum_KeywordMatchType" json:"match_type,omitempty"`
...
var file_resources_keyword_plan_campaign_keyword_proto_rawDesc = string([]byte{
	...
	0x32, 0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x37, 0x67, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61,
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6b, 0x65, 0x79,
...
var (
	...
	file_resources_keyword_plan_campaign_keyword_proto_rawDescData []byte
)
...
func file_resources_keyword_plan_campaign_keyword_proto_rawDescGZIP() []byte {
	file_resources_keyword_plan_campaign_keyword_proto_rawDescOnce.Do(func() {
		file_resources_keyword_plan_campaign_keyword_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_keyword_plan_campaign_keyword_proto_rawDesc), len(file_resources_keyword_plan_campaign_keyword_proto_rawDesc)))
	})
...
var file_resources_keyword_plan_campaign_keyword_proto_goTypes = []any{
	(*KeywordPlanCampaignKeyword)(nil),               // 0: google.ads.googleads.v25.resources.KeywordPlanCampaignKeyword
	(enums.KeywordMatchTypeEnum_KeywordMatchType)(0), // 1: google.ads.googleads.v25.enums.KeywordMatchTypeEnum.KeywordMatchType
}
var file_resources_keyword_plan_campaign_keyword_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.resources.KeywordPlanCampaignKeyword.match_type:type_name -> google.ads.googleads.v25.enums.KeywordMatchTypeEnum.KeywordMatchType
...
func file_resources_keyword_plan_campaign_keyword_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_keyword_plan_campaign_keyword_proto_rawDesc), len(file_resources_keyword_plan_campaign_keyword_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
