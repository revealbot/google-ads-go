...
var file_resources_group_placement_view_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x50, 0x6c, 0x61,
...
var (
	...
	file_resources_group_placement_view_proto_rawDescData []byte
)
...
func file_resources_group_placement_view_proto_rawDescGZIP() []byte {
	file_resources_group_placement_view_proto_rawDescOnce.Do(func() {
		file_resources_group_placement_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_group_placement_view_proto_rawDesc), len(file_resources_group_placement_view_proto_rawDesc)))
	})
...
var file_resources_group_placement_view_proto_goTypes = []any{
	(*GroupPlacementView)(nil),                 // 0: google.ads.googleads.v22.resources.GroupPlacementView
...
var file_resources_group_placement_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.GroupPlacementView.placement_type:type_name -> google.ads.googleads.v22.enums.PlacementTypeEnum.PlacementType
...
func file_resources_group_placement_view_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_group_placement_view_proto_rawDesc), len(file_resources_group_placement_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
