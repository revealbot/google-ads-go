...
type OfflineConversionUploadConversionActionSummary struct {
	...
	// stats.
	Status enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus" json:"status,omitempty"`
...
var file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x32, 0x2f, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2f, 0x6f, 0x66,
	...
	0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4f, 0x66, 0x66, 0x6c, 0x69, 0x6e,
...
var (
	...
	file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescData []byte
)
...
func file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescGZIP() []byte {
	file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescOnce.Do(func() {
		file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc), len(file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc)))
	})
...
var file_resources_offline_conversion_upload_conversion_action_summary_proto_goTypes = []any{
	(*OfflineConversionUploadConversionActionSummary)(nil),                             // 0: google.ads.googleads.v22.resources.OfflineConversionUploadConversionActionSummary
	(enums.OfflineEventUploadClientEnum_OfflineEventUploadClient)(0),                   // 1: google.ads.googleads.v22.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	(enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus)(0), // 2: google.ads.googleads.v22.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	(*OfflineConversionSummary)(nil),                                                   // 3: google.ads.googleads.v22.resources.OfflineConversionSummary
	(*OfflineConversionAlert)(nil),                                                     // 4: google.ads.googleads.v22.resources.OfflineConversionAlert
}
var file_resources_offline_conversion_upload_conversion_action_summary_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.OfflineConversionUploadConversionActionSummary.client:type_name -> google.ads.googleads.v22.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	2, // 1: google.ads.googleads.v22.resources.OfflineConversionUploadConversionActionSummary.status:type_name -> google.ads.googleads.v22.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	3, // 2: google.ads.googleads.v22.resources.OfflineConversionUploadConversionActionSummary.daily_summaries:type_name -> google.ads.googleads.v22.resources.OfflineConversionSummary
	3, // 3: google.ads.googleads.v22.resources.OfflineConversionUploadConversionActionSummary.job_summaries:type_name -> google.ads.googleads.v22.resources.OfflineConversionSummary
	4, // 4: google.ads.googleads.v22.resources.OfflineConversionUploadConversionActionSummary.alerts:type_name -> google.ads.googleads.v22.resources.OfflineConversionAlert
...
func file_resources_offline_conversion_upload_conversion_action_summary_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc), len(file_resources_offline_conversion_upload_conversion_action_summary_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
