...
func init() {
	proto.RegisterType((*SharedSet)(nil), "google.ads.googleads.v9.resources.SharedSet")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/shared_set.proto", fileDescriptor_a08bbd9f39f73150)
}
