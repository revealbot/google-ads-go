...
type AssetSetTypeView struct {
	...
	AssetSetType  enums.AssetSetTypeEnum_AssetSetType `protobuf:"varint,3,opt,name=asset_set_type,json=assetSetType,proto3,enum=google.ads.googleads.v22.enums.AssetSetTypeEnum_AssetSetType" json:"asset_set_type,omitempty"`
...
var file_resources_asset_set_type_view_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_asset_set_type_view_proto_rawDescData []byte
)
...
func file_resources_asset_set_type_view_proto_rawDescGZIP() []byte {
	file_resources_asset_set_type_view_proto_rawDescOnce.Do(func() {
		file_resources_asset_set_type_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_asset_set_type_view_proto_rawDesc), len(file_resources_asset_set_type_view_proto_rawDesc)))
	})
...
var file_resources_asset_set_type_view_proto_goTypes = []any{
	(*AssetSetTypeView)(nil),                 // 0: google.ads.googleads.v22.resources.AssetSetTypeView
	(enums.AssetSetTypeEnum_AssetSetType)(0), // 1: google.ads.googleads.v22.enums.AssetSetTypeEnum.AssetSetType
}
var file_resources_asset_set_type_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.AssetSetTypeView.asset_set_type:type_name -> google.ads.googleads.v22.enums.AssetSetTypeEnum.AssetSetType
...
func file_resources_asset_set_type_view_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_asset_set_type_view_proto_rawDesc), len(file_resources_asset_set_type_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
