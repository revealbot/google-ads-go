...
var file_resources_android_privacy_shared_key_google_campaign_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_android_privacy_shared_key_google_campaign_proto_rawDescData []byte
)
...
func file_resources_android_privacy_shared_key_google_campaign_proto_rawDescGZIP() []byte {
	file_resources_android_privacy_shared_key_google_campaign_proto_rawDescOnce.Do(func() {
		file_resources_android_privacy_shared_key_google_campaign_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_android_privacy_shared_key_google_campaign_proto_rawDesc), len(file_resources_android_privacy_shared_key_google_campaign_proto_rawDesc)))
	})
...
var file_resources_android_privacy_shared_key_google_campaign_proto_goTypes = []any{
	(*AndroidPrivacySharedKeyGoogleCampaign)(nil),                              // 0: google.ads.googleads.v22.resources.AndroidPrivacySharedKeyGoogleCampaign
...
var file_resources_android_privacy_shared_key_google_campaign_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.AndroidPrivacySharedKeyGoogleCampaign.android_privacy_interaction_type:type_name -> google.ads.googleads.v22.enums.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType
...
func file_resources_android_privacy_shared_key_google_campaign_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_android_privacy_shared_key_google_campaign_proto_rawDesc), len(file_resources_android_privacy_shared_key_google_campaign_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
