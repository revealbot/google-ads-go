...
type ConversionCustomVariable struct {
	...
	Status enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus" json:"status,omitempty"`
...
var file_resources_conversion_custom_variable_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_conversion_custom_variable_proto_rawDescData []byte
)
...
func file_resources_conversion_custom_variable_proto_rawDescGZIP() []byte {
	file_resources_conversion_custom_variable_proto_rawDescOnce.Do(func() {
		file_resources_conversion_custom_variable_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_conversion_custom_variable_proto_rawDesc), len(file_resources_conversion_custom_variable_proto_rawDesc)))
	})
...
var file_resources_conversion_custom_variable_proto_goTypes = []any{
	(*ConversionCustomVariable)(nil),                                             // 0: google.ads.googleads.v22.resources.ConversionCustomVariable
	(enums.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus)(0), // 1: google.ads.googleads.v22.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
}
var file_resources_conversion_custom_variable_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.ConversionCustomVariable.status:type_name -> google.ads.googleads.v22.enums.ConversionCustomVariableStatusEnum.ConversionCustomVariableStatus
...
func file_resources_conversion_custom_variable_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_conversion_custom_variable_proto_rawDesc), len(file_resources_conversion_custom_variable_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
