...
func init() {
	proto.RegisterType((*GenderView)(nil), "google.ads.googleads.v9.resources.GenderView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/gender_view.proto", fileDescriptor_5632c8e0f3f7fb1f)
}
