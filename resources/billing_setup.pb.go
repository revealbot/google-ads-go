...
func init() {
	proto.RegisterType((*BillingSetup)(nil), "google.ads.googleads.v9.resources.BillingSetup")
	proto.RegisterType((*BillingSetup_PaymentsAccountInfo)(nil), "google.ads.googleads.v9.resources.BillingSetup.PaymentsAccountInfo")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/billing_setup.proto", fileDescriptor_1b091bf330203108)
}
