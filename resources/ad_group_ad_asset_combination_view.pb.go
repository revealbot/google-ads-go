...
var file_resources_ad_group_ad_asset_combination_view_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x32, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x22,
...
var (
	...
	file_resources_ad_group_ad_asset_combination_view_proto_rawDescData []byte
)
...
func file_resources_ad_group_ad_asset_combination_view_proto_rawDescGZIP() []byte {
	file_resources_ad_group_ad_asset_combination_view_proto_rawDescOnce.Do(func() {
		file_resources_ad_group_ad_asset_combination_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_ad_group_ad_asset_combination_view_proto_rawDesc), len(file_resources_ad_group_ad_asset_combination_view_proto_rawDesc)))
	})
...
var file_resources_ad_group_ad_asset_combination_view_proto_goTypes = []any{
	(*AdGroupAdAssetCombinationView)(nil), // 0: google.ads.googleads.v22.resources.AdGroupAdAssetCombinationView
	(*common.AssetUsage)(nil),             // 1: google.ads.googleads.v22.common.AssetUsage
}
var file_resources_ad_group_ad_asset_combination_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.AdGroupAdAssetCombinationView.served_assets:type_name -> google.ads.googleads.v22.common.AssetUsage
...
func file_resources_ad_group_ad_asset_combination_view_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_ad_group_ad_asset_combination_view_proto_rawDesc), len(file_resources_ad_group_ad_asset_combination_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
