...
func init() {
	proto.RegisterType((*CustomerManagerLink)(nil), "google.ads.googleads.v9.resources.CustomerManagerLink")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/customer_manager_link.proto", fileDescriptor_c8877a11674449b3)
}
