...
type MobileDeviceConstant struct {
	...
	Type          enums.MobileDeviceTypeEnum_MobileDeviceType `protobuf:"varint,6,opt,name=type,proto3,enum=google.ads.googleads.v22.enums.MobileDeviceTypeEnum_MobileDeviceType" json:"type,omitempty"`
...
var file_resources_mobile_device_constant_proto_rawDesc = string([]byte{
	...
	0x73, 0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4d, 0x6f, 0x62, 0x69,
...
var (
	...
	file_resources_mobile_device_constant_proto_rawDescData []byte
)
...
func file_resources_mobile_device_constant_proto_rawDescGZIP() []byte {
	file_resources_mobile_device_constant_proto_rawDescOnce.Do(func() {
		file_resources_mobile_device_constant_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_mobile_device_constant_proto_rawDesc), len(file_resources_mobile_device_constant_proto_rawDesc)))
	})
...
var file_resources_mobile_device_constant_proto_goTypes = []any{
	(*MobileDeviceConstant)(nil),                     // 0: google.ads.googleads.v22.resources.MobileDeviceConstant
	(enums.MobileDeviceTypeEnum_MobileDeviceType)(0), // 1: google.ads.googleads.v22.enums.MobileDeviceTypeEnum.MobileDeviceType
}
var file_resources_mobile_device_constant_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.MobileDeviceConstant.type:type_name -> google.ads.googleads.v22.enums.MobileDeviceTypeEnum.MobileDeviceType
...
func file_resources_mobile_device_constant_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_mobile_device_constant_proto_rawDesc), len(file_resources_mobile_device_constant_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
