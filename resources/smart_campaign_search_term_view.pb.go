...
const file_resources_smart_campaign_search_term_view_proto_rawDesc = "" +
	"\n" +
	"Hgoogle/ads/googleads/v19/resources/smart_campaign_search_term_view.proto\x12\"google.ads.googleads.v19.resources\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xf6\x02\n" +
	"\x1bSmartCampaignSearchTermView\x12a\n" +
	"\rresource_name\x18\x01 \x01(\tB<\xe0A\x03\xfaA6\n" +
	"4googleads.googleapis.com/SmartCampaignSearchTermViewR\fresourceName\x12$\n" +
	"\vsearch_term\x18\x02 \x01(\tB\x03\xe0A\x03R\n" +
	"searchTerm\x12E\n" +
	"\bcampaign\x18\x03 \x01(\tB)\xe0A\x03\xfaA#\n" +
	"!googleads.googleapis.com/CampaignR\bcampaign:\x86\x01\xeaA\x82\x01\n" +
	...
	"&com.google.ads.googleads.v19.resourcesB SmartCampaignSearchTermViewProtoP\x01ZKgithub.com/revealbot/google-ads-go/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"

var (
	file_resources_smart_campaign_search_term_view_proto_rawDescOnce sync.Once
	file_resources_smart_campaign_search_term_view_proto_rawDescData []byte
)
...
func file_resources_smart_campaign_search_term_view_proto_rawDescGZIP() []byte {
	file_resources_smart_campaign_search_term_view_proto_rawDescOnce.Do(func() {
		file_resources_smart_campaign_search_term_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_smart_campaign_search_term_view_proto_rawDesc), len(file_resources_smart_campaign_search_term_view_proto_rawDesc)))
	})
...
var file_resources_smart_campaign_search_term_view_proto_goTypes = []any{
	(*SmartCampaignSearchTermView)(nil), // 0: google.ads.googleads.v19.resources.SmartCampaignSearchTermView
}
...
func file_resources_smart_campaign_search_term_view_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_smart_campaign_search_term_view_proto_rawDesc), len(file_resources_smart_campaign_search_term_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
