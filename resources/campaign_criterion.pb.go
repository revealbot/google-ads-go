...
func init() {
	proto.RegisterType((*CampaignCriterion)(nil), "google.ads.googleads.v9.resources.CampaignCriterion")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/campaign_criterion.proto", fileDescriptor_889de17d165924ac)
}
