...
type CampaignGroup struct {
	...
	Status        enums.CampaignGroupStatusEnum_CampaignGroupStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.CampaignGroupStatusEnum_CampaignGroupStatus" json:"status,omitempty"`
...
var file_resources_campaign_group_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x3a, 0x67,
	...
	0x2e, 0x76, 0x32, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x12,
...
var (
	...
	file_resources_campaign_group_proto_rawDescData []byte
)

func file_resources_campaign_group_proto_rawDescGZIP() []byte {
	file_resources_campaign_group_proto_rawDescOnce.Do(func() {
		file_resources_campaign_group_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_campaign_group_proto_rawDesc), len(file_resources_campaign_group_proto_rawDesc)))
	})
...
var file_resources_campaign_group_proto_goTypes = []any{
	(*CampaignGroup)(nil), // 0: google.ads.googleads.v22.resources.CampaignGroup
	(enums.CampaignGroupStatusEnum_CampaignGroupStatus)(0), // 1: google.ads.googleads.v22.enums.CampaignGroupStatusEnum.CampaignGroupStatus
}
var file_resources_campaign_group_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.CampaignGroup.status:type_name -> google.ads.googleads.v22.enums.CampaignGroupStatusEnum.CampaignGroupStatus
...
func file_resources_campaign_group_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_campaign_group_proto_rawDesc), len(file_resources_campaign_group_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
