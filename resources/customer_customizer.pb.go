...
type CustomerCustomizer struct {
	...
	Status enums.CustomizerValueStatusEnum_CustomizerValueStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v16.enums.CustomizerValueStatusEnum_CustomizerValueStatus" json:"status,omitempty"`
...
var file_resources_customer_customizer_proto_rawDesc = []byte{
	...
	0x2f, 0x76, 0x31, 0x36, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f,
...
var file_resources_customer_customizer_proto_goTypes = []interface{}{
	(*CustomerCustomizer)(nil),                                 // 0: google.ads.googleads.v16.resources.CustomerCustomizer
...
var file_resources_customer_customizer_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v16.resources.CustomerCustomizer.status:type_name -> google.ads.googleads.v16.enums.CustomizerValueStatusEnum.CustomizerValueStatus
	2, // 1: google.ads.googleads.v16.resources.CustomerCustomizer.value:type_name -> google.ads.googleads.v16.common.CustomizerValue
