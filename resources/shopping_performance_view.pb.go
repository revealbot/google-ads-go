...
var file_resources_shopping_performance_view_proto_rawDesc = string([]byte{
...
var file_resources_shopping_performance_view_proto_goTypes = []any{
	(*ShoppingPerformanceView)(nil), // 0: google.ads.googleads.v25.resources.ShoppingPerformanceView
}
