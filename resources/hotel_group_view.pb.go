...
func init() {
	proto.RegisterType((*HotelGroupView)(nil), "google.ads.googleads.v9.resources.HotelGroupView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/hotel_group_view.proto", fileDescriptor_d4274b225e9f7415)
}
