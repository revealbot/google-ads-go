...
type AccessibleBiddingStrategy struct {
	...
	Type enums.BiddingStrategyTypeEnum_BiddingStrategyType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v18.enums.BiddingStrategyTypeEnum_BiddingStrategyType" json:"type,omitempty"`
...
var file_resources_accessible_bidding_strategy_proto_rawDesc = []byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x61, 0x72,
...
var file_resources_accessible_bidding_strategy_proto_goTypes = []interface{}{
	(*AccessibleBiddingStrategy)(nil),                                          // 0: google.ads.googleads.v18.resources.AccessibleBiddingStrategy
	(*AccessibleBiddingStrategy_MaximizeConversionValue)(nil),                  // 1: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.MaximizeConversionValue
	(*AccessibleBiddingStrategy_MaximizeConversions)(nil),                      // 2: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.MaximizeConversions
	(*AccessibleBiddingStrategy_TargetCpa)(nil),                                // 3: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetCpa
	(*AccessibleBiddingStrategy_TargetImpressionShare)(nil),                    // 4: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetImpressionShare
	(*AccessibleBiddingStrategy_TargetRoas)(nil),                               // 5: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetRoas
	(*AccessibleBiddingStrategy_TargetSpend)(nil),                              // 6: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetSpend
	(enums.BiddingStrategyTypeEnum_BiddingStrategyType)(0),                     // 7: google.ads.googleads.v18.enums.BiddingStrategyTypeEnum.BiddingStrategyType
	(enums.TargetImpressionShareLocationEnum_TargetImpressionShareLocation)(0), // 8: google.ads.googleads.v18.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation
}
var file_resources_accessible_bidding_strategy_proto_depIdxs = []int32{
	7, // 0: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.type:type_name -> google.ads.googleads.v18.enums.BiddingStrategyTypeEnum.BiddingStrategyType
	1, // 1: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.maximize_conversion_value:type_name -> google.ads.googleads.v18.resources.AccessibleBiddingStrategy.MaximizeConversionValue
	2, // 2: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.maximize_conversions:type_name -> google.ads.googleads.v18.resources.AccessibleBiddingStrategy.MaximizeConversions
	3, // 3: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.target_cpa:type_name -> google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetCpa
	4, // 4: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.target_impression_share:type_name -> google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetImpressionShare
	5, // 5: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.target_roas:type_name -> google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetRoas
	6, // 6: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.target_spend:type_name -> google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetSpend
	8, // 7: google.ads.googleads.v18.resources.AccessibleBiddingStrategy.TargetImpressionShare.location:type_name -> google.ads.googleads.v18.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation
