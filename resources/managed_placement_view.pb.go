...
func init() {
	proto.RegisterType((*ManagedPlacementView)(nil), "google.ads.googleads.v9.resources.ManagedPlacementView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/managed_placement_view.proto", fileDescriptor_b66b40c4713c533c)
}
