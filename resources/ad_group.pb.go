...
type AdGroup struct {
	...
	Status enums.AdGroupStatusEnum_AdGroupStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v13.enums.AdGroupStatusEnum_AdGroupStatus" json:"status,omitempty"`
	// Immutable. The type of the ad group.
	Type enums.AdGroupTypeEnum_AdGroupType `protobuf:"varint,12,opt,name=type,proto3,enum=google.ads.googleads.v13.enums.AdGroupTypeEnum_AdGroupType" json:"type,omitempty"`
	// The ad rotation mode of the ad group.
	AdRotationMode enums.AdGroupAdRotationModeEnum_AdGroupAdRotationMode `protobuf:"varint,22,opt,name=ad_rotation_mode,json=adRotationMode,proto3,enum=google.ads.googleads.v13.enums.AdGroupAdRotationModeEnum_AdGroupAdRotationMode" json:"ad_rotation_mode,omitempty"`
	...
	DisplayCustomBidDimension enums.TargetingDimensionEnum_TargetingDimension `protobuf:"varint,23,opt,name=display_custom_bid_dimension,json=displayCustomBidDimension,proto3,enum=google.ads.googleads.v13.enums.TargetingDimensionEnum_TargetingDimension" json:"display_custom_bid_dimension,omitempty"`
	...
	// This field is read-only.
	EffectiveTargetCpaSource enums.BiddingSourceEnum_BiddingSource `protobuf:"varint,29,opt,name=effective_target_cpa_source,json=effectiveTargetCpaSource,proto3,enum=google.ads.googleads.v13.enums.BiddingSourceEnum_BiddingSource" json:"effective_target_cpa_source,omitempty"`
	...
	// This field is read-only.
	EffectiveTargetRoasSource enums.BiddingSourceEnum_BiddingSource `protobuf:"varint,32,opt,name=effective_target_roas_source,json=effectiveTargetRoasSource,proto3,enum=google.ads.googleads.v13.enums.BiddingSourceEnum_BiddingSource" json:"effective_target_roas_source,omitempty"`
	...
	// the upper levels.
	ExcludedParentAssetFieldTypes []enums.AssetFieldTypeEnum_AssetFieldType `protobuf:"varint,54,rep,packed,name=excluded_parent_asset_field_types,json=excludedParentAssetFieldTypes,proto3,enum=google.ads.googleads.v13.enums.AssetFieldTypeEnum_AssetFieldType" json:"excluded_parent_asset_field_types,omitempty"`
	...
	ExcludedParentAssetSetTypes []enums.AssetSetTypeEnum_AssetSetType `protobuf:"varint,58,rep,packed,name=excluded_parent_asset_set_types,json=excludedParentAssetSetTypes,proto3,enum=google.ads.googleads.v13.enums.AssetSetTypeEnum_AssetSetType" json:"excluded_parent_asset_set_types,omitempty"`
}
...
var file_resources_ad_group_proto_rawDesc = []byte{
	...
	0x31, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x64, 0x5f, 0x67, 0x72, 0x6f, 0x75,
	...
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61,
	...
	0x76, 0x31, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f,
	0x73, 0x65, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x33,
	0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x61, 0x64, 0x73, 0x2f, 0x67, 0x6f, 0x6f, 0x67, 0x6c,
	0x65, 0x61, 0x64, 0x73, 0x2f, 0x76, 0x31, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62,
	...
	0x31, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x41, 0x64, 0x47, 0x72, 0x6f, 0x75, 0x70,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x54, 0x61,
	...
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x33, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x54,
	...
	0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x31, 0x33, 0x2e, 0x52, 0x65,
	...
	0x31, 0x33, 0x5c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0xea, 0x02, 0x26, 0x47,
	0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x3a, 0x3a, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x31, 0x33, 0x3a, 0x3a, 0x52, 0x65, 0x73, 0x6f,
...
var file_resources_ad_group_proto_goTypes = []interface{}{
	(*AdGroup)(nil),                                            // 0: google.ads.googleads.v13.resources.AdGroup
	(*AdGroup_AudienceSetting)(nil),                            // 1: google.ads.googleads.v13.resources.AdGroup.AudienceSetting
	(enums.AdGroupStatusEnum_AdGroupStatus)(0),                 // 2: google.ads.googleads.v13.enums.AdGroupStatusEnum.AdGroupStatus
	(enums.AdGroupTypeEnum_AdGroupType)(0),                     // 3: google.ads.googleads.v13.enums.AdGroupTypeEnum.AdGroupType
	(enums.AdGroupAdRotationModeEnum_AdGroupAdRotationMode)(0), // 4: google.ads.googleads.v13.enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode
	(*common.CustomParameter)(nil),                             // 5: google.ads.googleads.v13.common.CustomParameter
	(enums.TargetingDimensionEnum_TargetingDimension)(0),       // 6: google.ads.googleads.v13.enums.TargetingDimensionEnum.TargetingDimension
	(*common.TargetingSetting)(nil),                            // 7: google.ads.googleads.v13.common.TargetingSetting
	(enums.BiddingSourceEnum_BiddingSource)(0),                 // 8: google.ads.googleads.v13.enums.BiddingSourceEnum.BiddingSource
	(enums.AssetFieldTypeEnum_AssetFieldType)(0),               // 9: google.ads.googleads.v13.enums.AssetFieldTypeEnum.AssetFieldType
	(enums.AssetSetTypeEnum_AssetSetType)(0),                   // 10: google.ads.googleads.v13.enums.AssetSetTypeEnum.AssetSetType
}
var file_resources_ad_group_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v13.resources.AdGroup.status:type_name -> google.ads.googleads.v13.enums.AdGroupStatusEnum.AdGroupStatus
	3,  // 1: google.ads.googleads.v13.resources.AdGroup.type:type_name -> google.ads.googleads.v13.enums.AdGroupTypeEnum.AdGroupType
	4,  // 2: google.ads.googleads.v13.resources.AdGroup.ad_rotation_mode:type_name -> google.ads.googleads.v13.enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode
	5,  // 3: google.ads.googleads.v13.resources.AdGroup.url_custom_parameters:type_name -> google.ads.googleads.v13.common.CustomParameter
	6,  // 4: google.ads.googleads.v13.resources.AdGroup.display_custom_bid_dimension:type_name -> google.ads.googleads.v13.enums.TargetingDimensionEnum.TargetingDimension
	7,  // 5: google.ads.googleads.v13.resources.AdGroup.targeting_setting:type_name -> google.ads.googleads.v13.common.TargetingSetting
	1,  // 6: google.ads.googleads.v13.resources.AdGroup.audience_setting:type_name -> google.ads.googleads.v13.resources.AdGroup.AudienceSetting
	8,  // 7: google.ads.googleads.v13.resources.AdGroup.effective_target_cpa_source:type_name -> google.ads.googleads.v13.enums.BiddingSourceEnum.BiddingSource
	8,  // 8: google.ads.googleads.v13.resources.AdGroup.effective_target_roas_source:type_name -> google.ads.googleads.v13.enums.BiddingSourceEnum.BiddingSource
	9,  // 9: google.ads.googleads.v13.resources.AdGroup.excluded_parent_asset_field_types:type_name -> google.ads.googleads.v13.enums.AssetFieldTypeEnum.AssetFieldType
	10, // 10: google.ads.googleads.v13.resources.AdGroup.excluded_parent_asset_set_types:type_name -> google.ads.googleads.v13.enums.AssetSetTypeEnum.AssetSetType
