...
func init() {
	proto.RegisterType((*AdGroup)(nil), "google.ads.googleads.v9.resources.AdGroup")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/ad_group.proto", fileDescriptor_57e5af87b0eea660)
}
