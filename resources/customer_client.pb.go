...
func init() {
	proto.RegisterType((*CustomerClient)(nil), "google.ads.googleads.v9.resources.CustomerClient")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/customer_client.proto", fileDescriptor_c6a5e5c5ac31fc14)
}
