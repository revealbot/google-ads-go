...
func init() {
	proto.RegisterType((*AdGroupFeed)(nil), "google.ads.googleads.v9.resources.AdGroupFeed")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/ad_group_feed.proto", fileDescriptor_1f048fb4293eaa8a)
}
