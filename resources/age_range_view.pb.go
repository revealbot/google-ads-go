...
func init() {
	proto.RegisterType((*AgeRangeView)(nil), "google.ads.googleads.v9.resources.AgeRangeView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/age_range_view.proto", fileDescriptor_8571fe1afb43562a)
}
