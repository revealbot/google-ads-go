...
func init() {
	proto.RegisterType((*CampaignBudget)(nil), "google.ads.googleads.v9.resources.CampaignBudget")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/campaign_budget.proto", fileDescriptor_8518b5fa03df6f7a)
}
