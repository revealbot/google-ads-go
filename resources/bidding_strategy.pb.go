...
func init() {
	proto.RegisterType((*BiddingStrategy)(nil), "google.ads.googleads.v9.resources.BiddingStrategy")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/bidding_strategy.proto", fileDescriptor_954492da6a94ea83)
}
