...
type AssetSet struct {
	...
	Type enums.AssetSetTypeEnum_AssetSetType `protobuf:"varint,3,opt,name=type,proto3,enum=google.ads.googleads.v13.enums.AssetSetTypeEnum_AssetSetType" json:"type,omitempty"`
	// Output only. The status of the asset set. Read-only.
	Status enums.AssetSetStatusEnum_AssetSetStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v13.enums.AssetSetStatusEnum_AssetSetStatus" json:"status,omitempty"`
...
var file_resources_asset_set_proto_rawDesc = []byte{
	...
	0x31, 0x33, 0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2f, 0x61, 0x73, 0x73, 0x65, 0x74, 0x5f,
...
var file_resources_asset_set_proto_goTypes = []interface{}{
	(*AssetSet)(nil),                             // 0: google.ads.googleads.v13.resources.AssetSet
	(*AssetSet_MerchantCenterFeed)(nil),          // 1: google.ads.googleads.v13.resources.AssetSet.MerchantCenterFeed
	(*AssetSet_HotelPropertyData)(nil),           // 2: google.ads.googleads.v13.resources.AssetSet.HotelPropertyData
	(enums.AssetSetTypeEnum_AssetSetType)(0),     // 3: google.ads.googleads.v13.enums.AssetSetTypeEnum.AssetSetType
	(enums.AssetSetStatusEnum_AssetSetStatus)(0), // 4: google.ads.googleads.v13.enums.AssetSetStatusEnum.AssetSetStatus
	(*common.LocationSet)(nil),                   // 5: google.ads.googleads.v13.common.LocationSet
	(*common.BusinessProfileLocationGroup)(nil),  // 6: google.ads.googleads.v13.common.BusinessProfileLocationGroup
	(*common.ChainLocationGroup)(nil),            // 7: google.ads.googleads.v13.common.ChainLocationGroup
}
var file_resources_asset_set_proto_depIdxs = []int32{
	3, // 0: google.ads.googleads.v13.resources.AssetSet.type:type_name -> google.ads.googleads.v13.enums.AssetSetTypeEnum.AssetSetType
	4, // 1: google.ads.googleads.v13.resources.AssetSet.status:type_name -> google.ads.googleads.v13.enums.AssetSetStatusEnum.AssetSetStatus
	1, // 2: google.ads.googleads.v13.resources.AssetSet.merchant_center_feed:type_name -> google.ads.googleads.v13.resources.AssetSet.MerchantCenterFeed
	2, // 3: google.ads.googleads.v13.resources.AssetSet.hotel_property_data:type_name -> google.ads.googleads.v13.resources.AssetSet.HotelPropertyData
	5, // 4: google.ads.googleads.v13.resources.AssetSet.location_set:type_name -> google.ads.googleads.v13.common.LocationSet
	6, // 5: google.ads.googleads.v13.resources.AssetSet.business_profile_location_group:type_name -> google.ads.googleads.v13.common.BusinessProfileLocationGroup
	7, // 6: google.ads.googleads.v13.resources.AssetSet.chain_location_group:type_name -> google.ads.googleads.v13.common.ChainLocationGroup
