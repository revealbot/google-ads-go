...
type OfflineConversionUploadClientSummary struct {
	...
	Client enums.OfflineEventUploadClientEnum_OfflineEventUploadClient `protobuf:"varint,2,opt,name=client,proto3,enum=google.ads.googleads.v18.enums.OfflineEventUploadClientEnum_OfflineEventUploadClient" json:"client,omitempty"`
	...
	Status enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v18.enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus" json:"status,omitempty"`
...
type OfflineConversionError_CollectionSizeError struct {
	...
	CollectionSizeError errors.CollectionSizeErrorEnum_CollectionSizeError `protobuf:"varint,1,opt,name=collection_size_error,json=collectionSizeError,proto3,enum=google.ads.googleads.v18.errors.CollectionSizeErrorEnum_CollectionSizeError,oneof"`
}

type OfflineConversionError_ConversionAdjustmentUploadError struct {
	// Output only. Conversion adjustment upload error.
	ConversionAdjustmentUploadError errors.ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError `protobuf:"varint,2,opt,name=conversion_adjustment_upload_error,json=conversionAdjustmentUploadError,proto3,enum=google.ads.googleads.v18.errors.ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError,oneof"`
}

type OfflineConversionError_ConversionUploadError struct {
	// Output only. Conversion upload error.
	ConversionUploadError errors.ConversionUploadErrorEnum_ConversionUploadError `protobuf:"varint,3,opt,name=conversion_upload_error,json=conversionUploadError,proto3,enum=google.ads.googleads.v18.errors.ConversionUploadErrorEnum_ConversionUploadError,oneof"`
}

type OfflineConversionError_DateError struct {
	// Output only. Date error.
	DateError errors.DateErrorEnum_DateError `protobuf:"varint,4,opt,name=date_error,json=dateError,proto3,enum=google.ads.googleads.v18.errors.DateErrorEnum_DateError,oneof"`
}

type OfflineConversionError_DistinctError struct {
	// Output only. Distinct error.
	DistinctError errors.DistinctErrorEnum_DistinctError `protobuf:"varint,5,opt,name=distinct_error,json=distinctError,proto3,enum=google.ads.googleads.v18.errors.DistinctErrorEnum_DistinctError,oneof"`
}

type OfflineConversionError_FieldError struct {
	// Output only. Field error.
	FieldError errors.FieldErrorEnum_FieldError `protobuf:"varint,6,opt,name=field_error,json=fieldError,proto3,enum=google.ads.googleads.v18.errors.FieldErrorEnum_FieldError,oneof"`
}

type OfflineConversionError_MutateError struct {
	// Output only. Mutate error.
	MutateError errors.MutateErrorEnum_MutateError `protobuf:"varint,7,opt,name=mutate_error,json=mutateError,proto3,enum=google.ads.googleads.v18.errors.MutateErrorEnum_MutateError,oneof"`
}

type OfflineConversionError_NotAllowlistedError struct {
	// Output only. Not allowlisted error.
	NotAllowlistedError errors.NotAllowlistedErrorEnum_NotAllowlistedError `protobuf:"varint,8,opt,name=not_allowlisted_error,json=notAllowlistedError,proto3,enum=google.ads.googleads.v18.errors.NotAllowlistedErrorEnum_NotAllowlistedError,oneof"`
}

type OfflineConversionError_StringFormatError struct {
	// Output only. String format error.
	StringFormatError errors.StringFormatErrorEnum_StringFormatError `protobuf:"varint,9,opt,name=string_format_error,json=stringFormatError,proto3,enum=google.ads.googleads.v18.errors.StringFormatErrorEnum_StringFormatError,oneof"`
}

type OfflineConversionError_StringLengthError struct {
	// Output only. String length error.
	StringLengthError errors.StringLengthErrorEnum_StringLengthError `protobuf:"varint,10,opt,name=string_length_error,json=stringLengthError,proto3,enum=google.ads.googleads.v18.errors.StringLengthErrorEnum_StringLengthError,oneof"`
}
...
var file_resources_offline_conversion_upload_client_summary_proto_rawDesc = []byte{
	...
	0x38, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65, 0x5f,
	...
	0x64, 0x73, 0x2f, 0x76, 0x31, 0x38, 0x2f, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2f, 0x66, 0x69,
	...
	0x31, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65,
	...
	0x61, 0x64, 0x73, 0x2e, 0x76, 0x31, 0x38, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4f, 0x66,
	...
	0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76,
	0x31, 0x38, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x2e, 0x4f, 0x66, 0x66,
	...
	0x73, 0x2e, 0x76, 0x31, 0x38, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x43, 0x6f, 0x6c,
	...
	0x2e, 0x76, 0x31, 0x38, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x44, 0x69, 0x73, 0x74,
	...
	0x38, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x45, 0x72,
	...
	0x64, 0x73, 0x2e, 0x76, 0x31, 0x38, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x2e, 0x4d, 0x75,
...
var file_resources_offline_conversion_upload_client_summary_proto_goTypes = []interface{}{
	(*OfflineConversionUploadClientSummary)(nil),                                       // 0: google.ads.googleads.v18.resources.OfflineConversionUploadClientSummary
	(*OfflineConversionSummary)(nil),                                                   // 1: google.ads.googleads.v18.resources.OfflineConversionSummary
	(*OfflineConversionAlert)(nil),                                                     // 2: google.ads.googleads.v18.resources.OfflineConversionAlert
	(*OfflineConversionError)(nil),                                                     // 3: google.ads.googleads.v18.resources.OfflineConversionError
	(enums.OfflineEventUploadClientEnum_OfflineEventUploadClient)(0),                   // 4: google.ads.googleads.v18.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	(enums.OfflineConversionDiagnosticStatusEnum_OfflineConversionDiagnosticStatus)(0), // 5: google.ads.googleads.v18.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	(errors.CollectionSizeErrorEnum_CollectionSizeError)(0),                            // 6: google.ads.googleads.v18.errors.CollectionSizeErrorEnum.CollectionSizeError
	(errors.ConversionAdjustmentUploadErrorEnum_ConversionAdjustmentUploadError)(0),    // 7: google.ads.googleads.v18.errors.ConversionAdjustmentUploadErrorEnum.ConversionAdjustmentUploadError
	(errors.ConversionUploadErrorEnum_ConversionUploadError)(0),                        // 8: google.ads.googleads.v18.errors.ConversionUploadErrorEnum.ConversionUploadError
	(errors.DateErrorEnum_DateError)(0),                                                // 9: google.ads.googleads.v18.errors.DateErrorEnum.DateError
	(errors.DistinctErrorEnum_DistinctError)(0),                                        // 10: google.ads.googleads.v18.errors.DistinctErrorEnum.DistinctError
	(errors.FieldErrorEnum_FieldError)(0),                                              // 11: google.ads.googleads.v18.errors.FieldErrorEnum.FieldError
	(errors.MutateErrorEnum_MutateError)(0),                                            // 12: google.ads.googleads.v18.errors.MutateErrorEnum.MutateError
	(errors.NotAllowlistedErrorEnum_NotAllowlistedError)(0),                            // 13: google.ads.googleads.v18.errors.NotAllowlistedErrorEnum.NotAllowlistedError
	(errors.StringFormatErrorEnum_StringFormatError)(0),                                // 14: google.ads.googleads.v18.errors.StringFormatErrorEnum.StringFormatError
	(errors.StringLengthErrorEnum_StringLengthError)(0),                                // 15: google.ads.googleads.v18.errors.StringLengthErrorEnum.StringLengthError
}
var file_resources_offline_conversion_upload_client_summary_proto_depIdxs = []int32{
	4,  // 0: google.ads.googleads.v18.resources.OfflineConversionUploadClientSummary.client:type_name -> google.ads.googleads.v18.enums.OfflineEventUploadClientEnum.OfflineEventUploadClient
	5,  // 1: google.ads.googleads.v18.resources.OfflineConversionUploadClientSummary.status:type_name -> google.ads.googleads.v18.enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus
	1,  // 2: google.ads.googleads.v18.resources.OfflineConversionUploadClientSummary.daily_summaries:type_name -> google.ads.googleads.v18.resources.OfflineConversionSummary
	1,  // 3: google.ads.googleads.v18.resources.OfflineConversionUploadClientSummary.job_summaries:type_name -> google.ads.googleads.v18.resources.OfflineConversionSummary
	2,  // 4: google.ads.googleads.v18.resources.OfflineConversionUploadClientSummary.alerts:type_name -> google.ads.googleads.v18.resources.OfflineConversionAlert
	3,  // 5: google.ads.googleads.v18.resources.OfflineConversionAlert.error:type_name -> google.ads.googleads.v18.resources.OfflineConversionError
	6,  // 6: google.ads.googleads.v18.resources.OfflineConversionError.collection_size_error:type_name -> google.ads.googleads.v18.errors.CollectionSizeErrorEnum.CollectionSizeError
	7,  // 7: google.ads.googleads.v18.resources.OfflineConversionError.conversion_adjustment_upload_error:type_name -> google.ads.googleads.v18.errors.ConversionAdjustmentUploadErrorEnum.ConversionAdjustmentUploadError
	8,  // 8: google.ads.googleads.v18.resources.OfflineConversionError.conversion_upload_error:type_name -> google.ads.googleads.v18.errors.ConversionUploadErrorEnum.ConversionUploadError
	9,  // 9: google.ads.googleads.v18.resources.OfflineConversionError.date_error:type_name -> google.ads.googleads.v18.errors.DateErrorEnum.DateError
	10, // 10: google.ads.googleads.v18.resources.OfflineConversionError.distinct_error:type_name -> google.ads.googleads.v18.errors.DistinctErrorEnum.DistinctError
	11, // 11: google.ads.googleads.v18.resources.OfflineConversionError.field_error:type_name -> google.ads.googleads.v18.errors.FieldErrorEnum.FieldError
	12, // 12: google.ads.googleads.v18.resources.OfflineConversionError.mutate_error:type_name -> google.ads.googleads.v18.errors.MutateErrorEnum.MutateError
	13, // 13: google.ads.googleads.v18.resources.OfflineConversionError.not_allowlisted_error:type_name -> google.ads.googleads.v18.errors.NotAllowlistedErrorEnum.NotAllowlistedError
	14, // 14: google.ads.googleads.v18.resources.OfflineConversionError.string_format_error:type_name -> google.ads.googleads.v18.errors.StringFormatErrorEnum.StringFormatError
	15, // 15: google.ads.googleads.v18.resources.OfflineConversionError.string_length_error:type_name -> google.ads.googleads.v18.errors.StringLengthErrorEnum.StringLengthError
