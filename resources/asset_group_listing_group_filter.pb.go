...
// 	protoc        v7.35.0
// source: google/ads/googleads/v25/resources/asset_group_listing_group_filter.proto
...
type AssetGroupListingGroupFilter struct {
	...
	Type enums.ListingGroupFilterTypeEnum_ListingGroupFilterType `protobuf:"varint,4,opt,name=type,proto3,enum=google.ads.googleads.v25.enums.ListingGroupFilterTypeEnum_ListingGroupFilterType" json:"type,omitempty"`
	// Immutable. The source of listings filtered by this listing group filter.
	ListingSource enums.ListingGroupFilterListingSourceEnum_ListingGroupFilterListingSource `protobuf:"varint,9,opt,name=listing_source,json=listingSource,proto3,enum=google.ads.googleads.v25.enums.ListingGroupFilterListingSourceEnum_ListingGroupFilterListingSource" json:"listing_source,omitempty"`
...
type ListingGroupFilterDimension struct {
	...
	//	*ListingGroupFilterDimension_RetailFilterBundle_
...
func (x *ListingGroupFilterDimension) GetRetailFilterBundle() *ListingGroupFilterDimension_RetailFilterBundle {
	if x != nil {
		if x, ok := x.Dimension.(*ListingGroupFilterDimension_RetailFilterBundle_); ok {
...
type ListingGroupFilterDimension_RetailFilterBundle_ struct {
	// Dimension for Retail Product Tags.
	RetailFilterBundle *ListingGroupFilterDimension_RetailFilterBundle `protobuf:"bytes,11,opt,name=retail_filter_bundle,json=retailFilterBundle,proto3,oneof"`
}
...
func (*ListingGroupFilterDimension_RetailFilterBundle_) isListingGroupFilterDimension_Dimension() {}
...
type ListingGroupFilterDimension_ProductCategory struct {
	...
	Level         enums.ListingGroupFilterProductCategoryLevelEnum_ListingGroupFilterProductCategoryLevel `protobuf:"varint,2,opt,name=level,proto3,enum=google.ads.googleads.v25.enums.ListingGroupFilterProductCategoryLevelEnum_ListingGroupFilterProductCategoryLevel" json:"level,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListingGroupFilterDimension_ProductChannel struct {
	...
	Channel       enums.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel `protobuf:"varint,1,opt,name=channel,proto3,enum=google.ads.googleads.v25.enums.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel" json:"channel,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListingGroupFilterDimension_ProductCondition struct {
	...
	Condition     enums.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition `protobuf:"varint,1,opt,name=condition,proto3,enum=google.ads.googleads.v25.enums.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition" json:"condition,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListingGroupFilterDimension_ProductCustomAttribute struct {
	...
	Index         enums.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex `protobuf:"varint,2,opt,name=index,proto3,enum=google.ads.googleads.v25.enums.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex" json:"index,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ListingGroupFilterDimension_ProductType struct {
	...
	Value *string `protobuf:"bytes,1,opt,name=value,proto3,oneof" json:"value,omitempty"`
	// Level of the type.
	Level         enums.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel `protobuf:"varint,2,opt,name=level,proto3,enum=google.ads.googleads.v25.enums.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel" json:"level,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
// Dimension for Retail Product Tags.
type ListingGroupFilterDimension_RetailFilterBundle struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *ListingGroupFilterDimension_RetailFilterBundle) Reset() {
	*x = ListingGroupFilterDimension_RetailFilterBundle{}
	mi := &file_resources_asset_group_listing_group_filter_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListingGroupFilterDimension_RetailFilterBundle) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListingGroupFilterDimension_RetailFilterBundle) ProtoMessage() {}

func (x *ListingGroupFilterDimension_RetailFilterBundle) ProtoReflect() protoreflect.Message {
	mi := &file_resources_asset_group_listing_group_filter_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListingGroupFilterDimension_RetailFilterBundle.ProtoReflect.Descriptor instead.
func (*ListingGroupFilterDimension_RetailFilterBundle) Descriptor() ([]byte, []int) {
	return file_resources_asset_group_listing_group_filter_proto_rawDescGZIP(), []int{2, 9}
}

func (x *ListingGroupFilterDimension_RetailFilterBundle) GetSharedSet() string {
...
var file_resources_asset_group_listing_group_filter_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2f, 0x76, 0x32, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x69,
	...
	0x32, 0x35, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67,
	...
	0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64,
	0x73, 0x2e, 0x76, 0x32, 0x35, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c, 0x69, 0x73, 0x74,
	...
	0x22, 0xd3, 0x13, 0x0a, 0x1b, 0x4c, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x47, 0x72, 0x6f, 0x75,
	...
	,
	...
	0x6c, 0x65, 0x76, 0x65, 0x6c, 0x42, 0x08, 0x0a, 0x06, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x1a,
	0x7b, 0x0a, 0x07, 0x57, 0x65, 0x62, 0x70, 0x61, 0x67, 0x65, 0x12, 0x70, 0x0a, 0x0a, 0x63, 0x6f,
	0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x50,
	0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x35, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72,
	0x63, 0x65, 0x73, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x69, 0x6e, 0x67, 0x47, 0x72, 0x6f, 0x75, 0x70,
	...
	,
	...
	,
	...
	0x2e, 0x56, 0x32, 0x35, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0xca, 0x02,
	0x22, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f, 0x6f, 0x67,
	0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x32, 0x35, 0x5c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
...
var (
	...
	file_resources_asset_group_listing_group_filter_proto_rawDescData []byte
)
...
func file_resources_asset_group_listing_group_filter_proto_rawDescGZIP() []byte {
	file_resources_asset_group_listing_group_filter_proto_rawDescOnce.Do(func() {
		file_resources_asset_group_listing_group_filter_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_asset_group_listing_group_filter_proto_rawDesc), len(file_resources_asset_group_listing_group_filter_proto_rawDesc)))
	})
	return file_resources_asset_group_listing_group_filter_proto_rawDescData
}

var file_resources_asset_group_listing_group_filter_proto_msgTypes = make([]protoimpl.MessageInfo, 13)
var file_resources_asset_group_listing_group_filter_proto_goTypes = []any{
	(*AssetGroupListingGroupFilter)(nil),                                                         // 0: google.ads.googleads.v25.resources.AssetGroupListingGroupFilter
	(*ListingGroupFilterDimensionPath)(nil),                                                      // 1: google.ads.googleads.v25.resources.ListingGroupFilterDimensionPath
	(*ListingGroupFilterDimension)(nil),                                                          // 2: google.ads.googleads.v25.resources.ListingGroupFilterDimension
	(*ListingGroupFilterDimension_ProductCategory)(nil),                                          // 3: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCategory
	(*ListingGroupFilterDimension_ProductBrand)(nil),                                             // 4: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductBrand
	(*ListingGroupFilterDimension_ProductChannel)(nil),                                           // 5: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductChannel
	(*ListingGroupFilterDimension_ProductCondition)(nil),                                         // 6: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCondition
	(*ListingGroupFilterDimension_ProductCustomAttribute)(nil),                                   // 7: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCustomAttribute
	(*ListingGroupFilterDimension_ProductItemId)(nil),                                            // 8: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductItemId
	(*ListingGroupFilterDimension_ProductType)(nil),                                              // 9: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductType
	(*ListingGroupFilterDimension_Webpage)(nil),                                                  // 10: google.ads.googleads.v25.resources.ListingGroupFilterDimension.Webpage
	(*ListingGroupFilterDimension_WebpageCondition)(nil),                                         // 11: google.ads.googleads.v25.resources.ListingGroupFilterDimension.WebpageCondition
	(*ListingGroupFilterDimension_RetailFilterBundle)(nil),                                       // 12: google.ads.googleads.v25.resources.ListingGroupFilterDimension.RetailFilterBundle
	(enums.ListingGroupFilterTypeEnum_ListingGroupFilterType)(0),                                 // 13: google.ads.googleads.v25.enums.ListingGroupFilterTypeEnum.ListingGroupFilterType
	(enums.ListingGroupFilterListingSourceEnum_ListingGroupFilterListingSource)(0),               // 14: google.ads.googleads.v25.enums.ListingGroupFilterListingSourceEnum.ListingGroupFilterListingSource
	(enums.ListingGroupFilterProductCategoryLevelEnum_ListingGroupFilterProductCategoryLevel)(0), // 15: google.ads.googleads.v25.enums.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevel
	(enums.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel)(0),             // 16: google.ads.googleads.v25.enums.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannel
	(enums.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition)(0),         // 17: google.ads.googleads.v25.enums.ListingGroupFilterProductConditionEnum.ListingGroupFilterProductCondition
	(enums.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex)(0), // 18: google.ads.googleads.v25.enums.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex
	(enums.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel)(0),         // 19: google.ads.googleads.v25.enums.ListingGroupFilterProductTypeLevelEnum.ListingGroupFilterProductTypeLevel
}
var file_resources_asset_group_listing_group_filter_proto_depIdxs = []int32{
	13, // 0: google.ads.googleads.v25.resources.AssetGroupListingGroupFilter.type:type_name -> google.ads.googleads.v25.enums.ListingGroupFilterTypeEnum.ListingGroupFilterType
	14, // 1: google.ads.googleads.v25.resources.AssetGroupListingGroupFilter.listing_source:type_name -> google.ads.googleads.v25.enums.ListingGroupFilterListingSourceEnum.ListingGroupFilterListingSource
	2,  // 2: google.ads.googleads.v25.resources.AssetGroupListingGroupFilter.case_value:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension
	1,  // 3: google.ads.googleads.v25.resources.AssetGroupListingGroupFilter.path:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimensionPath
	2,  // 4: google.ads.googleads.v25.resources.ListingGroupFilterDimensionPath.dimensions:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension
	3,  // 5: google.ads.googleads.v25.resources.ListingGroupFilterDimension.product_category:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCategory
	4,  // 6: google.ads.googleads.v25.resources.ListingGroupFilterDimension.product_brand:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductBrand
	5,  // 7: google.ads.googleads.v25.resources.ListingGroupFilterDimension.product_channel:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductChannel
	6,  // 8: google.ads.googleads.v25.resources.ListingGroupFilterDimension.product_condition:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCondition
	7,  // 9: google.ads.googleads.v25.resources.ListingGroupFilterDimension.product_custom_attribute:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCustomAttribute
	8,  // 10: google.ads.googleads.v25.resources.ListingGroupFilterDimension.product_item_id:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductItemId
	9,  // 11: google.ads.googleads.v25.resources.ListingGroupFilterDimension.product_type:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductType
	10, // 12: google.ads.googleads.v25.resources.ListingGroupFilterDimension.webpage:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.Webpage
	12, // 13: google.ads.googleads.v25.resources.ListingGroupFilterDimension.retail_filter_bundle:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.RetailFilterBundle
	15, // 14: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCategory.level:type_name -> google.ads.googleads.v25.enums.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevel
	16, // 15: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductChannel.channel:type_name -> google.ads.googleads.v25.enums.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannel
	17, // 16: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCondition.condition:type_name -> google.ads.googleads.v25.enums.ListingGroupFilterProductConditionEnum.ListingGroupFilterProductCondition
	18, // 17: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductCustomAttribute.index:type_name -> google.ads.googleads.v25.enums.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex
	19, // 18: google.ads.googleads.v25.resources.ListingGroupFilterDimension.ProductType.level:type_name -> google.ads.googleads.v25.enums.ListingGroupFilterProductTypeLevelEnum.ListingGroupFilterProductTypeLevel
	11, // 19: google.ads.googleads.v25.resources.ListingGroupFilterDimension.Webpage.conditions:type_name -> google.ads.googleads.v25.resources.ListingGroupFilterDimension.WebpageCondition
...
func file_resources_asset_group_listing_group_filter_proto_init() {
	...
	file_resources_asset_group_listing_group_filter_proto_msgTypes[2].OneofWrappers = []any{
		...
		(*ListingGroupFilterDimension_RetailFilterBundle_)(nil),
	}
	...
	file_resources_asset_group_listing_group_filter_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_asset_group_listing_group_filter_proto_rawDesc), len(file_resources_asset_group_listing_group_filter_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   13,
			NumExtensions: 0,
			NumServices:   0,
