...
const file_resources_asset_group_listing_group_filter_proto_rawDesc = "" +
	"\n" +
	...
	"\x1cAssetGroupListingGroupFilter\x12b\n" +
	"\rresource_name\x18\x01 \x01(\tB=\xe0A\x05\xfaA7\n" +
	"5googleads.googleapis.com/AssetGroupListingGroupFilterR\fresourceName\x12L\n" +
	"\vasset_group\x18\x02 \x01(\tB+\xe0A\x05\xfaA%\n" +
	"#googleads.googleapis.com/AssetGroupR\n" +
	"assetGroup\x12\x13\n" +
	"\x02id\x18\x03 \x01(\x03B\x03\xe0A\x03R\x02id\x12j\n" +
	"\x04type\x18\x04 \x01(\x0e2Q.google.ads.googleads.v19.enums.ListingGroupFilterTypeEnum.ListingGroupFilterTypeB\x03\xe0A\x05R\x04type\x12\x8f\x01\n" +
	"\x0elisting_source\x18\t \x01(\x0e2c.google.ads.googleads.v19.enums.ListingGroupFilterListingSourceEnum.ListingGroupFilterListingSourceB\x03\xe0A\x05R\rlistingSource\x12^\n" +
	"\n" +
	"case_value\x18\x06 \x01(\v2?.google.ads.googleads.v19.resources.ListingGroupFilterDimensionR\tcaseValue\x12|\n" +
	"\x1bparent_listing_group_filter\x18\a \x01(\tB=\xe0A\x05\xfaA7\n" +
	"5googleads.googleapis.com/AssetGroupListingGroupFilterR\x18parentListingGroupFilter\x12\\\n" +
	"\x04path\x18\b \x01(\v2C.google.ads.googleads.v19.resources.ListingGroupFilterDimensionPathB\x03\xe0A\x03R\x04path:\x9d\x01\xeaA\x99\x01\n" +
	"5googleads.googleapis.com/AssetGroupListingGroupFilter\x12`customers/{customer_id}/assetGroupListingGroupFilters/{asset_group_id}~{listing_group_filter_id}\"\x87\x01\n" +
	"\x1fListingGroupFilterDimensionPath\x12d\n" +
	"\n" +
	"dimensions\x18\x01 \x03(\v2?.google.ads.googleads.v19.resources.ListingGroupFilterDimensionB\x03\xe0A\x03R\n" +
	"dimensions\"\xd8\x11\n" +
	"\x1bListingGroupFilterDimension\x12|\n" +
	"\x10product_category\x18\n" +
	" \x01(\v2O.google.ads.googleads.v19.resources.ListingGroupFilterDimension.ProductCategoryH\x00R\x0fproductCategory\x12s\n" +
	"\rproduct_brand\x18\x02 \x01(\v2L.google.ads.googleads.v19.resources.ListingGroupFilterDimension.ProductBrandH\x00R\fproductBrand\x12y\n" +
	"\x0fproduct_channel\x18\x03 \x01(\v2N.google.ads.googleads.v19.resources.ListingGroupFilterDimension.ProductChannelH\x00R\x0eproductChannel\x12\x7f\n" +
	"\x11product_condition\x18\x04 \x01(\v2P.google.ads.googleads.v19.resources.ListingGroupFilterDimension.ProductConditionH\x00R\x10productCondition\x12\x92\x01\n" +
	"\x18product_custom_attribute\x18\x05 \x01(\v2V.google.ads.googleads.v19.resources.ListingGroupFilterDimension.ProductCustomAttributeH\x00R\x16productCustomAttribute\x12w\n" +
	"\x0fproduct_item_id\x18\x06 \x01(\v2M.google.ads.googleads.v19.resources.ListingGroupFilterDimension.ProductItemIdH\x00R\rproductItemId\x12p\n" +
	"\fproduct_type\x18\a \x01(\v2K.google.ads.googleads.v19.resources.ListingGroupFilterDimension.ProductTypeH\x00R\vproductType\x12c\n" +
	"\awebpage\x18\t \x01(\v2G.google.ads.googleads.v19.resources.ListingGroupFilterDimension.WebpageH\x00R\awebpage\x1a\xd1\x01\n" +
	"\x0fProductCategory\x12$\n" +
	"\vcategory_id\x18\x01 \x01(\x03H\x00R\n" +
	"categoryId\x88\x01\x01\x12\x87\x01\n" +
	"\x05level\x18\x02 \x01(\x0e2q.google.ads.googleads.v19.enums.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevelR\x05levelB\x0e\n" +
	"\f_category_id\x1a3\n" +
	"\fProductBrand\x12\x19\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x88\x01\x01B\b\n" +
	"\x06_value\x1a\x91\x01\n" +
	"\x0eProductChannel\x12\x7f\n" +
	"\achannel\x18\x01 \x01(\x0e2e.google.ads.googleads.v19.enums.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannelR\achannel\x1a\x9c\x01\n" +
	"\x10ProductCondition\x12\x87\x01\n" +
	"\tcondition\x18\x01 \x01(\x0e2i.google.ads.googleads.v19.enums.ListingGroupFilterProductConditionEnum.ListingGroupFilterProductConditionR\tcondition\x1a\xc7\x01\n" +
	"\x16ProductCustomAttribute\x12\x19\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x88\x01\x01\x12\x87\x01\n" +
	"\x05index\x18\x02 \x01(\x0e2q.google.ads.googleads.v19.enums.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndexR\x05indexB\b\n" +
	"\x06_value\x1a4\n" +
	"\rProductItemId\x12\x19\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x88\x01\x01B\b\n" +
	"\x06_value\x1a\xb3\x01\n" +
	"\vProductType\x12\x19\n" +
	"\x05value\x18\x01 \x01(\tH\x00R\x05value\x88\x01\x01\x12\x7f\n" +
	"\x05level\x18\x02 \x01(\x0e2i.google.ads.googleads.v19.enums.ListingGroupFilterProductTypeLevelEnum.ListingGroupFilterProductTypeLevelR\x05levelB\b\n" +
	"\x06_value\x1a{\n" +
	"\aWebpage\x12p\n" +
	"\n" +
	"conditions\x18\x01 \x03(\v2P.google.ads.googleads.v19.resources.ListingGroupFilterDimension.WebpageConditionR\n" +
	"conditions\x1ai\n" +
	"\x10WebpageCondition\x12#\n" +
	"\fcustom_label\x18\x01 \x01(\tH\x00R\vcustomLabel\x12#\n" +
	"\furl_contains\x18\x02 \x01(\tH\x00R\vurlContainsB\v\n" +
	"\tconditionB\v\n" +
	"\tdimensionB\x93\x02\n" +
	"&com.google.ads.googleads.v19.resourcesB!AssetGroupListingGroupFilterProtoP\x01ZKgithub.com/revealbot/google-ads-go/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"
