...
func init() {
	proto.RegisterType((*AdGroupAd)(nil), "google.ads.googleads.v9.resources.AdGroupAd")
	proto.RegisterType((*AdGroupAdPolicySummary)(nil), "google.ads.googleads.v9.resources.AdGroupAdPolicySummary")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/ad_group_ad.proto", fileDescriptor_cf776c83bb98cd76)
}
