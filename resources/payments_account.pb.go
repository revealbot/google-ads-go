...
func init() {
	proto.RegisterType((*PaymentsAccount)(nil), "google.ads.googleads.v9.resources.PaymentsAccount")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/payments_account.proto", fileDescriptor_cfd44d4d083315de)
}
