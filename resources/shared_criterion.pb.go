...
func init() {
	proto.RegisterType((*SharedCriterion)(nil), "google.ads.googleads.v9.resources.SharedCriterion")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/shared_criterion.proto", fileDescriptor_d7037cca319430ac)
}
