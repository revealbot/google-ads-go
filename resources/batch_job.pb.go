...
type BatchJob struct {
	...
	Status enums.BatchJobStatusEnum_BatchJobStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.BatchJobStatusEnum_BatchJobStatus" json:"status,omitempty"`
...
var file_resources_batch_job_proto_rawDesc = string([]byte{
	...
	0x32, 0x32, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x62, 0x61, 0x74, 0x63, 0x68, 0x5f, 0x6a,
...
var (
	...
	file_resources_batch_job_proto_rawDescData []byte
)

func file_resources_batch_job_proto_rawDescGZIP() []byte {
	file_resources_batch_job_proto_rawDescOnce.Do(func() {
		file_resources_batch_job_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_batch_job_proto_rawDesc), len(file_resources_batch_job_proto_rawDesc)))
	})
...
var file_resources_batch_job_proto_goTypes = []any{
	(*BatchJob)(nil),                             // 0: google.ads.googleads.v22.resources.BatchJob
	(*BatchJob_BatchJobMetadata)(nil),            // 1: google.ads.googleads.v22.resources.BatchJob.BatchJobMetadata
	(enums.BatchJobStatusEnum_BatchJobStatus)(0), // 2: google.ads.googleads.v22.enums.BatchJobStatusEnum.BatchJobStatus
}
var file_resources_batch_job_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.BatchJob.metadata:type_name -> google.ads.googleads.v22.resources.BatchJob.BatchJobMetadata
	2, // 1: google.ads.googleads.v22.resources.BatchJob.status:type_name -> google.ads.googleads.v22.enums.BatchJobStatusEnum.BatchJobStatus
...
func file_resources_batch_job_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_batch_job_proto_rawDesc), len(file_resources_batch_job_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
