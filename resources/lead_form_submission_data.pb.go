...
type LeadFormSubmissionField struct {
	...
	FieldType enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType `protobuf:"varint,1,opt,name=field_type,json=fieldType,proto3,enum=google.ads.googleads.v22.enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType" json:"field_type,omitempty"`
...
var file_resources_lead_form_submission_data_proto_rawDesc = string([]byte{
	...
	0x32, 0x32, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x65, 0x61, 0x64, 0x5f, 0x66, 0x6f,
...
var (
	...
	file_resources_lead_form_submission_data_proto_rawDescData []byte
)
...
func file_resources_lead_form_submission_data_proto_rawDescGZIP() []byte {
	file_resources_lead_form_submission_data_proto_rawDescOnce.Do(func() {
		file_resources_lead_form_submission_data_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_lead_form_submission_data_proto_rawDesc), len(file_resources_lead_form_submission_data_proto_rawDesc)))
	})
...
var file_resources_lead_form_submission_data_proto_goTypes = []any{
	(*LeadFormSubmissionData)(nil),                                       // 0: google.ads.googleads.v22.resources.LeadFormSubmissionData
	(*LeadFormSubmissionField)(nil),                                      // 1: google.ads.googleads.v22.resources.LeadFormSubmissionField
	(*CustomLeadFormSubmissionField)(nil),                                // 2: google.ads.googleads.v22.resources.CustomLeadFormSubmissionField
	(enums.LeadFormFieldUserInputTypeEnum_LeadFormFieldUserInputType)(0), // 3: google.ads.googleads.v22.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType
}
var file_resources_lead_form_submission_data_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.LeadFormSubmissionData.lead_form_submission_fields:type_name -> google.ads.googleads.v22.resources.LeadFormSubmissionField
	2, // 1: google.ads.googleads.v22.resources.LeadFormSubmissionData.custom_lead_form_submission_fields:type_name -> google.ads.googleads.v22.resources.CustomLeadFormSubmissionField
	3, // 2: google.ads.googleads.v22.resources.LeadFormSubmissionField.field_type:type_name -> google.ads.googleads.v22.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType
...
func file_resources_lead_form_submission_data_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_lead_form_submission_data_proto_rawDesc), len(file_resources_lead_form_submission_data_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
