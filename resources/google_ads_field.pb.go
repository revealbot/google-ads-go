...
type GoogleAdsField struct {
	...
	Category enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory `protobuf:"varint,3,opt,name=category,proto3,enum=google.ads.googleads.v22.enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory" json:"category,omitempty"`
	...
	DataType enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType `protobuf:"varint,12,opt,name=data_type,json=dataType,proto3,enum=google.ads.googleads.v22.enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType" json:"data_type,omitempty"`
...
var file_resources_google_ads_field_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x32, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x13,
...
var (
	...
	file_resources_google_ads_field_proto_rawDescData []byte
)

func file_resources_google_ads_field_proto_rawDescGZIP() []byte {
	file_resources_google_ads_field_proto_rawDescOnce.Do(func() {
		file_resources_google_ads_field_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_google_ads_field_proto_rawDesc), len(file_resources_google_ads_field_proto_rawDesc)))
	})
...
var file_resources_google_ads_field_proto_goTypes = []any{
	(*GoogleAdsField)(nil), // 0: google.ads.googleads.v22.resources.GoogleAdsField
	(enums.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory)(0), // 1: google.ads.googleads.v22.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	(enums.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType)(0), // 2: google.ads.googleads.v22.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
}
var file_resources_google_ads_field_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.GoogleAdsField.category:type_name -> google.ads.googleads.v22.enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory
	2, // 1: google.ads.googleads.v22.resources.GoogleAdsField.data_type:type_name -> google.ads.googleads.v22.enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType
...
func file_resources_google_ads_field_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_google_ads_field_proto_rawDesc), len(file_resources_google_ads_field_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
