...
func init() {
	proto.RegisterType((*GoogleAdsField)(nil), "google.ads.googleads.v9.resources.GoogleAdsField")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/google_ads_field.proto", fileDescriptor_80f6b4594efeb0d1)
}
