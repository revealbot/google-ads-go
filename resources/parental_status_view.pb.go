...
func init() {
	proto.RegisterType((*ParentalStatusView)(nil), "google.ads.googleads.v9.resources.ParentalStatusView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/parental_status_view.proto", fileDescriptor_ae1d6e6376638f3a)
}
