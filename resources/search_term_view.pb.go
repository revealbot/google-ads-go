...
func init() {
	proto.RegisterType((*SearchTermView)(nil), "google.ads.googleads.v9.resources.SearchTermView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/search_term_view.proto", fileDescriptor_44c47ef1e53d88b1)
}
