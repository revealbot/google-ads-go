...
const file_resources_customer_negative_criterion_proto_rawDesc = "" +
	"\n" +
	"Dgoogle/ads/googleads/v19/resources/customer_negative_criterion.proto\x12\"google.ads.googleads.v19.resources\x1a.google/ads/googleads/v19/common/criteria.proto\x1a3google/ads/googleads/v19/enums/criterion_type.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\x98\t\n" +
	...
	"\x04type\x18\x03 \x01(\x0e2?.google.ads.googleads.v19.enums.CriterionTypeEnum.CriterionTypeB\x03\xe0A\x03R\x04type\x12]\n" +
	"\rcontent_label\x18\x04 \x01(\v21.google.ads.googleads.v19.common.ContentLabelInfoB\x03\xe0A\x05H\x00R\fcontentLabel\x12l\n" +
	"\x12mobile_application\x18\x05 \x01(\v26.google.ads.googleads.v19.common.MobileApplicationInfoB\x03\xe0A\x05H\x00R\x11mobileApplication\x12m\n" +
	"\x13mobile_app_category\x18\x06 \x01(\v26.google.ads.googleads.v19.common.MobileAppCategoryInfoB\x03\xe0A\x05H\x00R\x11mobileAppCategory\x12S\n" +
	"\tplacement\x18\a \x01(\v2..google.ads.googleads.v19.common.PlacementInfoB\x03\xe0A\x05H\x00R\tplacement\x12]\n" +
	"\ryoutube_video\x18\b \x01(\v21.google.ads.googleads.v19.common.YouTubeVideoInfoB\x03\xe0A\x05H\x00R\fyoutubeVideo\x12c\n" +
	"\x0fyoutube_channel\x18\t \x01(\v23.google.ads.googleads.v19.common.YouTubeChannelInfoB\x03\xe0A\x05H\x00R\x0eyoutubeChannel\x12s\n" +
	"\x15negative_keyword_list\x18\v \x01(\v28.google.ads.googleads.v19.common.NegativeKeywordListInfoB\x03\xe0A\x05H\x00R\x13negativeKeywordList\x12N\n" +
	"\bip_block\x18\f \x01(\v2,.google.ads.googleads.v19.common.IpBlockInfoB\x03\xe0A\x05H\x00R\aipBlock:x\xeaAu\n" +
	"2googleads.googleapis.com/CustomerNegativeCriterion\x12?customers/{customer_id}/customerNegativeCriteria/{criterion_id}B\v\n" +
	"\tcriterionB\x05\n" +
	"\x03_idB\x90\x02\n" +
	"&com.google.ads.googleads.v19.resourcesB\x1eCustomerNegativeCriterionProtoP\x01ZKgithub.com/revealbot/google-ads-go/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"
