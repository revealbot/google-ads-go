...
func init() {
	proto.RegisterType((*KeywordPlanAdGroup)(nil), "google.ads.googleads.v9.resources.KeywordPlanAdGroup")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/keyword_plan_ad_group.proto", fileDescriptor_3824dce59517be04)
}
