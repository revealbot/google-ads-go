...
func init() {
	proto.RegisterType((*HotelPerformanceView)(nil), "google.ads.googleads.v9.resources.HotelPerformanceView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/hotel_performance_view.proto", fileDescriptor_52df0ab1166e0bdf)
}
