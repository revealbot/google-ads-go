...
var file_resources_asset_group_top_combination_view_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_asset_group_top_combination_view_proto_rawDescData []byte
)
...
func file_resources_asset_group_top_combination_view_proto_rawDescGZIP() []byte {
	file_resources_asset_group_top_combination_view_proto_rawDescOnce.Do(func() {
		file_resources_asset_group_top_combination_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_asset_group_top_combination_view_proto_rawDesc), len(file_resources_asset_group_top_combination_view_proto_rawDesc)))
	})
...
var file_resources_asset_group_top_combination_view_proto_goTypes = []any{
	(*AssetGroupTopCombinationView)(nil),   // 0: google.ads.googleads.v22.resources.AssetGroupTopCombinationView
	(*AssetGroupAssetCombinationData)(nil), // 1: google.ads.googleads.v22.resources.AssetGroupAssetCombinationData
	(*common.AssetUsage)(nil),              // 2: google.ads.googleads.v22.common.AssetUsage
}
var file_resources_asset_group_top_combination_view_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.AssetGroupTopCombinationView.asset_group_top_combinations:type_name -> google.ads.googleads.v22.resources.AssetGroupAssetCombinationData
	2, // 1: google.ads.googleads.v22.resources.AssetGroupAssetCombinationData.asset_combination_served_assets:type_name -> google.ads.googleads.v22.common.AssetUsage
...
func file_resources_asset_group_top_combination_view_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_asset_group_top_combination_view_proto_rawDesc), len(file_resources_asset_group_top_combination_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
