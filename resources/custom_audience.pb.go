...
type CustomAudience struct {
	...
	Status enums.CustomAudienceStatusEnum_CustomAudienceStatus `protobuf:"varint,3,opt,name=status,proto3,enum=google.ads.googleads.v23.enums.CustomAudienceStatusEnum_CustomAudienceStatus" json:"status,omitempty"`
	...
	Type enums.CustomAudienceTypeEnum_CustomAudienceType `protobuf:"varint,5,opt,name=type,proto3,enum=google.ads.googleads.v23.enums.CustomAudienceTypeEnum_CustomAudienceType" json:"type,omitempty"`
...
type CustomAudienceMember struct {
	...
	MemberType enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType `protobuf:"varint,1,opt,name=member_type,json=memberType,proto3,enum=google.ads.googleads.v23.enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType" json:"member_type,omitempty"`
...
var file_resources_custom_audience_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_custom_audience_proto_rawDescData []byte
)

func file_resources_custom_audience_proto_rawDescGZIP() []byte {
	file_resources_custom_audience_proto_rawDescOnce.Do(func() {
		file_resources_custom_audience_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_custom_audience_proto_rawDesc), len(file_resources_custom_audience_proto_rawDesc)))
	})
...
var file_resources_custom_audience_proto_goTypes = []any{
	(*CustomAudience)(nil),                                           // 0: google.ads.googleads.v23.resources.CustomAudience
	(*CustomAudienceMember)(nil),                                     // 1: google.ads.googleads.v23.resources.CustomAudienceMember
	(enums.CustomAudienceStatusEnum_CustomAudienceStatus)(0),         // 2: google.ads.googleads.v23.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	(enums.CustomAudienceTypeEnum_CustomAudienceType)(0),             // 3: google.ads.googleads.v23.enums.CustomAudienceTypeEnum.CustomAudienceType
	(enums.CustomAudienceMemberTypeEnum_CustomAudienceMemberType)(0), // 4: google.ads.googleads.v23.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
}
var file_resources_custom_audience_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v23.resources.CustomAudience.status:type_name -> google.ads.googleads.v23.enums.CustomAudienceStatusEnum.CustomAudienceStatus
	3, // 1: google.ads.googleads.v23.resources.CustomAudience.type:type_name -> google.ads.googleads.v23.enums.CustomAudienceTypeEnum.CustomAudienceType
	1, // 2: google.ads.googleads.v23.resources.CustomAudience.members:type_name -> google.ads.googleads.v23.resources.CustomAudienceMember
	4, // 3: google.ads.googleads.v23.resources.CustomAudienceMember.member_type:type_name -> google.ads.googleads.v23.enums.CustomAudienceMemberTypeEnum.CustomAudienceMemberType
...
func file_resources_custom_audience_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_custom_audience_proto_rawDesc), len(file_resources_custom_audience_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
