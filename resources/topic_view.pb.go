...
func init() {
	proto.RegisterType((*TopicView)(nil), "google.ads.googleads.v9.resources.TopicView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/topic_view.proto", fileDescriptor_4ca8d4429105b54b)
}
