...
func init() {
	proto.RegisterType((*AdScheduleView)(nil), "google.ads.googleads.v9.resources.AdScheduleView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/ad_schedule_view.proto", fileDescriptor_9334d85fc04ad394)
}
