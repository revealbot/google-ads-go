...
var file_resources_domain_category_proto_rawDesc = string([]byte{
	...
	0x2e, 0x76, 0x32, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x1a, 0x1f,
...
var (
	...
	file_resources_domain_category_proto_rawDescData []byte
)

func file_resources_domain_category_proto_rawDescGZIP() []byte {
	file_resources_domain_category_proto_rawDescOnce.Do(func() {
		file_resources_domain_category_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_domain_category_proto_rawDesc), len(file_resources_domain_category_proto_rawDesc)))
	})
...
var file_resources_domain_category_proto_goTypes = []any{
	(*DomainCategory)(nil), // 0: google.ads.googleads.v22.resources.DomainCategory
}
...
func file_resources_domain_category_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_domain_category_proto_rawDesc), len(file_resources_domain_category_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
