...
func init() {
	proto.RegisterType((*AdGroupBidModifier)(nil), "google.ads.googleads.v9.resources.AdGroupBidModifier")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/ad_group_bid_modifier.proto", fileDescriptor_69f729284505e90f)
}
