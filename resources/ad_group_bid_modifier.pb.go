...
const file_resources_ad_group_bid_modifier_proto_rawDesc = "" +
	"\n" +
	">google/ads/googleads/v19/resources/ad_group_bid_modifier.proto\x12\"google.ads.googleads.v19.resources\x1a.google/ads/googleads/v19/common/criteria.proto\x1a8google/ads/googleads/v19/enums/bid_modifier_source.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\xd3\n" +
	"\n" +
	...
	" \x01(\x0e2G.google.ads.googleads.v19.enums.BidModifierSourceEnum.BidModifierSourceB\x03\xe0A\x03R\x11bidModifierSource\x12}\n" +
	"\x19hotel_date_selection_type\x18\x05 \x01(\v2;.google.ads.googleads.v19.common.HotelDateSelectionTypeInfoB\x03\xe0A\x05H\x00R\x16hotelDateSelectionType\x12\x86\x01\n" +
	"\x1chotel_advance_booking_window\x18\x06 \x01(\v2>.google.ads.googleads.v19.common.HotelAdvanceBookingWindowInfoB\x03\xe0A\x05H\x00R\x19hotelAdvanceBookingWindow\x12n\n" +
	"\x14hotel_length_of_stay\x18\a \x01(\v26.google.ads.googleads.v19.common.HotelLengthOfStayInfoB\x03\xe0A\x05H\x00R\x11hotelLengthOfStay\x12h\n" +
	"\x12hotel_check_in_day\x18\b \x01(\v24.google.ads.googleads.v19.common.HotelCheckInDayInfoB\x03\xe0A\x05H\x00R\x0fhotelCheckInDay\x12J\n" +
	"\x06device\x18\v \x01(\v2+.google.ads.googleads.v19.common.DeviceInfoB\x03\xe0A\x05H\x00R\x06device\x12{\n" +
	"\x19hotel_check_in_date_range\x18\x11 \x01(\v2:.google.ads.googleads.v19.common.HotelCheckInDateRangeInfoB\x03\xe0A\x05H\x00R\x15hotelCheckInDateRange:z\xeaAw\n" +
	...
	"&com.google.ads.googleads.v19.resourcesB\x17AdGroupBidModifierProtoP\x01ZKgithub.com/revealbot/google-ads-go/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"
