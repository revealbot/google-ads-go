...
func init() {
	proto.RegisterType((*ProductGroupView)(nil), "google.ads.googleads.v9.resources.ProductGroupView")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/product_group_view.proto", fileDescriptor_a1f6f8d3b3fdbada)
}
