...
func init() {
	proto.RegisterType((*KeywordPlan)(nil), "google.ads.googleads.v9.resources.KeywordPlan")
	proto.RegisterType((*KeywordPlanForecastPeriod)(nil), "google.ads.googleads.v9.resources.KeywordPlanForecastPeriod")
}
