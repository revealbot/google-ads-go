...
type CustomConversionGoal struct {
	...
	Status        enums.CustomConversionGoalStatusEnum_CustomConversionGoalStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.CustomConversionGoalStatusEnum_CustomConversionGoalStatus" json:"status,omitempty"`
...
var file_resources_custom_conversion_goal_proto_rawDesc = string([]byte{
	...
	0x76, 0x32, 0x32, 0x2e, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x42, 0x19, 0x43,
...
var (
	...
	file_resources_custom_conversion_goal_proto_rawDescData []byte
)
...
func file_resources_custom_conversion_goal_proto_rawDescGZIP() []byte {
	file_resources_custom_conversion_goal_proto_rawDescOnce.Do(func() {
		file_resources_custom_conversion_goal_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_custom_conversion_goal_proto_rawDesc), len(file_resources_custom_conversion_goal_proto_rawDesc)))
	})
...
var file_resources_custom_conversion_goal_proto_goTypes = []any{
	(*CustomConversionGoal)(nil),                                         // 0: google.ads.googleads.v22.resources.CustomConversionGoal
	(enums.CustomConversionGoalStatusEnum_CustomConversionGoalStatus)(0), // 1: google.ads.googleads.v22.enums.CustomConversionGoalStatusEnum.CustomConversionGoalStatus
}
var file_resources_custom_conversion_goal_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.CustomConversionGoal.status:type_name -> google.ads.googleads.v22.enums.CustomConversionGoalStatusEnum.CustomConversionGoalStatus
...
func file_resources_custom_conversion_goal_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_custom_conversion_goal_proto_rawDesc), len(file_resources_custom_conversion_goal_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
