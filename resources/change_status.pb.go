...
func init() {
	proto.RegisterType((*ChangeStatus)(nil), "google.ads.googleads.v9.resources.ChangeStatus")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/change_status.proto", fileDescriptor_9283dfe5f3535cc7)
}
