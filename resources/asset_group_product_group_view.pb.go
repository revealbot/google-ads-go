...
var file_resources_asset_group_product_group_view_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_asset_group_product_group_view_proto_rawDescData []byte
)
...
func file_resources_asset_group_product_group_view_proto_rawDescGZIP() []byte {
	file_resources_asset_group_product_group_view_proto_rawDescOnce.Do(func() {
		file_resources_asset_group_product_group_view_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_asset_group_product_group_view_proto_rawDesc), len(file_resources_asset_group_product_group_view_proto_rawDesc)))
	})
...
var file_resources_asset_group_product_group_view_proto_goTypes = []any{
	(*AssetGroupProductGroupView)(nil), // 0: google.ads.googleads.v22.resources.AssetGroupProductGroupView
}
...
func file_resources_asset_group_product_group_view_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_asset_group_product_group_view_proto_rawDesc), len(file_resources_asset_group_product_group_view_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
