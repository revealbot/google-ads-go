...
type CustomerClientLink struct {
	...
	Status enums.ManagerLinkStatusEnum_ManagerLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v25.enums.ManagerLinkStatusEnum_ManagerLinkStatus" json:"status,omitempty"`
...
var file_resources_customer_client_link_proto_goTypes = []any{
	(*CustomerClientLink)(nil),                         // 0: google.ads.googleads.v25.resources.CustomerClientLink
	(enums.ManagerLinkStatusEnum_ManagerLinkStatus)(0), // 1: google.ads.googleads.v25.enums.ManagerLinkStatusEnum.ManagerLinkStatus
}
var file_resources_customer_client_link_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.resources.CustomerClientLink.status:type_name -> google.ads.googleads.v25.enums.ManagerLinkStatusEnum.ManagerLinkStatus
