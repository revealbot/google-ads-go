...
func init() {
	proto.RegisterType((*CustomerClientLink)(nil), "google.ads.googleads.v9.resources.CustomerClientLink")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/customer_client_link.proto", fileDescriptor_6e191a1cccf74f17)
}
