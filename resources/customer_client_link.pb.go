...
type CustomerClientLink struct {
	...
	Status enums.ManagerLinkStatusEnum_ManagerLinkStatus `protobuf:"varint,5,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.ManagerLinkStatusEnum_ManagerLinkStatus" json:"status,omitempty"`
...
var file_resources_customer_client_link_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_customer_client_link_proto_rawDescData []byte
)
...
func file_resources_customer_client_link_proto_rawDescGZIP() []byte {
	file_resources_customer_client_link_proto_rawDescOnce.Do(func() {
		file_resources_customer_client_link_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_customer_client_link_proto_rawDesc), len(file_resources_customer_client_link_proto_rawDesc)))
	})
...
var file_resources_customer_client_link_proto_goTypes = []any{
	(*CustomerClientLink)(nil),                         // 0: google.ads.googleads.v22.resources.CustomerClientLink
	(enums.ManagerLinkStatusEnum_ManagerLinkStatus)(0), // 1: google.ads.googleads.v22.enums.ManagerLinkStatusEnum.ManagerLinkStatus
}
var file_resources_customer_client_link_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.CustomerClientLink.status:type_name -> google.ads.googleads.v22.enums.ManagerLinkStatusEnum.ManagerLinkStatus
...
func file_resources_customer_client_link_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_customer_client_link_proto_rawDesc), len(file_resources_customer_client_link_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
