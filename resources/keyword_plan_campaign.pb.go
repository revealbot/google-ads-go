...
func init() {
	proto.RegisterType((*KeywordPlanCampaign)(nil), "google.ads.googleads.v9.resources.KeywordPlanCampaign")
	proto.RegisterType((*KeywordPlanGeoTarget)(nil), "google.ads.googleads.v9.resources.KeywordPlanGeoTarget")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/keyword_plan_campaign.proto", fileDescriptor_8ee1a602123b5150)
}
