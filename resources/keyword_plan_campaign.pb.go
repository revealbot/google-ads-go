...
type KeywordPlanCampaign struct {
	...
	// This field is required and should not be empty when creating Keyword Plan
	// campaigns.
	KeywordPlanNetwork enums.KeywordPlanNetworkEnum_KeywordPlanNetwork `protobuf:"varint,6,opt,name=keyword_plan_network,json=keywordPlanNetwork,proto3,enum=google.ads.googleads.v22.enums.KeywordPlanNetworkEnum_KeywordPlanNetwork" json:"keyword_plan_network,omitempty"`
...
var file_resources_keyword_plan_campaign_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_keyword_plan_campaign_proto_rawDescData []byte
)
...
func file_resources_keyword_plan_campaign_proto_rawDescGZIP() []byte {
	file_resources_keyword_plan_campaign_proto_rawDescOnce.Do(func() {
		file_resources_keyword_plan_campaign_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_keyword_plan_campaign_proto_rawDesc), len(file_resources_keyword_plan_campaign_proto_rawDesc)))
	})
...
var file_resources_keyword_plan_campaign_proto_goTypes = []any{
	(*KeywordPlanCampaign)(nil),                          // 0: google.ads.googleads.v22.resources.KeywordPlanCampaign
	(*KeywordPlanGeoTarget)(nil),                         // 1: google.ads.googleads.v22.resources.KeywordPlanGeoTarget
	(enums.KeywordPlanNetworkEnum_KeywordPlanNetwork)(0), // 2: google.ads.googleads.v22.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
}
var file_resources_keyword_plan_campaign_proto_depIdxs = []int32{
	2, // 0: google.ads.googleads.v22.resources.KeywordPlanCampaign.keyword_plan_network:type_name -> google.ads.googleads.v22.enums.KeywordPlanNetworkEnum.KeywordPlanNetwork
	1, // 1: google.ads.googleads.v22.resources.KeywordPlanCampaign.geo_targets:type_name -> google.ads.googleads.v22.resources.KeywordPlanGeoTarget
...
func file_resources_keyword_plan_campaign_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_keyword_plan_campaign_proto_rawDesc), len(file_resources_keyword_plan_campaign_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
