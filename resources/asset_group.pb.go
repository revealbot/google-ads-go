...
type AssetGroup struct {
	...
	Status enums.AssetGroupStatusEnum_AssetGroupStatus `protobuf:"varint,6,opt,name=status,proto3,enum=google.ads.googleads.v23.enums.AssetGroupStatusEnum_AssetGroupStatus" json:"status,omitempty"`
	...
	PrimaryStatus enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus `protobuf:"varint,11,opt,name=primary_status,json=primaryStatus,proto3,enum=google.ads.googleads.v23.enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus" json:"primary_status,omitempty"`
	...
	// issues.
	PrimaryStatusReasons []enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason `protobuf:"varint,12,rep,packed,name=primary_status_reasons,json=primaryStatusReasons,proto3,enum=google.ads.googleads.v23.enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason" json:"primary_status_reasons,omitempty"`
	...
	AdStrength enums.AdStrengthEnum_AdStrength `protobuf:"varint,10,opt,name=ad_strength,json=adStrength,proto3,enum=google.ads.googleads.v23.enums.AdStrengthEnum_AdStrength" json:"ad_strength,omitempty"`
...
type AdStrengthActionItem struct {
	...
	ActionItemType enums.AdStrengthActionItemTypeEnum_AdStrengthActionItemType `protobuf:"varint,1,opt,name=action_item_type,json=actionItemType,proto3,enum=google.ads.googleads.v23.enums.AdStrengthActionItemTypeEnum_AdStrengthActionItemType" json:"action_item_type,omitempty"`
...
type AdStrengthActionItem_AddAssetDetails struct {
	...
	AssetFieldType enums.AssetFieldTypeEnum_AssetFieldType `protobuf:"varint,1,opt,name=asset_field_type,json=assetFieldType,proto3,enum=google.ads.googleads.v23.enums.AssetFieldTypeEnum_AssetFieldType" json:"asset_field_type,omitempty"`
...
var file_resources_asset_group_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2f, 0x76, 0x32, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x61, 0x64, 0x5f,
	...
	0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x33, 0x2e, 0x52, 0x65, 0x73, 0x6f,
	...
	0x41, 0x64, 0x73, 0x3a, 0x3a, 0x56, 0x32, 0x33, 0x3a, 0x3a, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72,
...
var file_resources_asset_group_proto_goTypes = []any{
	(*AssetGroup)(nil),                                                                               // 0: google.ads.googleads.v23.resources.AssetGroup
	(*AssetCoverage)(nil),                                                                            // 1: google.ads.googleads.v23.resources.AssetCoverage
	(*AdStrengthActionItem)(nil),                                                                     // 2: google.ads.googleads.v23.resources.AdStrengthActionItem
	(*AdStrengthActionItem_AddAssetDetails)(nil),                                                     // 3: google.ads.googleads.v23.resources.AdStrengthActionItem.AddAssetDetails
	(enums.AssetGroupStatusEnum_AssetGroupStatus)(0),                                                 // 4: google.ads.googleads.v23.enums.AssetGroupStatusEnum.AssetGroupStatus
	(enums.AssetGroupPrimaryStatusEnum_AssetGroupPrimaryStatus)(0),                                   // 5: google.ads.googleads.v23.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	(enums.AssetGroupPrimaryStatusReasonEnum_AssetGroupPrimaryStatusReason)(0),                       // 6: google.ads.googleads.v23.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
	(enums.AdStrengthEnum_AdStrength)(0),                                                             // 7: google.ads.googleads.v23.enums.AdStrengthEnum.AdStrength
	(enums.AdStrengthActionItemTypeEnum_AdStrengthActionItemType)(0),                                 // 8: google.ads.googleads.v23.enums.AdStrengthActionItemTypeEnum.AdStrengthActionItemType
	(enums.AssetFieldTypeEnum_AssetFieldType)(0),                                                     // 9: google.ads.googleads.v23.enums.AssetFieldTypeEnum.AssetFieldType
	(enums.AssetCoverageVideoAspectRatioRequirementEnum_AssetCoverageVideoAspectRatioRequirement)(0), // 10: google.ads.googleads.v23.enums.AssetCoverageVideoAspectRatioRequirementEnum.AssetCoverageVideoAspectRatioRequirement
}
var file_resources_asset_group_proto_depIdxs = []int32{
	4,  // 0: google.ads.googleads.v23.resources.AssetGroup.status:type_name -> google.ads.googleads.v23.enums.AssetGroupStatusEnum.AssetGroupStatus
	5,  // 1: google.ads.googleads.v23.resources.AssetGroup.primary_status:type_name -> google.ads.googleads.v23.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus
	6,  // 2: google.ads.googleads.v23.resources.AssetGroup.primary_status_reasons:type_name -> google.ads.googleads.v23.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason
	7,  // 3: google.ads.googleads.v23.resources.AssetGroup.ad_strength:type_name -> google.ads.googleads.v23.enums.AdStrengthEnum.AdStrength
	1,  // 4: google.ads.googleads.v23.resources.AssetGroup.asset_coverage:type_name -> google.ads.googleads.v23.resources.AssetCoverage
	2,  // 5: google.ads.googleads.v23.resources.AssetCoverage.ad_strength_action_items:type_name -> google.ads.googleads.v23.resources.AdStrengthActionItem
	8,  // 6: google.ads.googleads.v23.resources.AdStrengthActionItem.action_item_type:type_name -> google.ads.googleads.v23.enums.AdStrengthActionItemTypeEnum.AdStrengthActionItemType
	3,  // 7: google.ads.googleads.v23.resources.AdStrengthActionItem.add_asset_details:type_name -> google.ads.googleads.v23.resources.AdStrengthActionItem.AddAssetDetails
	9,  // 8: google.ads.googleads.v23.resources.AdStrengthActionItem.AddAssetDetails.asset_field_type:type_name -> google.ads.googleads.v23.enums.AssetFieldTypeEnum.AssetFieldType
	10, // 9: google.ads.googleads.v23.resources.AdStrengthActionItem.AddAssetDetails.video_aspect_ratio_requirement:type_name -> google.ads.googleads.v23.enums.AssetCoverageVideoAspectRatioRequirementEnum.AssetCoverageVideoAspectRatioRequirement
