...
const file_resources_asset_group_proto_rawDesc = "" +
	"\n" +
	...
	"\x06status\x18\x06 \x01(\x0e2E.google.ads.googleads.v19.enums.AssetGroupStatusEnum.AssetGroupStatusR\x06status\x12\x7f\n" +
	"\x0eprimary_status\x18\v \x01(\x0e2S.google.ads.googleads.v19.enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatusB\x03\xe0A\x03R\rprimaryStatus\x12\x9a\x01\n" +
	"\x16primary_status_reasons\x18\f \x03(\x0e2_.google.ads.googleads.v19.enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReasonB\x03\xe0A\x03R\x14primaryStatusReasons\x12\x14\n" +
	"\x05path1\x18\a \x01(\tR\x05path1\x12\x14\n" +
	"\x05path2\x18\b \x01(\tR\x05path2\x12_\n" +
	"\vad_strength\x18\n" +
	" \x01(\x0e29.google.ads.googleads.v19.enums.AdStrengthEnum.AdStrengthB\x03\xe0A\x03R\n" +
	"adStrength\x12]\n" +
	"\x0easset_coverage\x18\r \x01(\v21.google.ads.googleads.v19.resources.AssetCoverageB\x03\xe0A\x03R\rassetCoverage:w\xeaAt\n" +
	"#googleads.googleapis.com/AssetGroup\x124customers/{customer_id}/assetGroups/{asset_group_id}*\vassetGroups2\n" +
	"assetGroup\"\x87\x01\n" +
	"\rAssetCoverage\x12v\n" +
	"\x18ad_strength_action_items\x18\x01 \x03(\v28.google.ads.googleads.v19.resources.AdStrengthActionItemB\x03\xe0A\x03R\x15adStrengthActionItems\"\xd7\x05\n" +
	"\x14AdStrengthActionItem\x12\x84\x01\n" +
	"\x10action_item_type\x18\x01 \x01(\x0e2U.google.ads.googleads.v19.enums.AdStrengthActionItemTypeEnum.AdStrengthActionItemTypeB\x03\xe0A\x03R\x0eactionItemType\x12{\n" +
	"\x11add_asset_details\x18\x02 \x01(\v2H.google.ads.googleads.v19.resources.AdStrengthActionItem.AddAssetDetailsB\x03\xe0A\x03H\x00R\x0faddAssetDetails\x1a\xa8\x03\n" +
	"\x0fAddAssetDetails\x12p\n" +
	"\x10asset_field_type\x18\x01 \x01(\x0e2A.google.ads.googleads.v19.enums.AssetFieldTypeEnum.AssetFieldTypeB\x03\xe0A\x03R\x0eassetFieldType\x12)\n" +
	"\vasset_count\x18\x02 \x01(\x05B\x03\xe0A\x03H\x00R\n" +
	"assetCount\x88\x01\x01\x12\xc4\x01\n" +
	"\x1evideo_aspect_ratio_requirement\x18\x03 \x01(\x0e2u.google.ads.googleads.v19.enums.AssetCoverageVideoAspectRatioRequirementEnum.AssetCoverageVideoAspectRatioRequirementB\x03\xe0A\x03H\x01R\x1bvideoAspectRatioRequirement\x88\x01\x01B\x0e\n" +
	"\f_asset_countB!\n" +
	"\x1f_video_aspect_ratio_requirementB\x10\n" +
	"\x0eaction_detailsB\x81\x02\n" +
	"&com.google.ads.googleads.v19.resourcesB\x0fAssetGroupProtoP\x01ZKgithub.com/revealbot/google-ads-go/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"
