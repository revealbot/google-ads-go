...
const file_resources_smart_campaign_setting_proto_rawDesc = "" +
	"\n" +
	"?google/ads/googleads/v19/resources/smart_campaign_setting.proto\x12\"google.ads.googleads.v19.resources\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\"\x95\b\n" +
	...
	"\fphone_number\x18\x03 \x01(\v2D.google.ads.googleads.v19.resources.SmartCampaignSetting.PhoneNumberR\vphoneNumber\x12:\n" +
	...
	"%ad_optimized_business_profile_setting\x18\t \x01(\v2Z.google.ads.googleads.v19.resources.SmartCampaignSetting.AdOptimizedBusinessProfileSettingH\x00R!adOptimizedBusinessProfileSetting\x12%\n" +
	...
	"&com.google.ads.googleads.v19.resourcesB\x19SmartCampaignSettingProtoP\x01ZKgithub.com/revealbot/google-ads-go/resources;resources\xa2\x02\x03GAA\xaa\x02\"Google.Ads.GoogleAds.V19.Resources\xca\x02\"Google\\Ads\\GoogleAds\\V19\\Resources\xea\x02&Google::Ads::GoogleAds::V19::Resourcesb\x06proto3"

var (
	file_resources_smart_campaign_setting_proto_rawDescOnce sync.Once
	file_resources_smart_campaign_setting_proto_rawDescData []byte
)
...
func file_resources_smart_campaign_setting_proto_rawDescGZIP() []byte {
	file_resources_smart_campaign_setting_proto_rawDescOnce.Do(func() {
		file_resources_smart_campaign_setting_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_smart_campaign_setting_proto_rawDesc), len(file_resources_smart_campaign_setting_proto_rawDesc)))
	})
...
var file_resources_smart_campaign_setting_proto_goTypes = []any{
	(*SmartCampaignSetting)(nil),                                   // 0: google.ads.googleads.v19.resources.SmartCampaignSetting
	(*SmartCampaignSetting_PhoneNumber)(nil),                       // 1: google.ads.googleads.v19.resources.SmartCampaignSetting.PhoneNumber
	(*SmartCampaignSetting_AdOptimizedBusinessProfileSetting)(nil), // 2: google.ads.googleads.v19.resources.SmartCampaignSetting.AdOptimizedBusinessProfileSetting
}
var file_resources_smart_campaign_setting_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v19.resources.SmartCampaignSetting.phone_number:type_name -> google.ads.googleads.v19.resources.SmartCampaignSetting.PhoneNumber
	2, // 1: google.ads.googleads.v19.resources.SmartCampaignSetting.ad_optimized_business_profile_setting:type_name -> google.ads.googleads.v19.resources.SmartCampaignSetting.AdOptimizedBusinessProfileSetting
...
func file_resources_smart_campaign_setting_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_smart_campaign_setting_proto_rawDesc), len(file_resources_smart_campaign_setting_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
