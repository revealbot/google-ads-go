...
func init() {
	proto.RegisterType((*LanguageConstant)(nil), "google.ads.googleads.v9.resources.LanguageConstant")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/language_constant.proto", fileDescriptor_05acff603327c3aa)
}
