...
type AssetSetAsset struct {
	...
	Status        enums.AssetSetAssetStatusEnum_AssetSetAssetStatus `protobuf:"varint,4,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.AssetSetAssetStatusEnum_AssetSetAssetStatus" json:"status,omitempty"`
...
var file_resources_asset_set_asset_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_asset_set_asset_proto_rawDescData []byte
)

func file_resources_asset_set_asset_proto_rawDescGZIP() []byte {
	file_resources_asset_set_asset_proto_rawDescOnce.Do(func() {
		file_resources_asset_set_asset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_asset_set_asset_proto_rawDesc), len(file_resources_asset_set_asset_proto_rawDesc)))
	})
...
var file_resources_asset_set_asset_proto_goTypes = []any{
	(*AssetSetAsset)(nil), // 0: google.ads.googleads.v22.resources.AssetSetAsset
	(enums.AssetSetAssetStatusEnum_AssetSetAssetStatus)(0), // 1: google.ads.googleads.v22.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus
}
var file_resources_asset_set_asset_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.AssetSetAsset.status:type_name -> google.ads.googleads.v22.enums.AssetSetAssetStatusEnum.AssetSetAssetStatus
...
func file_resources_asset_set_asset_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_asset_set_asset_proto_rawDesc), len(file_resources_asset_set_asset_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
