...
type CampaignSharedSet struct {
	...
	Status        enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus `protobuf:"varint,2,opt,name=status,proto3,enum=google.ads.googleads.v22.enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus" json:"status,omitempty"`
...
var file_resources_campaign_shared_set_proto_rawDesc = string([]byte{
...
var (
	...
	file_resources_campaign_shared_set_proto_rawDescData []byte
)
...
func file_resources_campaign_shared_set_proto_rawDescGZIP() []byte {
	file_resources_campaign_shared_set_proto_rawDescOnce.Do(func() {
		file_resources_campaign_shared_set_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_resources_campaign_shared_set_proto_rawDesc), len(file_resources_campaign_shared_set_proto_rawDesc)))
	})
...
var file_resources_campaign_shared_set_proto_goTypes = []any{
	(*CampaignSharedSet)(nil),                                      // 0: google.ads.googleads.v22.resources.CampaignSharedSet
	(enums.CampaignSharedSetStatusEnum_CampaignSharedSetStatus)(0), // 1: google.ads.googleads.v22.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
}
var file_resources_campaign_shared_set_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.resources.CampaignSharedSet.status:type_name -> google.ads.googleads.v22.enums.CampaignSharedSetStatusEnum.CampaignSharedSetStatus
...
func file_resources_campaign_shared_set_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_resources_campaign_shared_set_proto_rawDesc), len(file_resources_campaign_shared_set_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
