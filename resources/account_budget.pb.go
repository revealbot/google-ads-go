...
func init() {
	proto.RegisterType((*AccountBudget)(nil), "google.ads.googleads.v9.resources.AccountBudget")
	proto.RegisterType((*AccountBudget_PendingAccountBudgetProposal)(nil), "google.ads.googleads.v9.resources.AccountBudget.PendingAccountBudgetProposal")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/account_budget.proto", fileDescriptor_a27ed199db7c45f7)
}
