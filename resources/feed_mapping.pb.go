...
func init() {
	proto.RegisterType((*FeedMapping)(nil), "google.ads.googleads.v9.resources.FeedMapping")
	proto.RegisterType((*AttributeFieldMapping)(nil), "google.ads.googleads.v9.resources.AttributeFieldMapping")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/resources/feed_mapping.proto", fileDescriptor_4241d81c78605d65)
}
