...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.StringFormatErrorEnum_StringFormatError", StringFormatErrorEnum_StringFormatError_name, StringFormatErrorEnum_StringFormatError_value)
	proto.RegisterType((*StringFormatErrorEnum)(nil), "google.ads.googleads.v9.errors.StringFormatErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/string_format_error.proto", fileDescriptor_5fc8527e9ecfab70)
}
