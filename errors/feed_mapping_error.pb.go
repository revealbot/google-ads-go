...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.FeedMappingErrorEnum_FeedMappingError", FeedMappingErrorEnum_FeedMappingError_name, FeedMappingErrorEnum_FeedMappingError_value)
	proto.RegisterType((*FeedMappingErrorEnum)(nil), "google.ads.googleads.v9.errors.FeedMappingErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/feed_mapping_error.proto", fileDescriptor_8fe0b067790a1620)
}
