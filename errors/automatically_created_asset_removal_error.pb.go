...
func (AutomaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalError) Descriptor() protoreflect.EnumDescriptor {
	return file_errors_automatically_created_asset_removal_error_proto_enumTypes[0].Descriptor()
}

func (AutomaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalError) Type() protoreflect.EnumType {
	return &file_errors_automatically_created_asset_removal_error_proto_enumTypes[0]
}
...
func (AutomaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalError) EnumDescriptor() ([]byte, []int) {
	return file_errors_automatically_created_asset_removal_error_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *AutomaticallyCreatedAssetRemovalErrorEnum) Reset() {
	*x = AutomaticallyCreatedAssetRemovalErrorEnum{}
	mi := &file_errors_automatically_created_asset_removal_error_proto_msgTypes[0]
...
func (*AutomaticallyCreatedAssetRemovalErrorEnum) Descriptor() ([]byte, []int) {
	return file_errors_automatically_created_asset_removal_error_proto_rawDescGZIP(), []int{0}
}

var File_errors_automatically_created_asset_removal_error_proto protoreflect.FileDescriptor

var file_errors_automatically_created_asset_removal_error_proto_rawDesc = string([]byte{
	...
	0x6c, 0x65, 0x41, 0x64, 0x73, 0x2e, 0x56, 0x32, 0x32, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x73,
	0xca, 0x02, 0x1f, 0x47, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x5c, 0x41, 0x64, 0x73, 0x5c, 0x47, 0x6f,
	0x6f, 0x67, 0x6c, 0x65, 0x41, 0x64, 0x73, 0x5c, 0x56, 0x32, 0x32, 0x5c, 0x45, 0x72, 0x72, 0x6f,
...
var (
	file_errors_automatically_created_asset_removal_error_proto_rawDescOnce sync.Once
	file_errors_automatically_created_asset_removal_error_proto_rawDescData []byte
)

func file_errors_automatically_created_asset_removal_error_proto_rawDescGZIP() []byte {
	file_errors_automatically_created_asset_removal_error_proto_rawDescOnce.Do(func() {
		file_errors_automatically_created_asset_removal_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_errors_automatically_created_asset_removal_error_proto_rawDesc), len(file_errors_automatically_created_asset_removal_error_proto_rawDesc)))
	})
	return file_errors_automatically_created_asset_removal_error_proto_rawDescData
}

var file_errors_automatically_created_asset_removal_error_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_errors_automatically_created_asset_removal_error_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_errors_automatically_created_asset_removal_error_proto_goTypes = []any{
	(AutomaticallyCreatedAssetRemovalErrorEnum_AutomaticallyCreatedAssetRemovalError)(0), // 0: google.ads.googleads.v22.errors.AutomaticallyCreatedAssetRemovalErrorEnum.AutomaticallyCreatedAssetRemovalError
	(*AutomaticallyCreatedAssetRemovalErrorEnum)(nil),                                    // 1: google.ads.googleads.v22.errors.AutomaticallyCreatedAssetRemovalErrorEnum
}
var file_errors_automatically_created_asset_removal_error_proto_depIdxs = []int32{
...
func file_errors_automatically_created_asset_removal_error_proto_init() {
	if File_errors_automatically_created_asset_removal_error_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_errors_automatically_created_asset_removal_error_proto_rawDesc), len(file_errors_automatically_created_asset_removal_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_errors_automatically_created_asset_removal_error_proto_goTypes,
		DependencyIndexes: file_errors_automatically_created_asset_removal_error_proto_depIdxs,
		EnumInfos:         file_errors_automatically_created_asset_removal_error_proto_enumTypes,
		MessageInfos:      file_errors_automatically_created_asset_removal_error_proto_msgTypes,
	}.Build()
	File_errors_automatically_created_asset_removal_error_proto = out.File
	file_errors_automatically_created_asset_removal_error_proto_goTypes = nil
	file_errors_automatically_created_asset_removal_error_proto_depIdxs = nil
}
