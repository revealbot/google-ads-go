...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdErrorEnum_AdError", AdErrorEnum_AdError_name, AdErrorEnum_AdError_value)
	proto.RegisterType((*AdErrorEnum)(nil), "google.ads.googleads.v9.errors.AdErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/ad_error.proto", fileDescriptor_9775b5a00581c080)
}
