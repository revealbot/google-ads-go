...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.ChangeStatusErrorEnum_ChangeStatusError", ChangeStatusErrorEnum_ChangeStatusError_name, ChangeStatusErrorEnum_ChangeStatusError_value)
	proto.RegisterType((*ChangeStatusErrorEnum)(nil), "google.ads.googleads.v9.errors.ChangeStatusErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/change_status_error.proto", fileDescriptor_9471dd6e24155c32)
}
