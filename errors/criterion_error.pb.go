...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CriterionErrorEnum_CriterionError", CriterionErrorEnum_CriterionError_name, CriterionErrorEnum_CriterionError_value)
	proto.RegisterType((*CriterionErrorEnum)(nil), "google.ads.googleads.v9.errors.CriterionErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/criterion_error.proto", fileDescriptor_9ee6104492ac1fe2)
}
