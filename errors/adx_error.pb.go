...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdxErrorEnum_AdxError", AdxErrorEnum_AdxError_name, AdxErrorEnum_AdxError_value)
	proto.RegisterType((*AdxErrorEnum)(nil), "google.ads.googleads.v9.errors.AdxErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/adx_error.proto", fileDescriptor_636d8e8b7297ccf0)
}
