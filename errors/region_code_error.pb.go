...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.RegionCodeErrorEnum_RegionCodeError", RegionCodeErrorEnum_RegionCodeError_name, RegionCodeErrorEnum_RegionCodeError_value)
	proto.RegisterType((*RegionCodeErrorEnum)(nil), "google.ads.googleads.v9.errors.RegionCodeErrorEnum")
}
