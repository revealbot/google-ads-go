...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.FieldMaskErrorEnum_FieldMaskError", FieldMaskErrorEnum_FieldMaskError_name, FieldMaskErrorEnum_FieldMaskError_value)
	proto.RegisterType((*FieldMaskErrorEnum)(nil), "google.ads.googleads.v9.errors.FieldMaskErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/field_mask_error.proto", fileDescriptor_72820e40b31f95b7)
}
