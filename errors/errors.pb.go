...
type ErrorCode_KeywordPlanNegativeKeywordError struct {
	KeywordPlanNegativeKeywordError KeywordPlanNegativeKeywordErrorEnum_KeywordPlanNegativeKeywordError `protobuf:"varint,73,opt,name=keyword_plan_negative_keyword_error,json=keywordPlanNegativeKeywordError,proto3,enum=google.ads.googleads.v9.errors.KeywordPlanNegativeKeywordErrorEnum_KeywordPlanNegativeKeywordError,oneof"`
}
...
type ErrorCode_KeywordPlanKeywordError struct {
	KeywordPlanKeywordError KeywordPlanKeywordErrorEnum_KeywordPlanKeywordError `protobuf:"varint,75,opt,name=keyword_plan_keyword_error,json=keywordPlanKeywordError,proto3,enum=google.ads.googleads.v9.errors.KeywordPlanKeywordErrorEnum_KeywordPlanKeywordError,oneof"`
}
...
func init() {
	proto.RegisterType((*GoogleAdsFailure)(nil), "google.ads.googleads.v9.errors.GoogleAdsFailure")
	proto.RegisterType((*GoogleAdsError)(nil), "google.ads.googleads.v9.errors.GoogleAdsError")
	proto.RegisterType((*ErrorCode)(nil), "google.ads.googleads.v9.errors.ErrorCode")
	proto.RegisterType((*ErrorLocation)(nil), "google.ads.googleads.v9.errors.ErrorLocation")
	proto.RegisterType((*ErrorLocation_FieldPathElement)(nil), "google.ads.googleads.v9.errors.ErrorLocation.FieldPathElement")
	proto.RegisterType((*ErrorDetails)(nil), "google.ads.googleads.v9.errors.ErrorDetails")
	proto.RegisterType((*PolicyViolationDetails)(nil), "google.ads.googleads.v9.errors.PolicyViolationDetails")
	proto.RegisterType((*PolicyFindingDetails)(nil), "google.ads.googleads.v9.errors.PolicyFindingDetails")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/errors.proto", fileDescriptor_10c3852f8fd778b2)
}
