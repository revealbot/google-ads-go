...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.NewResourceCreationErrorEnum_NewResourceCreationError", NewResourceCreationErrorEnum_NewResourceCreationError_name, NewResourceCreationErrorEnum_NewResourceCreationError_value)
	proto.RegisterType((*NewResourceCreationErrorEnum)(nil), "google.ads.googleads.v9.errors.NewResourceCreationErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/new_resource_creation_error.proto", fileDescriptor_44d42568dcd14b02)
}
