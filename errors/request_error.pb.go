...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.RequestErrorEnum_RequestError", RequestErrorEnum_RequestError_name, RequestErrorEnum_RequestError_value)
	proto.RegisterType((*RequestErrorEnum)(nil), "google.ads.googleads.v9.errors.RequestErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/request_error.proto", fileDescriptor_af025fd60103d993)
}
