...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.MediaFileErrorEnum_MediaFileError", MediaFileErrorEnum_MediaFileError_name, MediaFileErrorEnum_MediaFileError_value)
	proto.RegisterType((*MediaFileErrorEnum)(nil), "google.ads.googleads.v9.errors.MediaFileErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/media_file_error.proto", fileDescriptor_a2d93b9512bf54ef)
}
