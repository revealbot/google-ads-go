...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.ExtensionSettingErrorEnum_ExtensionSettingError", ExtensionSettingErrorEnum_ExtensionSettingError_name, ExtensionSettingErrorEnum_ExtensionSettingError_value)
	proto.RegisterType((*ExtensionSettingErrorEnum)(nil), "google.ads.googleads.v9.errors.ExtensionSettingErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/extension_setting_error.proto", fileDescriptor_e0acb104f9133266)
}
