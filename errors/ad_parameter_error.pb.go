...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdParameterErrorEnum_AdParameterError", AdParameterErrorEnum_AdParameterError_name, AdParameterErrorEnum_AdParameterError_value)
	proto.RegisterType((*AdParameterErrorEnum)(nil), "google.ads.googleads.v9.errors.AdParameterErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/ad_parameter_error.proto", fileDescriptor_3af7a7a0c8f4a68d)
}
