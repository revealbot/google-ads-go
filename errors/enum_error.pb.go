...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.EnumErrorEnum_EnumError", EnumErrorEnum_EnumError_name, EnumErrorEnum_EnumError_value)
	proto.RegisterType((*EnumErrorEnum)(nil), "google.ads.googleads.v9.errors.EnumErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/enum_error.proto", fileDescriptor_0ba41addc123f3cb)
}
