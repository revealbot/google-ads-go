...
var file_errors_enum_error_proto_rawDesc = string([]byte{
...
var (
	...
	file_errors_enum_error_proto_rawDescData []byte
)

func file_errors_enum_error_proto_rawDescGZIP() []byte {
	file_errors_enum_error_proto_rawDescOnce.Do(func() {
		file_errors_enum_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_errors_enum_error_proto_rawDesc), len(file_errors_enum_error_proto_rawDesc)))
	})
...
var file_errors_enum_error_proto_goTypes = []any{
	(EnumErrorEnum_EnumError)(0), // 0: google.ads.googleads.v22.errors.EnumErrorEnum.EnumError
	(*EnumErrorEnum)(nil),        // 1: google.ads.googleads.v22.errors.EnumErrorEnum
}
...
func file_errors_enum_error_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_errors_enum_error_proto_rawDesc), len(file_errors_enum_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
