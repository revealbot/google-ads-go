...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CustomerClientLinkErrorEnum_CustomerClientLinkError", CustomerClientLinkErrorEnum_CustomerClientLinkError_name, CustomerClientLinkErrorEnum_CustomerClientLinkError_value)
	proto.RegisterType((*CustomerClientLinkErrorEnum)(nil), "google.ads.googleads.v9.errors.CustomerClientLinkErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/customer_client_link_error.proto", fileDescriptor_b1018da6c8f09f8c)
}
