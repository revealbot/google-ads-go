...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.ConversionActionErrorEnum_ConversionActionError", ConversionActionErrorEnum_ConversionActionError_name, ConversionActionErrorEnum_ConversionActionError_value)
	proto.RegisterType((*ConversionActionErrorEnum)(nil), "google.ads.googleads.v9.errors.ConversionActionErrorEnum")
}
