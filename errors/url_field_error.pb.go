...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.UrlFieldErrorEnum_UrlFieldError", UrlFieldErrorEnum_UrlFieldError_name, UrlFieldErrorEnum_UrlFieldError_value)
	proto.RegisterType((*UrlFieldErrorEnum)(nil), "google.ads.googleads.v9.errors.UrlFieldErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/url_field_error.proto", fileDescriptor_431e07eb138f6320)
}
