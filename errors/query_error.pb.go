...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.QueryErrorEnum_QueryError", QueryErrorEnum_QueryError_name, QueryErrorEnum_QueryError_value)
	proto.RegisterType((*QueryErrorEnum)(nil), "google.ads.googleads.v9.errors.QueryErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/query_error.proto", fileDescriptor_6f4fec85baa96749)
}
