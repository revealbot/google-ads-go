...
var file_errors_query_error_proto_goTypes = []any{
	(QueryErrorEnum_QueryError)(0), // 0: google.ads.googleads.v22.errors.QueryErrorEnum.QueryError
	(*QueryErrorEnum)(nil),         // 1: google.ads.googleads.v22.errors.QueryErrorEnum
}
