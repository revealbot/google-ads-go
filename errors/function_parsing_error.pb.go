...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.FunctionParsingErrorEnum_FunctionParsingError", FunctionParsingErrorEnum_FunctionParsingError_name, FunctionParsingErrorEnum_FunctionParsingError_value)
	proto.RegisterType((*FunctionParsingErrorEnum)(nil), "google.ads.googleads.v9.errors.FunctionParsingErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/function_parsing_error.proto", fileDescriptor_d7874a447e476afb)
}
