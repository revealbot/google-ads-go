...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CampaignCriterionErrorEnum_CampaignCriterionError", CampaignCriterionErrorEnum_CampaignCriterionError_name, CampaignCriterionErrorEnum_CampaignCriterionError_value)
	proto.RegisterType((*CampaignCriterionErrorEnum)(nil), "google.ads.googleads.v9.errors.CampaignCriterionErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/campaign_criterion_error.proto", fileDescriptor_8f09f8f330c3bc1f)
}
