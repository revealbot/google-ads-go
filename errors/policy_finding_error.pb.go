...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.PolicyFindingErrorEnum_PolicyFindingError", PolicyFindingErrorEnum_PolicyFindingError_name, PolicyFindingErrorEnum_PolicyFindingError_value)
	proto.RegisterType((*PolicyFindingErrorEnum)(nil), "google.ads.googleads.v9.errors.PolicyFindingErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/policy_finding_error.proto", fileDescriptor_3d10e554dddee51c)
}
