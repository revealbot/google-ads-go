...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.FeedItemErrorEnum_FeedItemError", FeedItemErrorEnum_FeedItemError_name, FeedItemErrorEnum_FeedItemError_value)
	proto.RegisterType((*FeedItemErrorEnum)(nil), "google.ads.googleads.v9.errors.FeedItemErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/feed_item_error.proto", fileDescriptor_99ffa0797295834e)
}
