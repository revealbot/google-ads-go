...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdGroupErrorEnum_AdGroupError", AdGroupErrorEnum_AdGroupError_name, AdGroupErrorEnum_AdGroupError_value)
	proto.RegisterType((*AdGroupErrorEnum)(nil), "google.ads.googleads.v9.errors.AdGroupErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/ad_group_error.proto", fileDescriptor_0d2823512e8e4828)
}
