...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.DateRangeErrorEnum_DateRangeError", DateRangeErrorEnum_DateRangeError_name, DateRangeErrorEnum_DateRangeError_value)
	proto.RegisterType((*DateRangeErrorEnum)(nil), "google.ads.googleads.v9.errors.DateRangeErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/date_range_error.proto", fileDescriptor_2dc01d50b2259f80)
}
