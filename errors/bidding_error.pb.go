...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.BiddingErrorEnum_BiddingError", BiddingErrorEnum_BiddingError_name, BiddingErrorEnum_BiddingError_value)
	proto.RegisterType((*BiddingErrorEnum)(nil), "google.ads.googleads.v9.errors.BiddingErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/bidding_error.proto", fileDescriptor_82e5e07d9087e59c)
}
