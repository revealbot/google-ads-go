...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.HeaderErrorEnum_HeaderError", HeaderErrorEnum_HeaderError_name, HeaderErrorEnum_HeaderError_value)
	proto.RegisterType((*HeaderErrorEnum)(nil), "google.ads.googleads.v9.errors.HeaderErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/header_error.proto", fileDescriptor_418ddd4782dda673)
}
