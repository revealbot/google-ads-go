...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CampaignBudgetErrorEnum_CampaignBudgetError", CampaignBudgetErrorEnum_CampaignBudgetError_name, CampaignBudgetErrorEnum_CampaignBudgetError_value)
	proto.RegisterType((*CampaignBudgetErrorEnum)(nil), "google.ads.googleads.v9.errors.CampaignBudgetErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/campaign_budget_error.proto", fileDescriptor_9300e3888a22b411)
}
