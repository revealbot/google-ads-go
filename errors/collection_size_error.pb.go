...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CollectionSizeErrorEnum_CollectionSizeError", CollectionSizeErrorEnum_CollectionSizeError_name, CollectionSizeErrorEnum_CollectionSizeError_value)
	proto.RegisterType((*CollectionSizeErrorEnum)(nil), "google.ads.googleads.v9.errors.CollectionSizeErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/collection_size_error.proto", fileDescriptor_450d03ea4ad853f4)
}
