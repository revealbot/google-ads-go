...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.ImageErrorEnum_ImageError", ImageErrorEnum_ImageError_name, ImageErrorEnum_ImageError_value)
	proto.RegisterType((*ImageErrorEnum)(nil), "google.ads.googleads.v9.errors.ImageErrorEnum")
}
