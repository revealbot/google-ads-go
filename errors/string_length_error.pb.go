...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.StringLengthErrorEnum_StringLengthError", StringLengthErrorEnum_StringLengthError_name, StringLengthErrorEnum_StringLengthError_value)
	proto.RegisterType((*StringLengthErrorEnum)(nil), "google.ads.googleads.v9.errors.StringLengthErrorEnum")
}
