...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CustomerManagerLinkErrorEnum_CustomerManagerLinkError", CustomerManagerLinkErrorEnum_CustomerManagerLinkError_name, CustomerManagerLinkErrorEnum_CustomerManagerLinkError_value)
	proto.RegisterType((*CustomerManagerLinkErrorEnum)(nil), "google.ads.googleads.v9.errors.CustomerManagerLinkErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/customer_manager_link_error.proto", fileDescriptor_f4805bf779f258b5)
}
