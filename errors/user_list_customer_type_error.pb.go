...
var file_errors_user_list_customer_type_error_proto_goTypes = []interface{}{
	(UserListCustomerTypeErrorEnum_UserListCustomerTypeError)(0), // 0: google.ads.googleads.v18.errors.UserListCustomerTypeErrorEnum.UserListCustomerTypeError
	(*UserListCustomerTypeErrorEnum)(nil),                        // 1: google.ads.googleads.v18.errors.UserListCustomerTypeErrorEnum
}
...
func file_errors_user_list_customer_type_error_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_errors_user_list_customer_type_error_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
