...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CustomerErrorEnum_CustomerError", CustomerErrorEnum_CustomerError_name, CustomerErrorEnum_CustomerError_value)
	proto.RegisterType((*CustomerErrorEnum)(nil), "google.ads.googleads.v9.errors.CustomerErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/customer_error.proto", fileDescriptor_c9e66c3070369bbd)
}
