...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.SharedSetErrorEnum_SharedSetError", SharedSetErrorEnum_SharedSetError_name, SharedSetErrorEnum_SharedSetError_value)
	proto.RegisterType((*SharedSetErrorEnum)(nil), "google.ads.googleads.v9.errors.SharedSetErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/shared_set_error.proto", fileDescriptor_6111e246eb270151)
}
