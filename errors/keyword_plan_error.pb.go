...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.KeywordPlanErrorEnum_KeywordPlanError", KeywordPlanErrorEnum_KeywordPlanError_name, KeywordPlanErrorEnum_KeywordPlanError_value)
	proto.RegisterType((*KeywordPlanErrorEnum)(nil), "google.ads.googleads.v9.errors.KeywordPlanErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/keyword_plan_error.proto", fileDescriptor_cde1d45f7d0384c7)
}
