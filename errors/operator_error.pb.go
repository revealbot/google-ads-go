...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.OperatorErrorEnum_OperatorError", OperatorErrorEnum_OperatorError_name, OperatorErrorEnum_OperatorError_value)
	proto.RegisterType((*OperatorErrorEnum)(nil), "google.ads.googleads.v9.errors.OperatorErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/operator_error.proto", fileDescriptor_ef7e8edff1e60eda)
}
