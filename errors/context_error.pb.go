...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.ContextErrorEnum_ContextError", ContextErrorEnum_ContextError_name, ContextErrorEnum_ContextError_value)
	proto.RegisterType((*ContextErrorEnum)(nil), "google.ads.googleads.v9.errors.ContextErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/context_error.proto", fileDescriptor_8629287d03c2fcb7)
}
