...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdGroupBidModifierErrorEnum_AdGroupBidModifierError", AdGroupBidModifierErrorEnum_AdGroupBidModifierError_name, AdGroupBidModifierErrorEnum_AdGroupBidModifierError_value)
	proto.RegisterType((*AdGroupBidModifierErrorEnum)(nil), "google.ads.googleads.v9.errors.AdGroupBidModifierErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/ad_group_bid_modifier_error.proto", fileDescriptor_f4a6d661fb90a168)
}
