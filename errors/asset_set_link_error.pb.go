...
var file_errors_asset_set_link_error_proto_rawDesc = string([]byte{
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x32, 0x2e, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0x87, 0x02,
...
var (
	...
	file_errors_asset_set_link_error_proto_rawDescData []byte
)

func file_errors_asset_set_link_error_proto_rawDescGZIP() []byte {
	file_errors_asset_set_link_error_proto_rawDescOnce.Do(func() {
		file_errors_asset_set_link_error_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_errors_asset_set_link_error_proto_rawDesc), len(file_errors_asset_set_link_error_proto_rawDesc)))
	})
...
var file_errors_asset_set_link_error_proto_goTypes = []any{
	(AssetSetLinkErrorEnum_AssetSetLinkError)(0), // 0: google.ads.googleads.v22.errors.AssetSetLinkErrorEnum.AssetSetLinkError
	(*AssetSetLinkErrorEnum)(nil),                // 1: google.ads.googleads.v22.errors.AssetSetLinkErrorEnum
}
...
func file_errors_asset_set_link_error_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_errors_asset_set_link_error_proto_rawDesc), len(file_errors_asset_set_link_error_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
