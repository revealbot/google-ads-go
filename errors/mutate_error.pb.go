...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.MutateErrorEnum_MutateError", MutateErrorEnum_MutateError_name, MutateErrorEnum_MutateError_value)
	proto.RegisterType((*MutateErrorEnum)(nil), "google.ads.googleads.v9.errors.MutateErrorEnum")
}
