...
var file_errors_mutate_error_proto_goTypes = []any{
	(MutateErrorEnum_MutateError)(0), // 0: google.ads.googleads.v22.errors.MutateErrorEnum.MutateError
	(*MutateErrorEnum)(nil),          // 1: google.ads.googleads.v22.errors.MutateErrorEnum
}
