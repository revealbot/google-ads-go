...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.BiddingStrategyErrorEnum_BiddingStrategyError", BiddingStrategyErrorEnum_BiddingStrategyError_name, BiddingStrategyErrorEnum_BiddingStrategyError_value)
	proto.RegisterType((*BiddingStrategyErrorEnum)(nil), "google.ads.googleads.v9.errors.BiddingStrategyErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/bidding_strategy_error.proto", fileDescriptor_0728bafc5c82bd9f)
}
