...
var file_errors_label_error_proto_goTypes = []any{
	(LabelErrorEnum_LabelError)(0), // 0: google.ads.googleads.v22.errors.LabelErrorEnum.LabelError
	(*LabelErrorEnum)(nil),         // 1: google.ads.googleads.v22.errors.LabelErrorEnum
}
