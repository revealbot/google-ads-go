...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.IdErrorEnum_IdError", IdErrorEnum_IdError_name, IdErrorEnum_IdError_value)
	proto.RegisterType((*IdErrorEnum)(nil), "google.ads.googleads.v9.errors.IdErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/id_error.proto", fileDescriptor_481b2d6c08b40a01)
}
