...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.FeedItemValidationErrorEnum_FeedItemValidationError", FeedItemValidationErrorEnum_FeedItemValidationError_name, FeedItemValidationErrorEnum_FeedItemValidationError_value)
	proto.RegisterType((*FeedItemValidationErrorEnum)(nil), "google.ads.googleads.v9.errors.FeedItemValidationErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/feed_item_validation_error.proto", fileDescriptor_3467e9329ac8bbde)
}
