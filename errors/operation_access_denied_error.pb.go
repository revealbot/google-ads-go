...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.OperationAccessDeniedErrorEnum_OperationAccessDeniedError", OperationAccessDeniedErrorEnum_OperationAccessDeniedError_name, OperationAccessDeniedErrorEnum_OperationAccessDeniedError_value)
	proto.RegisterType((*OperationAccessDeniedErrorEnum)(nil), "google.ads.googleads.v9.errors.OperationAccessDeniedErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/operation_access_denied_error.proto", fileDescriptor_fb3b0aac42536863)
}
