...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.MultiplierErrorEnum_MultiplierError", MultiplierErrorEnum_MultiplierError_name, MultiplierErrorEnum_MultiplierError_value)
	proto.RegisterType((*MultiplierErrorEnum)(nil), "google.ads.googleads.v9.errors.MultiplierErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/multiplier_error.proto", fileDescriptor_bb6c3c8aa121bbde)
}
