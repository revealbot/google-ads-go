...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError", KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError_name, KeywordPlanIdeaErrorEnum_KeywordPlanIdeaError_value)
	proto.RegisterType((*KeywordPlanIdeaErrorEnum)(nil), "google.ads.googleads.v9.errors.KeywordPlanIdeaErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/keyword_plan_idea_error.proto", fileDescriptor_ede9abcd4982043b)
}
