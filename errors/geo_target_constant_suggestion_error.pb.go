...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.GeoTargetConstantSuggestionErrorEnum_GeoTargetConstantSuggestionError", GeoTargetConstantSuggestionErrorEnum_GeoTargetConstantSuggestionError_name, GeoTargetConstantSuggestionErrorEnum_GeoTargetConstantSuggestionError_value)
	proto.RegisterType((*GeoTargetConstantSuggestionErrorEnum)(nil), "google.ads.googleads.v9.errors.GeoTargetConstantSuggestionErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/geo_target_constant_suggestion_error.proto", fileDescriptor_0211167de73473bf)
}
