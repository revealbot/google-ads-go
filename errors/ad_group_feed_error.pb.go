...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdGroupFeedErrorEnum_AdGroupFeedError", AdGroupFeedErrorEnum_AdGroupFeedError_name, AdGroupFeedErrorEnum_AdGroupFeedError_value)
	proto.RegisterType((*AdGroupFeedErrorEnum)(nil), "google.ads.googleads.v9.errors.AdGroupFeedErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/ad_group_feed_error.proto", fileDescriptor_8ab63eb0dbc1326e)
}
