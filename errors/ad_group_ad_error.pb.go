...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdGroupAdErrorEnum_AdGroupAdError", AdGroupAdErrorEnum_AdGroupAdError_name, AdGroupAdErrorEnum_AdGroupAdError_value)
	proto.RegisterType((*AdGroupAdErrorEnum)(nil), "google.ads.googleads.v9.errors.AdGroupAdErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/ad_group_ad_error.proto", fileDescriptor_8fcbc1bc2062400b)
}
