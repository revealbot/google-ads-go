...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.ResourceAccessDeniedErrorEnum_ResourceAccessDeniedError", ResourceAccessDeniedErrorEnum_ResourceAccessDeniedError_name, ResourceAccessDeniedErrorEnum_ResourceAccessDeniedError_value)
	proto.RegisterType((*ResourceAccessDeniedErrorEnum)(nil), "google.ads.googleads.v9.errors.ResourceAccessDeniedErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/resource_access_denied_error.proto", fileDescriptor_be307f994c248b0a)
}
