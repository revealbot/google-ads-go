...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.CustomerFeedErrorEnum_CustomerFeedError", CustomerFeedErrorEnum_CustomerFeedError_name, CustomerFeedErrorEnum_CustomerFeedError_value)
	proto.RegisterType((*CustomerFeedErrorEnum)(nil), "google.ads.googleads.v9.errors.CustomerFeedErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/customer_feed_error.proto", fileDescriptor_d6d8c1cc6d23d819)
}
