...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AdGroupCriterionErrorEnum_AdGroupCriterionError", AdGroupCriterionErrorEnum_AdGroupCriterionError_name, AdGroupCriterionErrorEnum_AdGroupCriterionError_value)
	proto.RegisterType((*AdGroupCriterionErrorEnum)(nil), "google.ads.googleads.v9.errors.AdGroupCriterionErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/ad_group_criterion_error.proto", fileDescriptor_ab297178b75dc9da)
}
