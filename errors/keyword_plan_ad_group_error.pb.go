...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError", KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError_name, KeywordPlanAdGroupErrorEnum_KeywordPlanAdGroupError_value)
	proto.RegisterType((*KeywordPlanAdGroupErrorEnum)(nil), "google.ads.googleads.v9.errors.KeywordPlanAdGroupErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/keyword_plan_ad_group_error.proto", fileDescriptor_2bdfaf63ed9ec36a)
}
