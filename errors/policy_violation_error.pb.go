...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.PolicyViolationErrorEnum_PolicyViolationError", PolicyViolationErrorEnum_PolicyViolationError_name, PolicyViolationErrorEnum_PolicyViolationError_value)
	proto.RegisterType((*PolicyViolationErrorEnum)(nil), "google.ads.googleads.v9.errors.PolicyViolationErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/policy_violation_error.proto", fileDescriptor_a4b5e7134ee70800)
}
