...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.RecommendationErrorEnum_RecommendationError", RecommendationErrorEnum_RecommendationError_name, RecommendationErrorEnum_RecommendationError_value)
	proto.RegisterType((*RecommendationErrorEnum)(nil), "google.ads.googleads.v9.errors.RecommendationErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/recommendation_error.proto", fileDescriptor_d96255e6afd54850)
}
