...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AuthorizationErrorEnum_AuthorizationError", AuthorizationErrorEnum_AuthorizationError_name, AuthorizationErrorEnum_AuthorizationError_value)
	proto.RegisterType((*AuthorizationErrorEnum)(nil), "google.ads.googleads.v9.errors.AuthorizationErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/authorization_error.proto", fileDescriptor_e07a13a2f7455f77)
}
