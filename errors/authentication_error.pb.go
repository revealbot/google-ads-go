...
func init() {
	proto.RegisterEnum("google.ads.googleads.v9.errors.AuthenticationErrorEnum_AuthenticationError", AuthenticationErrorEnum_AuthenticationError_name, AuthenticationErrorEnum_AuthenticationError_value)
	proto.RegisterType((*AuthenticationErrorEnum)(nil), "google.ads.googleads.v9.errors.AuthenticationErrorEnum")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/errors/authentication_error.proto", fileDescriptor_bf995c8bcd802bf7)
}
