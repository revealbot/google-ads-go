...
const file_services_bidding_data_exclusion_service_proto_rawDesc = "" +
	"\n" +
	...
	"customerId\x12e\n" +
	"\n" +
	"operations\x18\x02 \x03(\v2@.google.ads.googleads.v19.services.BiddingDataExclusionOperationB\x03\xe0A\x02R\n" +
	"operations\x12'\n" +
	"\x0fpartial_failure\x18\x03 \x01(\bR\x0epartialFailure\x12#\n" +
	"\rvalidate_only\x18\x04 \x01(\bR\fvalidateOnly\x12\x7f\n" +
	"\x15response_content_type\x18\x05 \x01(\x0e2K.google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\"\xdf\x02\n" +
	"\x1dBiddingDataExclusionOperation\x12;\n" +
	"\vupdate_mask\x18\x04 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12R\n" +
	"\x06create\x18\x01 \x01(\v28.google.ads.googleads.v19.resources.BiddingDataExclusionH\x00R\x06create\x12R\n" +
	"\x06update\x18\x02 \x01(\v28.google.ads.googleads.v19.resources.BiddingDataExclusionH\x00R\x06update\x12L\n" +
	...
	"\aresults\x18\x02 \x03(\v2D.google.ads.googleads.v19.services.MutateBiddingDataExclusionsResultR\aresults\"\xec\x01\n" +
	...
	"\x16bidding_data_exclusion\x18\x02 \x01(\v28.google.ads.googleads.v19.resources.BiddingDataExclusionR\x14biddingDataExclusion2\xf4\x02\n" +
	"\x1bBiddingDataExclusionService\x12\x8d\x02\n" +
	"\x1bMutateBiddingDataExclusions\x12E.google.ads.googleads.v19.services.MutateBiddingDataExclusionsRequest\x1aF.google.ads.googleads.v19.services.MutateBiddingDataExclusionsResponse\"_\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02@:\x01*\";/v19/customers/{customer_id=*}/biddingDataExclusions:mutate\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x8c\x02\n" +
	"%com.google.ads.googleads.v19.servicesB BiddingDataExclusionServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
