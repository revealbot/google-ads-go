...
func (c *travelAssetSuggestionServiceClient) SuggestTravelAssets(ctx context.Context, in *SuggestTravelAssetsRequest, opts ...grpc.CallOption) (*SuggestTravelAssetsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v14.services.TravelAssetSuggestionService/SuggestTravelAssets", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TravelAssetSuggestionService_SuggestTravelAssets_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v14.services.TravelAssetSuggestionService/SuggestTravelAssets",
	}
...
var TravelAssetSuggestionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v14.services.TravelAssetSuggestionService",
	...
	Metadata: "google/ads/googleads/v14/services/travel_asset_suggestion_service.proto",
}
