...
func init() {
	proto.RegisterType((*GetChangeStatusRequest)(nil), "google.ads.googleads.v9.services.GetChangeStatusRequest")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/change_status_service.proto", fileDescriptor_5f9e8eb8258aae82)
}
