...
func init() {
	proto.RegisterType((*GetSharedSetRequest)(nil), "google.ads.googleads.v9.services.GetSharedSetRequest")
	proto.RegisterType((*MutateSharedSetsRequest)(nil), "google.ads.googleads.v9.services.MutateSharedSetsRequest")
	proto.RegisterType((*SharedSetOperation)(nil), "google.ads.googleads.v9.services.SharedSetOperation")
	proto.RegisterType((*MutateSharedSetsResponse)(nil), "google.ads.googleads.v9.services.MutateSharedSetsResponse")
	proto.RegisterType((*MutateSharedSetResult)(nil), "google.ads.googleads.v9.services.MutateSharedSetResult")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/shared_set_service.proto", fileDescriptor_b21526a3b3467a54)
}
