...
const file_services_content_creator_insights_service_proto_rawDesc = "" +
	"\n" +
	"Hgoogle/ads/googleads/v19/services/content_creator_insights_service.proto\x12!google.ads.googleads.v19.services\x1aAgoogle/ads/googleads/v19/common/audience_insights_attribute.proto\x1a.google/ads/googleads/v19/common/criteria.proto\x1a3google/ads/googleads/v19/enums/insights_trend.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\"\x88\t\n" +
	"\x1eGenerateCreatorInsightsRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12;\n" +
	"\x17customer_insights_group\x18\x02 \x01(\tB\x03\xe0A\x02R\x15customerInsightsGroup\x12_\n" +
	"\x11country_locations\x18\x06 \x03(\v2-.google.ads.googleads.v19.common.LocationInfoB\x03\xe0A\x02R\x10countryLocations\x12\x81\x01\n" +
	"\x11search_attributes\x18\x03 \x01(\v2R.google.ads.googleads.v19.services.GenerateCreatorInsightsRequest.SearchAttributesH\x00R\x10searchAttributes\x12r\n" +
	"\fsearch_brand\x18\x05 \x01(\v2M.google.ads.googleads.v19.services.GenerateCreatorInsightsRequest.SearchBrandH\x00R\vsearchBrand\x12|\n" +
	"\x0fsearch_channels\x18\x04 \x01(\v2Q.google.ads.googleads.v19.services.GenerateCreatorInsightsRequest.YouTubeChannelsH\x00R\x0esearchChannels\x1a\xf4\x01\n" +
	"\x10SearchAttributes\x12p\n" +
	"\x13audience_attributes\x18\x01 \x03(\v2:.google.ads.googleads.v19.common.AudienceInsightsAttributeB\x03\xe0A\x01R\x12audienceAttributes\x12n\n" +
	"\x12creator_attributes\x18\x02 \x03(\v2:.google.ads.googleads.v19.common.AudienceInsightsAttributeB\x03\xe0A\x01R\x11creatorAttributes\x1a\xb0\x01\n" +
	"\vSearchBrand\x12f\n" +
	"\x0ebrand_entities\x18\x01 \x03(\v2:.google.ads.googleads.v19.common.AudienceInsightsAttributeB\x03\xe0A\x01R\rbrandEntities\x129\n" +
	"\x16include_related_topics\x18\x02 \x01(\bB\x03\xe0A\x01R\x14includeRelatedTopics\x1av\n" +
	"\x0fYouTubeChannels\x12c\n" +
	"\x10youtube_channels\x18\x01 \x03(\v23.google.ads.googleads.v19.common.YouTubeChannelInfoB\x03\xe0A\x01R\x0fyoutubeChannelsB\n" +
	"\n" +
	"\bcriteria\"\x87\x01\n" +
	"\x1fGenerateCreatorInsightsResponse\x12d\n" +
	"\x10creator_insights\x18\x01 \x03(\v29.google.ads.googleads.v19.services.YouTubeCreatorInsightsR\x0fcreatorInsights\"\xa5\x03\n" +
	...
	"\x10country_location\x18\x03 \x01(\v2-.google.ads.googleads.v19.common.LocationInfoB\x03\xe0A\x02R\x0fcountryLocation\x12\\\n" +
	"\x0fsearch_audience\x18\x04 \x01(\v21.google.ads.googleads.v19.services.SearchAudienceH\x00R\x0esearchAudience\x12V\n" +
	"\rsearch_topics\x18\x05 \x01(\v2/.google.ads.googleads.v19.services.SearchTopicsH\x00R\fsearchTopicsB\n" +
	"\n" +
	"\bcriteria\"z\n" +
	" GenerateTrendingInsightsResponse\x12V\n" +
	"\x0etrend_insights\x18\x01 \x03(\v2/.google.ads.googleads.v19.services.TrendInsightR\rtrendInsights\"\xa1\x01\n" +
	"\x16YouTubeCreatorInsights\x12!\n" +
	"\fcreator_name\x18\x01 \x01(\tR\vcreatorName\x12d\n" +
	"\x10creator_channels\x18\x02 \x03(\v29.google.ads.googleads.v19.services.YouTubeChannelInsightsR\x0fcreatorChannels\"\xb6\x01\n" +
	...
	"videoCount\x127\n" +
	"\x18is_active_shorts_creator\x18\x04 \x01(\bR\x15isActiveShortsCreator\"\xc5\x05\n" +
	"\x16YouTubeChannelInsights\x12!\n" +
	"\fdisplay_name\x18\x01 \x01(\tR\vdisplayName\x12\\\n" +
	"\x0fyoutube_channel\x18\x02 \x01(\v23.google.ads.googleads.v19.common.YouTubeChannelInfoR\x0eyoutubeChannel\x12\x1f\n" +
	"\vchannel_url\x18\t \x01(\tR\n" +
	"channelUrl\x12/\n" +
	"\x13channel_description\x18\n" +
	" \x01(\tR\x12channelDescription\x12Z\n" +
	"\x0fchannel_metrics\x18\x03 \x01(\v21.google.ads.googleads.v19.services.YouTubeMetricsR\x0echannelMetrics\x12\x82\x01\n" +
	"\x1bchannel_audience_attributes\x18\a \x03(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\x19channelAudienceAttributes\x12q\n" +
	"\x12channel_attributes\x18\x05 \x03(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\x11channelAttributes\x12a\n" +
	"\n" +
	"top_videos\x18\b \x03(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\ttopVideos\x12!\n" +
	"\fchannel_type\x18\x06 \x01(\tR\vchannelType\"\x82\x01\n" +
	"\x0eSearchAudience\x12p\n" +
	"\x13audience_attributes\x18\x01 \x03(\v2:.google.ads.googleads.v19.common.AudienceInsightsAttributeB\x03\xe0A\x02R\x12audienceAttributes\"h\n" +
	"\fSearchTopics\x12X\n" +
	"\bentities\x18\x01 \x03(\v27.google.ads.googleads.v19.common.AudienceInsightsEntityB\x03\xe0A\x02R\bentities\"\xaf\x02\n" +
	"\fTrendInsight\x12k\n" +
	"\x0ftrend_attribute\x18\x01 \x01(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\x0etrendAttribute\x12[\n" +
	"\rtrend_metrics\x18\x02 \x01(\v26.google.ads.googleads.v19.services.TrendInsightMetricsR\ftrendMetrics\x12U\n" +
	"\x05trend\x18\x03 \x01(\x0e2?.google.ads.googleads.v19.enums.InsightsTrendEnum.InsightsTrendR\x05trend\"6\n" +
	"\x13TrendInsightMetrics\x12\x1f\n" +
	"\vviews_count\x18\x01 \x01(\x03R\n" +
	"viewsCount2\xb6\x04\n" +
	"\x1dContentCreatorInsightsService\x12\xe3\x01\n" +
	"\x17GenerateCreatorInsights\x12A.google.ads.googleads.v19.services.GenerateCreatorInsightsRequest\x1aB.google.ads.googleads.v19.services.GenerateCreatorInsightsResponse\"A\x82\xd3\xe4\x93\x02;:\x01*\"6/v19/customers/{customer_id=*}:generateCreatorInsights\x12\xe7\x01\n" +
	"\x18GenerateTrendingInsights\x12B.google.ads.googleads.v19.services.GenerateTrendingInsightsRequest\x1aC.google.ads.googleads.v19.services.GenerateTrendingInsightsResponse\"B\x82\xd3\xe4\x93\x02<:\x01*\"7/v19/customers/{customer_id=*}:generateTrendingInsights\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x8e\x02\n" +
	"%com.google.ads.googleads.v19.servicesB\"ContentCreatorInsightsServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
