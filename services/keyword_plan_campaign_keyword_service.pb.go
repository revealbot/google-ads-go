...
// Request message for
// [KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords][google.ads.googleads.v25.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords].
...
func (x *MutateKeywordPlanCampaignKeywordsRequest) Reset() {
	*x = MutateKeywordPlanCampaignKeywordsRequest{}
	mi := &file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_msgTypes[0]
...
func (*MutateKeywordPlanCampaignKeywordsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *KeywordPlanCampaignKeywordOperation) Reset() {
	*x = KeywordPlanCampaignKeywordOperation{}
	mi := &file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*KeywordPlanCampaignKeywordOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateKeywordPlanCampaignKeywordsResponse) Reset() {
	*x = MutateKeywordPlanCampaignKeywordsResponse{}
	mi := &file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanCampaignKeywordsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateKeywordPlanCampaignKeywordResult) Reset() {
	*x = MutateKeywordPlanCampaignKeywordResult{}
	mi := &file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateKeywordPlanCampaignKeywordResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDesc = string([]byte{
	...
	0x22, 0x41, 0x2f, 0x76, 0x32, 0x35, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73,
...
var (
	file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDescData
}

var file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_goTypes = []any{
	(*MutateKeywordPlanCampaignKeywordsRequest)(nil),  // 0: google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordsRequest
	(*KeywordPlanCampaignKeywordOperation)(nil),       // 1: google.ads.googleads.v25.services.KeywordPlanCampaignKeywordOperation
	(*MutateKeywordPlanCampaignKeywordsResponse)(nil), // 2: google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordsResponse
	(*MutateKeywordPlanCampaignKeywordResult)(nil),    // 3: google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordResult
	(*fieldmaskpb.FieldMask)(nil),                     // 4: google.protobuf.FieldMask
	(*resources.KeywordPlanCampaignKeyword)(nil),      // 5: google.ads.googleads.v25.resources.KeywordPlanCampaignKeyword
	(*status.Status)(nil),                             // 6: google.rpc.Status
}
var file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordsRequest.operations:type_name -> google.ads.googleads.v25.services.KeywordPlanCampaignKeywordOperation
	4, // 1: google.ads.googleads.v25.services.KeywordPlanCampaignKeywordOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v25.services.KeywordPlanCampaignKeywordOperation.create:type_name -> google.ads.googleads.v25.resources.KeywordPlanCampaignKeyword
	5, // 3: google.ads.googleads.v25.services.KeywordPlanCampaignKeywordOperation.update:type_name -> google.ads.googleads.v25.resources.KeywordPlanCampaignKeyword
	6, // 4: google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 5: google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordsResponse.results:type_name -> google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordResult
	0, // 6: google.ads.googleads.v25.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords:input_type -> google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordsRequest
	2, // 7: google.ads.googleads.v25.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords:output_type -> google.ads.googleads.v25.services.MutateKeywordPlanCampaignKeywordsResponse
...
func file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_init() {
	if File_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto != nil {
		return
	}
	file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto = out.File
	file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_goTypes = nil
	file_google_ads_googleads_v25_services_keyword_plan_campaign_keyword_service_proto_depIdxs = nil
}
