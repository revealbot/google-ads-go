...
const file_services_audience_insights_service_proto_rawDesc = "" +
	"\n" +
	"Agoogle/ads/googleads/v19/services/audience_insights_service.proto\x12!google.ads.googleads.v19.services\x1aAgoogle/ads/googleads/v19/common/audience_insights_attribute.proto\x1a.google/ads/googleads/v19/common/criteria.proto\x1a+google/ads/googleads/v19/common/dates.proto\x1a@google/ads/googleads/v19/enums/audience_insights_dimension.proto\x1aJgoogle/ads/googleads/v19/enums/audience_insights_marketing_objective.proto\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\"\xdb\x02\n" +
	"#GenerateInsightsFinderReportRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12j\n" +
	"\x11baseline_audience\x18\x02 \x01(\v28.google.ads.googleads.v19.services.BasicInsightsAudienceB\x03\xe0A\x02R\x10baselineAudience\x12j\n" +
	"\x11specific_audience\x18\x03 \x01(\v28.google.ads.googleads.v19.services.BasicInsightsAudienceB\x03\xe0A\x02R\x10specificAudience\x126\n" +
	"\x17customer_insights_group\x18\x04 \x01(\tR\x15customerInsightsGroup\"P\n" +
	"$GenerateInsightsFinderReportResponse\x12(\n" +
	"\x10saved_report_url\x18\x01 \x01(\tR\x0esavedReportUrl\"\xdf\x03\n" +
	"*GenerateAudienceCompositionInsightsRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12T\n" +
	"\baudience\x18\x02 \x01(\v23.google.ads.googleads.v19.services.InsightsAudienceB\x03\xe0A\x02R\baudience\x12`\n" +
	"\x11baseline_audience\x18\x06 \x01(\v23.google.ads.googleads.v19.services.InsightsAudienceR\x10baselineAudience\x12\x1d\n" +
	"\n" +
	"data_month\x18\x03 \x01(\tR\tdataMonth\x12|\n" +
	"\n" +
	"dimensions\x18\x04 \x03(\x0e2W.google.ads.googleads.v19.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimensionB\x03\xe0A\x02R\n" +
	"dimensions\x126\n" +
	"\x17customer_insights_group\x18\x05 \x01(\tR\x15customerInsightsGroup\"\x88\x01\n" +
	"+GenerateAudienceCompositionInsightsResponse\x12Y\n" +
	"\bsections\x18\x01 \x03(\v2=.google.ads.googleads.v19.services.AudienceCompositionSectionR\bsections\"\x87\x03\n" +
	")GenerateSuggestedTargetingInsightsRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12;\n" +
	"\x17customer_insights_group\x18\x05 \x01(\tB\x03\xe0A\x01R\x15customerInsightsGroup\x12p\n" +
	"\x13audience_definition\x18\x06 \x01(\v2=.google.ads.googleads.v19.services.InsightsAudienceDefinitionH\x00R\x12audienceDefinition\x12s\n" +
	"\x14audience_description\x18\a \x01(\v2>.google.ads.googleads.v19.services.InsightsAudienceDescriptionH\x00R\x13audienceDescriptionB\x10\n" +
	"\x0eaudience_input\"\x8d\x01\n" +
	"*GenerateSuggestedTargetingInsightsResponse\x12_\n" +
	"\vsuggestions\x18\x01 \x03(\v2=.google.ads.googleads.v19.services.TargetingSuggestionMetricsR\vsuggestions\"\xc4\x04\n" +
	"\x1aTargetingSuggestionMetrics\x12`\n" +
	"\tlocations\x18\t \x03(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\tlocations\x12L\n" +
	"\n" +
	"age_ranges\x18\x02 \x03(\v2-.google.ads.googleads.v19.common.AgeRangeInfoR\tageRanges\x12C\n" +
	"\x06gender\x18\x03 \x01(\v2+.google.ads.googleads.v19.common.GenderInfoR\x06gender\x12\\\n" +
	"\x0fparental_status\x18\b \x01(\v23.google.ads.googleads.v19.common.ParentalStatusInfoR\x0eparentalStatus\x12i\n" +
	"\x0euser_interests\x18\n" +
	" \x03(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\ruserInterests\x12\x1a\n" +
	"\bcoverage\x18\x05 \x01(\x01R\bcoverage\x12\x14\n" +
	"\x05index\x18\x06 \x01(\x01R\x05index\x126\n" +
	"\x17potential_youtube_reach\x18\a \x01(\x03R\x15potentialYoutubeReach\"\xf5\x03\n" +
	"%ListAudienceInsightsAttributesRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12|\n" +
	"\n" +
	"dimensions\x18\x02 \x03(\x0e2W.google.ads.googleads.v19.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimensionB\x03\xe0A\x02R\n" +
	"dimensions\x12\"\n" +
	"\n" +
	"query_text\x18\x03 \x01(\tB\x03\xe0A\x02R\tqueryText\x126\n" +
	"\x17customer_insights_group\x18\x04 \x01(\tR\x15customerInsightsGroup\x12g\n" +
	"\x18location_country_filters\x18\x05 \x03(\v2-.google.ads.googleads.v19.common.LocationInfoR\x16locationCountryFilters\x12c\n" +
	"\x16youtube_reach_location\x18\x06 \x01(\v2-.google.ads.googleads.v19.common.LocationInfoR\x14youtubeReachLocation\"\x8c\x01\n" +
	"&ListAudienceInsightsAttributesResponse\x12b\n" +
	"\n" +
	"attributes\x18\x02 \x03(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\n" +
	"attributes\"\"\n" +
	" ListInsightsEligibleDatesRequest\"\x9a\x01\n" +
	"!ListInsightsEligibleDatesResponse\x12\x1f\n" +
	"\vdata_months\x18\x01 \x03(\tR\n" +
	"dataMonths\x12T\n" +
	"\x10last_thirty_days\x18\x02 \x01(\v2*.google.ads.googleads.v19.common.DateRangeR\x0elastThirtyDays\"\xd1\x03\n" +
	"&GenerateAudienceOverlapInsightsRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12]\n" +
	"\x10country_location\x18\x02 \x01(\v2-.google.ads.googleads.v19.common.LocationInfoB\x03\xe0A\x02R\x0fcountryLocation\x12l\n" +
	"\x11primary_attribute\x18\x06 \x01(\v2:.google.ads.googleads.v19.common.AudienceInsightsAttributeB\x03\xe0A\x02R\x10primaryAttribute\x12|\n" +
	"\n" +
	"dimensions\x18\x04 \x03(\x0e2W.google.ads.googleads.v19.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimensionB\x03\xe0A\x02R\n" +
	"dimensions\x126\n" +
	"\x17customer_insights_group\x18\x05 \x01(\tR\x15customerInsightsGroup\"\x94\x02\n" +
	"'GenerateAudienceOverlapInsightsResponse\x12\x80\x01\n" +
	"\x1aprimary_attribute_metadata\x18\x03 \x01(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\x18primaryAttributeMetadata\x12f\n" +
	"\x11dimension_results\x18\x02 \x03(\v29.google.ads.googleads.v19.services.DimensionOverlapResultR\x10dimensionResults\"\xdd\x01\n" +
	"\x16DimensionOverlapResult\x12u\n" +
	"\tdimension\x18\x01 \x01(\x0e2W.google.ads.googleads.v19.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimensionR\tdimension\x12L\n" +
	"\x05items\x18\x02 \x03(\v26.google.ads.googleads.v19.services.AudienceOverlapItemR\x05items\"\xd9\x01\n" +
	"\x13AudienceOverlapItem\x12q\n" +
	"\x12attribute_metadata\x18\x03 \x01(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\x11attributeMetadata\x12O\n" +
	"$potential_youtube_reach_intersection\x18\x02 \x01(\x03R!potentialYoutubeReachIntersection\"\xeb\x01\n" +
	")GenerateTargetingSuggestionMetricsRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12[\n" +
	"\taudiences\x18\x02 \x03(\v28.google.ads.googleads.v19.services.BasicInsightsAudienceB\x03\xe0A\x02R\taudiences\x12;\n" +
	"\x17customer_insights_group\x18\x03 \x01(\tB\x03\xe0A\x01R\x15customerInsightsGroup\"\x8d\x01\n" +
	"*GenerateTargetingSuggestionMetricsResponse\x12_\n" +
	"\vsuggestions\x18\x01 \x03(\v2=.google.ads.googleads.v19.services.TargetingSuggestionMetricsR\vsuggestions\"\x96\x04\n" +
	"\x15BasicInsightsAudience\x12]\n" +
	"\x10country_location\x18\x01 \x03(\v2-.google.ads.googleads.v19.common.LocationInfoB\x03\xe0A\x02R\x0fcountryLocation\x12a\n" +
	"\x15sub_country_locations\x18\x02 \x03(\v2-.google.ads.googleads.v19.common.LocationInfoR\x13subCountryLocations\x12C\n" +
	"\x06gender\x18\x03 \x01(\v2+.google.ads.googleads.v19.common.GenderInfoR\x06gender\x12L\n" +
	"\n" +
	"age_ranges\x18\x04 \x03(\v2-.google.ads.googleads.v19.common.AgeRangeInfoR\tageRanges\x12X\n" +
	"\x0euser_interests\x18\x05 \x03(\v21.google.ads.googleads.v19.common.UserInterestInfoR\ruserInterests\x12N\n" +
	"\x06topics\x18\a \x03(\v26.google.ads.googleads.v19.common.AudienceInsightsTopicR\x06topics\"\xfd\x01\n" +
	"\x1aInsightsAudienceDefinition\x12T\n" +
	"\baudience\x18\x01 \x01(\v23.google.ads.googleads.v19.services.InsightsAudienceB\x03\xe0A\x02R\baudience\x12e\n" +
	"\x11baseline_audience\x18\x02 \x01(\v23.google.ads.googleads.v19.services.InsightsAudienceB\x03\xe0A\x01R\x10baselineAudience\x12\"\n" +
	"\n" +
	"data_month\x18\x03 \x01(\tB\x03\xe0A\x01R\tdataMonth\"\xd8\x02\n" +
	"\x1bInsightsAudienceDescription\x12_\n" +
	"\x11country_locations\x18\x01 \x03(\v2-.google.ads.googleads.v19.common.LocationInfoB\x03\xe0A\x02R\x10countryLocations\x126\n" +
	"\x14audience_description\x18\x02 \x01(\tB\x03\xe0A\x02R\x13audienceDescription\x12\x9f\x01\n" +
	"\x13marketing_objective\x18\x03 \x01(\x0e2i.google.ads.googleads.v19.enums.AudienceInsightsMarketingObjectiveEnum.AudienceInsightsMarketingObjectiveB\x03\xe0A\x01R\x12marketingObjective\"\x8b\x06\n" +
	"\x10InsightsAudience\x12_\n" +
	"\x11country_locations\x18\x01 \x03(\v2-.google.ads.googleads.v19.common.LocationInfoB\x03\xe0A\x02R\x10countryLocations\x12a\n" +
	"\x15sub_country_locations\x18\x02 \x03(\v2-.google.ads.googleads.v19.common.LocationInfoR\x13subCountryLocations\x12C\n" +
	"\x06gender\x18\x03 \x01(\v2+.google.ads.googleads.v19.common.GenderInfoR\x06gender\x12L\n" +
	"\n" +
	"age_ranges\x18\x04 \x03(\v2-.google.ads.googleads.v19.common.AgeRangeInfoR\tageRanges\x12\\\n" +
	"\x0fparental_status\x18\x05 \x01(\v23.google.ads.googleads.v19.common.ParentalStatusInfoR\x0eparentalStatus\x12U\n" +
	"\rincome_ranges\x18\x06 \x03(\v20.google.ads.googleads.v19.common.IncomeRangeInfoR\fincomeRanges\x12g\n" +
	"\x0fdynamic_lineups\x18\t \x03(\v2>.google.ads.googleads.v19.common.AudienceInsightsDynamicLineupR\x0edynamicLineups\x12\x81\x01\n" +
	"\x1btopic_audience_combinations\x18\b \x03(\v2A.google.ads.googleads.v19.services.InsightsAudienceAttributeGroupR\x19topicAudienceCombinations\"\x81\x01\n" +
	"\x1eInsightsAudienceAttributeGroup\x12_\n" +
	"\n" +
	"attributes\x18\x02 \x03(\v2:.google.ads.googleads.v19.common.AudienceInsightsAttributeB\x03\xe0A\x02R\n" +
	"attributes\"\xf6\x02\n" +
	"\x1aAudienceCompositionSection\x12u\n" +
	"\tdimension\x18\x01 \x01(\x0e2W.google.ads.googleads.v19.enums.AudienceInsightsDimensionEnum.AudienceInsightsDimensionR\tdimension\x12f\n" +
	"\x0etop_attributes\x18\x03 \x03(\v2?.google.ads.googleads.v19.services.AudienceCompositionAttributeR\rtopAttributes\x12y\n" +
	"\x14clustered_attributes\x18\x04 \x03(\v2F.google.ads.googleads.v19.services.AudienceCompositionAttributeClusterR\x13clusteredAttributes\"\xa0\x02\n" +
	"#AudienceCompositionAttributeCluster\x120\n" +
	"\x14cluster_display_name\x18\x01 \x01(\tR\x12clusterDisplayName\x12f\n" +
	"\x0fcluster_metrics\x18\x03 \x01(\v2=.google.ads.googleads.v19.services.AudienceCompositionMetricsR\x0eclusterMetrics\x12_\n" +
	"\n" +
	"attributes\x18\x04 \x03(\v2?.google.ads.googleads.v19.services.AudienceCompositionAttributeR\n" +
	"attributes\"\xa7\x01\n" +
	...
	"\x12attribute_metadata\x18\x03 \x01(\v2B.google.ads.googleads.v19.common.AudienceInsightsAttributeMetadataR\x11attributeMetadata\x12W\n" +
	"\ametrics\x18\x02 \x01(\v2=.google.ads.googleads.v19.services.AudienceCompositionMetricsR\ametrics2\xd0\x10\n" +
	"\x17AudienceInsightsService\x12\xa9\x02\n" +
	"\x1cGenerateInsightsFinderReport\x12F.google.ads.googleads.v19.services.GenerateInsightsFinderReportRequest\x1aG.google.ads.googleads.v19.services.GenerateInsightsFinderReportResponse\"x\xdaA/customer_id,baseline_audience,specific_audience\x82\xd3\xe4\x93\x02@:\x01*\";/v19/customers/{customer_id=*}:generateInsightsFinderReport\x12\xa5\x02\n" +
	"\x1eListAudienceInsightsAttributes\x12H.google.ads.googleads.v19.services.ListAudienceInsightsAttributesRequest\x1aI.google.ads.googleads.v19.services.ListAudienceInsightsAttributesResponse\"n\xdaA!customer_id,dimensions,query_text\x82\xd3\xe4\x93\x02D:\x01*\"?/v19/customers/{customer_id=*}:searchAudienceInsightsAttributes\x12\xe2\x01\n" +
	"\x19ListInsightsEligibleDates\x12C.google.ads.googleads.v19.services.ListInsightsEligibleDatesRequest\x1aD.google.ads.googleads.v19.services.ListInsightsEligibleDatesResponse\":\x82\xd3\xe4\x93\x024:\x01*\"//v19/audienceInsights:listInsightsEligibleDates\x12\xb5\x02\n" +
	"#GenerateAudienceCompositionInsights\x12M.google.ads.googleads.v19.services.GenerateAudienceCompositionInsightsRequest\x1aN.google.ads.googleads.v19.services.GenerateAudienceCompositionInsightsResponse\"o\xdaA\x1fcustomer_id,audience,dimensions\x82\xd3\xe4\x93\x02G:\x01*\"B/v19/customers/{customer_id=*}:generateAudienceCompositionInsights\x12\x8f\x02\n" +
	"\"GenerateSuggestedTargetingInsights\x12L.google.ads.googleads.v19.services.GenerateSuggestedTargetingInsightsRequest\x1aM.google.ads.googleads.v19.services.GenerateSuggestedTargetingInsightsResponse\"L\x82\xd3\xe4\x93\x02F:\x01*\"A/v19/customers/{customer_id=*}:generateSuggestedTargetingInsights\x12\xc0\x02\n" +
	"\x1fGenerateAudienceOverlapInsights\x12I.google.ads.googleads.v19.services.GenerateAudienceOverlapInsightsRequest\x1aJ.google.ads.googleads.v19.services.GenerateAudienceOverlapInsightsResponse\"\x85\x01\xdaA9customer_id,country_location,primary_attribute,dimensions\x82\xd3\xe4\x93\x02C:\x01*\">/v19/customers/{customer_id=*}:generateAudienceOverlapInsights\x12\xa7\x02\n" +
	"\"GenerateTargetingSuggestionMetrics\x12L.google.ads.googleads.v19.services.GenerateTargetingSuggestionMetricsRequest\x1aM.google.ads.googleads.v19.services.GenerateTargetingSuggestionMetricsResponse\"d\xdaA\x15customer_id,audiences\x82\xd3\xe4\x93\x02F:\x01*\"A/v19/customers/{customer_id=*}:generateTargetingSuggestionMetrics\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x88\x02\n" +
	"%com.google.ads.googleads.v19.servicesB\x1cAudienceInsightsServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
