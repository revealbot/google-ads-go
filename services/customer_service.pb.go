...
const file_services_customer_service_proto_rawDesc = "" +
	"\n" +
	...
	"customerId\x12W\n" +
	"\toperation\x18\x04 \x01(\v24.google.ads.googleads.v19.services.CustomerOperationB\x03\xe0A\x02R\toperation\x12#\n" +
	"\rvalidate_only\x18\x05 \x01(\bR\fvalidateOnly\x12\x7f\n" +
	"\x15response_content_type\x18\x06 \x01(\x0e2K.google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\"\xdc\x02\n" +
	"\x1bCreateCustomerClientRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12Z\n" +
	"\x0fcustomer_client\x18\x02 \x01(\v2,.google.ads.googleads.v19.resources.CustomerB\x03\xe0A\x02R\x0ecustomerClient\x12(\n" +
	"\remail_address\x18\x05 \x01(\tH\x00R\femailAddress\x88\x01\x01\x12Z\n" +
	"\vaccess_role\x18\x04 \x01(\x0e29.google.ads.googleads.v19.enums.AccessRoleEnum.AccessRoleR\n" +
	"accessRole\x12#\n" +
	"\rvalidate_only\x18\x06 \x01(\bR\fvalidateOnlyB\x10\n" +
	"\x0e_email_address\"\x96\x01\n" +
	"\x11CustomerOperation\x12D\n" +
	"\x06update\x18\x01 \x01(\v2,.google.ads.googleads.v19.resources.CustomerR\x06update\x12;\n" +
	...
	"\x06result\x18\x02 \x01(\v27.google.ads.googleads.v19.services.MutateCustomerResultR\x06result\"\xad\x01\n" +
	"\x14MutateCustomerResult\x12K\n" +
	"\rresource_name\x18\x01 \x01(\tB&\xfaA#\n" +
	"!googleads.googleapis.com/CustomerR\fresourceName\x12H\n" +
	"\bcustomer\x18\x02 \x01(\v2,.google.ads.googleads.v19.resources.CustomerR\bcustomer\" \n" +
	...
	"\x0eMutateCustomer\x128.google.ads.googleads.v19.services.MutateCustomerRequest\x1a9.google.ads.googleads.v19.services.MutateCustomerResponse\"H\xdaA\x15customer_id,operation\x82\xd3\xe4\x93\x02*:\x01*\"%/v19/customers/{customer_id=*}:mutate\x12\xd0\x01\n" +
	...
	"\x14CreateCustomerClient\x12>.google.ads.googleads.v19.services.CreateCustomerClientRequest\x1a?.google.ads.googleads.v19.services.CreateCustomerClientResponse\"\\\xdaA\x1bcustomer_id,customer_client\x82\xd3\xe4\x93\x028:\x01*\"3/v19/customers/{customer_id=*}:createCustomerClient\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x80\x02\n" +
	"%com.google.ads.googleads.v19.servicesB\x14CustomerServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
