...
func init() {
	proto.RegisterType((*GetAdGroupRequest)(nil), "google.ads.googleads.v9.services.GetAdGroupRequest")
	proto.RegisterType((*MutateAdGroupsRequest)(nil), "google.ads.googleads.v9.services.MutateAdGroupsRequest")
	proto.RegisterType((*AdGroupOperation)(nil), "google.ads.googleads.v9.services.AdGroupOperation")
	proto.RegisterType((*MutateAdGroupsResponse)(nil), "google.ads.googleads.v9.services.MutateAdGroupsResponse")
	proto.RegisterType((*MutateAdGroupResult)(nil), "google.ads.googleads.v9.services.MutateAdGroupResult")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/ad_group_service.proto", fileDescriptor_223b55be421cddd0)
}
