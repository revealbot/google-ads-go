...
type ShareablePreviewOrError struct {
	...
	//
	// Types that are assignable to GenerateShareablePreviewResponse:
	//
...
func (m *ShareablePreviewOrError) GetGenerateShareablePreviewResponse() isShareablePreviewOrError_GenerateShareablePreviewResponse {
	if m != nil {
		return m.GenerateShareablePreviewResponse
	}
	return nil
}

func (x *ShareablePreviewOrError) GetShareablePreviewResult() *ShareablePreviewResult {
	if x, ok := x.GetGenerateShareablePreviewResponse().(*ShareablePreviewOrError_ShareablePreviewResult); ok {
...
func (x *ShareablePreviewOrError) GetPartialFailureError() *status.Status {
	if x, ok := x.GetGenerateShareablePreviewResponse().(*ShareablePreviewOrError_PartialFailureError); ok {
...
var file_services_shareable_preview_service_proto_rawDesc = []byte{
	...
	0x82, 0xd3, 0xe4, 0x93, 0x02, 0x3d, 0x22, 0x38, 0x2f, 0x76, 0x31, 0x38, 0x2f, 0x63, 0x75, 0x73,
	0x74, 0x6f, 0x6d, 0x65, 0x72, 0x73, 0x2f, 0x7b, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	0x5f, 0x69, 0x64, 0x3d, 0x2a, 0x7d, 0x3a, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x61, 0x74, 0x65, 0x53,
	0x68, 0x61, 0x72, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x50, 0x72, 0x65, 0x76, 0x69, 0x65, 0x77, 0x73,
	0x3a, 0x01, 0x2a, 0xda, 0x41, 0x1e, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x5f, 0x69,
	0x64, 0x2c, 0x73, 0x68, 0x61, 0x72, 0x65, 0x61, 0x62, 0x6c, 0x65, 0x5f, 0x70, 0x72, 0x65, 0x76,
...
var (
	...
	file_services_shareable_preview_service_proto_rawDescData = file_services_shareable_preview_service_proto_rawDesc
)
...
func file_services_shareable_preview_service_proto_rawDescGZIP() []byte {
	file_services_shareable_preview_service_proto_rawDescOnce.Do(func() {
		file_services_shareable_preview_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_services_shareable_preview_service_proto_rawDescData)
	})
...
var file_services_shareable_preview_service_proto_goTypes = []interface{}{
	(*GenerateShareablePreviewsRequest)(nil),  // 0: google.ads.googleads.v18.services.GenerateShareablePreviewsRequest
	(*ShareablePreview)(nil),                  // 1: google.ads.googleads.v18.services.ShareablePreview
	(*AssetGroupIdentifier)(nil),              // 2: google.ads.googleads.v18.services.AssetGroupIdentifier
	(*GenerateShareablePreviewsResponse)(nil), // 3: google.ads.googleads.v18.services.GenerateShareablePreviewsResponse
	(*ShareablePreviewOrError)(nil),           // 4: google.ads.googleads.v18.services.ShareablePreviewOrError
	(*ShareablePreviewResult)(nil),            // 5: google.ads.googleads.v18.services.ShareablePreviewResult
	(*status.Status)(nil),                     // 6: google.rpc.Status
}
var file_services_shareable_preview_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v18.services.GenerateShareablePreviewsRequest.shareable_previews:type_name -> google.ads.googleads.v18.services.ShareablePreview
	2, // 1: google.ads.googleads.v18.services.ShareablePreview.asset_group_identifier:type_name -> google.ads.googleads.v18.services.AssetGroupIdentifier
	4, // 2: google.ads.googleads.v18.services.GenerateShareablePreviewsResponse.responses:type_name -> google.ads.googleads.v18.services.ShareablePreviewOrError
	2, // 3: google.ads.googleads.v18.services.ShareablePreviewOrError.asset_group_identifier:type_name -> google.ads.googleads.v18.services.AssetGroupIdentifier
	5, // 4: google.ads.googleads.v18.services.ShareablePreviewOrError.shareable_preview_result:type_name -> google.ads.googleads.v18.services.ShareablePreviewResult
	6, // 5: google.ads.googleads.v18.services.ShareablePreviewOrError.partial_failure_error:type_name -> google.rpc.Status
	0, // 6: google.ads.googleads.v18.services.ShareablePreviewService.GenerateShareablePreviews:input_type -> google.ads.googleads.v18.services.GenerateShareablePreviewsRequest
	3, // 7: google.ads.googleads.v18.services.ShareablePreviewService.GenerateShareablePreviews:output_type -> google.ads.googleads.v18.services.GenerateShareablePreviewsResponse
...
func file_services_shareable_preview_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_services_shareable_preview_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GenerateShareablePreviewsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_shareable_preview_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShareablePreview); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_shareable_preview_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AssetGroupIdentifier); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_shareable_preview_service_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GenerateShareablePreviewsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_shareable_preview_service_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShareablePreviewOrError); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_services_shareable_preview_service_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ShareablePreviewResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_services_shareable_preview_service_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_services_shareable_preview_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_services_shareable_preview_service_proto_rawDesc = nil
