...
const (
	GoalService_MutateGoals_FullMethodName = "/google.ads.googleads.v22.services.GoalService/MutateGoals"
)
...
func (c *goalServiceClient) MutateGoals(ctx context.Context, in *MutateGoalsRequest, opts ...grpc.CallOption) (*MutateGoalsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(MutateGoalsResponse)
	err := c.cc.Invoke(ctx, GoalService_MutateGoals_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedGoalServiceServer) MutateGoals(context.Context, *MutateGoalsRequest) (*MutateGoalsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method MutateGoals not implemented")
}
...
func _GoalService_MutateGoals_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MutateGoalsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoalServiceServer).MutateGoals(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GoalService_MutateGoals_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoalServiceServer).MutateGoals(ctx, req.(*MutateGoalsRequest))
	}
...
var GoalService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "MutateGoals",
			Handler:    _GoalService_MutateGoals_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "google/ads/googleads/v22/services/goal_service.proto",
}
