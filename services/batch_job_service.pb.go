...
const file_services_batch_job_service_proto_rawDesc = "" +
	"\n" +
	...
	"customerId\x12W\n" +
	"\toperation\x18\x02 \x01(\v24.google.ads.googleads.v19.services.BatchJobOperationB\x03\xe0A\x02R\toperation\"\xaa\x01\n" +
	"\x11BatchJobOperation\x12F\n" +
	"\x06create\x18\x01 \x01(\v2,.google.ads.googleads.v19.resources.BatchJobH\x00R\x06create\x12@\n" +
	"\x06remove\x18\x04 \x01(\tB&\xfaA#\n" +
	"!googleads.googleapis.com/BatchJobH\x00R\x06removeB\v\n" +
	"\toperation\"i\n" +
	"\x16MutateBatchJobResponse\x12O\n" +
	"\x06result\x18\x01 \x01(\v27.google.ads.googleads.v19.services.MutateBatchJobResultR\x06result\"c\n" +
	...
	"\x11mutate_operations\x18\x03 \x03(\v22.google.ads.googleads.v19.services.MutateOperationB\x03\xe0A\x02R\x10mutateOperations\"z\n" +
	...
	"\x15response_content_type\x18\x04 \x01(\x0e2K.google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\"\x92\x01\n" +
	"\x1bListBatchJobResultsResponse\x12K\n" +
	"\aresults\x18\x01 \x03(\v21.google.ads.googleads.v19.services.BatchJobResultR\aresults\x12&\n" +
	...
	"\x19mutate_operation_response\x18\x02 \x01(\v2:.google.ads.googleads.v19.services.MutateOperationResponseR\x17mutateOperationResponse\x12*\n" +
	"\x06status\x18\x03 \x01(\v2\x12.google.rpc.StatusR\x06status2\xe1\b\n" +
	"\x0fBatchJobService\x12\xd9\x01\n" +
	"\x0eMutateBatchJob\x128.google.ads.googleads.v19.services.MutateBatchJobRequest\x1a9.google.ads.googleads.v19.services.MutateBatchJobResponse\"R\xdaA\x15customer_id,operation\x82\xd3\xe4\x93\x024:\x01*\"//v19/customers/{customer_id=*}/batchJobs:mutate\x12\xe6\x01\n" +
	...
	"\vRunBatchJob\x125.google.ads.googleads.v19.services.RunBatchJobRequest\x1a\x1d.google.longrunning.Operation\"\xa3\x01\xcaAU\n" +
	"\x15google.protobuf.Empty\x12<google.ads.googleads.v19.resources.BatchJob.BatchJobMetadata\xdaA\rresource_name\x82\xd3\xe4\x93\x025:\x01*\"0/v19/{resource_name=customers/*/batchJobs/*}:run\x12\xb5\x02\n" +
	"\x15AddBatchJobOperations\x12?.google.ads.googleads.v19.services.AddBatchJobOperationsRequest\x1a@.google.ads.googleads.v19.services.AddBatchJobOperationsResponse\"\x98\x01\xdaA.resource_name,sequence_token,mutate_operations\xdaA\x1fresource_name,mutate_operations\x82\xd3\xe4\x93\x02?:\x01*\":/v19/{resource_name=customers/*/batchJobs/*}:addOperations\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x80\x02\n" +
	"%com.google.ads.googleads.v19.servicesB\x14BatchJobServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
