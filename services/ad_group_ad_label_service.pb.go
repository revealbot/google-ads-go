...
var file_services_ad_group_ad_label_service_proto_rawDesc = string([]byte{
...
var (
	...
	file_services_ad_group_ad_label_service_proto_rawDescData []byte
)
...
func file_services_ad_group_ad_label_service_proto_rawDescGZIP() []byte {
	file_services_ad_group_ad_label_service_proto_rawDescOnce.Do(func() {
		file_services_ad_group_ad_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_ad_group_ad_label_service_proto_rawDesc), len(file_services_ad_group_ad_label_service_proto_rawDesc)))
	})
...
var file_services_ad_group_ad_label_service_proto_goTypes = []any{
	(*MutateAdGroupAdLabelsRequest)(nil),  // 0: google.ads.googleads.v22.services.MutateAdGroupAdLabelsRequest
	(*AdGroupAdLabelOperation)(nil),       // 1: google.ads.googleads.v22.services.AdGroupAdLabelOperation
	(*MutateAdGroupAdLabelsResponse)(nil), // 2: google.ads.googleads.v22.services.MutateAdGroupAdLabelsResponse
	(*MutateAdGroupAdLabelResult)(nil),    // 3: google.ads.googleads.v22.services.MutateAdGroupAdLabelResult
	(*resources.AdGroupAdLabel)(nil),      // 4: google.ads.googleads.v22.resources.AdGroupAdLabel
	(*status.Status)(nil),                 // 5: google.rpc.Status
}
var file_services_ad_group_ad_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.services.MutateAdGroupAdLabelsRequest.operations:type_name -> google.ads.googleads.v22.services.AdGroupAdLabelOperation
	4, // 1: google.ads.googleads.v22.services.AdGroupAdLabelOperation.create:type_name -> google.ads.googleads.v22.resources.AdGroupAdLabel
	5, // 2: google.ads.googleads.v22.services.MutateAdGroupAdLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v22.services.MutateAdGroupAdLabelsResponse.results:type_name -> google.ads.googleads.v22.services.MutateAdGroupAdLabelResult
	0, // 4: google.ads.googleads.v22.services.AdGroupAdLabelService.MutateAdGroupAdLabels:input_type -> google.ads.googleads.v22.services.MutateAdGroupAdLabelsRequest
	2, // 5: google.ads.googleads.v22.services.AdGroupAdLabelService.MutateAdGroupAdLabels:output_type -> google.ads.googleads.v22.services.MutateAdGroupAdLabelsResponse
...
func file_services_ad_group_ad_label_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_services_ad_group_ad_label_service_proto_rawDesc), len(file_services_ad_group_ad_label_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
