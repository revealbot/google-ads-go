...
func init() {
	proto.RegisterType((*GetDisplayKeywordViewRequest)(nil), "google.ads.googleads.v9.services.GetDisplayKeywordViewRequest")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/display_keyword_view_service.proto", fileDescriptor_6b85310d2a54b119)
}
