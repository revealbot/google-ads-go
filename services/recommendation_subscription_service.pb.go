...
// Request message for
// [RecommendationSubscriptionService.MutateRecommendationSubscription][google.ads.googleads.v25.services.RecommendationSubscriptionService.MutateRecommendationSubscription]
...
func (x *MutateRecommendationSubscriptionRequest) Reset() {
	*x = MutateRecommendationSubscriptionRequest{}
	mi := &file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_msgTypes[0]
...
func (*MutateRecommendationSubscriptionRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *RecommendationSubscriptionOperation) Reset() {
	*x = RecommendationSubscriptionOperation{}
	mi := &file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RecommendationSubscriptionOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateRecommendationSubscriptionResponse) Reset() {
	*x = MutateRecommendationSubscriptionResponse{}
	mi := &file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateRecommendationSubscriptionResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateRecommendationSubscriptionResult) Reset() {
	*x = MutateRecommendationSubscriptionResult{}
	mi := &file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateRecommendationSubscriptionResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v25_services_recommendation_subscription_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDesc = string([]byte{
	...
	0x93, 0x02, 0x60, 0x3a, 0x01, 0x2a, 0x22, 0x5b, 0x2f, 0x76, 0x32, 0x35, 0x2f, 0x63, 0x75, 0x73,
...
var (
	file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDescData
}

var file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_goTypes = []any{
	(*MutateRecommendationSubscriptionRequest)(nil),        // 0: google.ads.googleads.v25.services.MutateRecommendationSubscriptionRequest
	(*RecommendationSubscriptionOperation)(nil),            // 1: google.ads.googleads.v25.services.RecommendationSubscriptionOperation
	(*MutateRecommendationSubscriptionResponse)(nil),       // 2: google.ads.googleads.v25.services.MutateRecommendationSubscriptionResponse
	(*MutateRecommendationSubscriptionResult)(nil),         // 3: google.ads.googleads.v25.services.MutateRecommendationSubscriptionResult
	...
	(*resources.RecommendationSubscription)(nil),           // 6: google.ads.googleads.v25.resources.RecommendationSubscription
	(*status.Status)(nil),                                  // 7: google.rpc.Status
}
var file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.services.MutateRecommendationSubscriptionRequest.operations:type_name -> google.ads.googleads.v25.services.RecommendationSubscriptionOperation
	4, // 1: google.ads.googleads.v25.services.MutateRecommendationSubscriptionRequest.response_content_type:type_name -> google.ads.googleads.v25.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v25.services.RecommendationSubscriptionOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v25.services.RecommendationSubscriptionOperation.create:type_name -> google.ads.googleads.v25.resources.RecommendationSubscription
	6, // 4: google.ads.googleads.v25.services.RecommendationSubscriptionOperation.update:type_name -> google.ads.googleads.v25.resources.RecommendationSubscription
	3, // 5: google.ads.googleads.v25.services.MutateRecommendationSubscriptionResponse.results:type_name -> google.ads.googleads.v25.services.MutateRecommendationSubscriptionResult
	7, // 6: google.ads.googleads.v25.services.MutateRecommendationSubscriptionResponse.partial_failure_error:type_name -> google.rpc.Status
	6, // 7: google.ads.googleads.v25.services.MutateRecommendationSubscriptionResult.recommendation_subscription:type_name -> google.ads.googleads.v25.resources.RecommendationSubscription
	0, // 8: google.ads.googleads.v25.services.RecommendationSubscriptionService.MutateRecommendationSubscription:input_type -> google.ads.googleads.v25.services.MutateRecommendationSubscriptionRequest
	2, // 9: google.ads.googleads.v25.services.RecommendationSubscriptionService.MutateRecommendationSubscription:output_type -> google.ads.googleads.v25.services.MutateRecommendationSubscriptionResponse
...
func init() { file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_init() }
func file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_init() {
	if File_google_ads_googleads_v25_services_recommendation_subscription_service_proto != nil {
		return
	}
	file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v25_services_recommendation_subscription_service_proto = out.File
	file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_goTypes = nil
	file_google_ads_googleads_v25_services_recommendation_subscription_service_proto_depIdxs = nil
}
