...
const (
	AudienceInsightsService_GenerateInsightsFinderReport_FullMethodName        = "/google.ads.googleads.v25.services.AudienceInsightsService/GenerateInsightsFinderReport"
	AudienceInsightsService_ListAudienceInsightsAttributes_FullMethodName      = "/google.ads.googleads.v25.services.AudienceInsightsService/ListAudienceInsightsAttributes"
	AudienceInsightsService_ListInsightsEligibleDates_FullMethodName           = "/google.ads.googleads.v25.services.AudienceInsightsService/ListInsightsEligibleDates"
	AudienceInsightsService_GenerateAudienceCompositionInsights_FullMethodName = "/google.ads.googleads.v25.services.AudienceInsightsService/GenerateAudienceCompositionInsights"
	AudienceInsightsService_GenerateAudienceDefinition_FullMethodName          = "/google.ads.googleads.v25.services.AudienceInsightsService/GenerateAudienceDefinition"
	AudienceInsightsService_GenerateSuggestedTargetingInsights_FullMethodName  = "/google.ads.googleads.v25.services.AudienceInsightsService/GenerateSuggestedTargetingInsights"
	AudienceInsightsService_GenerateAudienceOverlapInsights_FullMethodName     = "/google.ads.googleads.v25.services.AudienceInsightsService/GenerateAudienceOverlapInsights"
	AudienceInsightsService_GenerateTargetingSuggestionMetrics_FullMethodName  = "/google.ads.googleads.v25.services.AudienceInsightsService/GenerateTargetingSuggestionMetrics"
)
...
type AudienceInsightsServiceClient interface {
	...
	//	[QuotaError]()
	//	[RequestError]()
	GenerateAudienceDefinition(ctx context.Context, in *GenerateAudienceDefinitionRequest, opts ...grpc.CallOption) (*GenerateAudienceDefinitionResponse, error)
...
func (c *audienceInsightsServiceClient) GenerateAudienceDefinition(ctx context.Context, in *GenerateAudienceDefinitionRequest, opts ...grpc.CallOption) (*GenerateAudienceDefinitionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateAudienceDefinitionResponse)
	err := c.cc.Invoke(ctx, AudienceInsightsService_GenerateAudienceDefinition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AudienceInsightsServiceServer interface {
	...
	//	[QuotaError]()
	//	[RequestError]()
	GenerateAudienceDefinition(context.Context, *GenerateAudienceDefinitionRequest) (*GenerateAudienceDefinitionResponse, error)
	// Returns a collection of targeting insights (e.g. targetable audiences) that
	// are relevant to the requested audience.
	//
	// List of thrown errors:
...
func (UnimplementedAudienceInsightsServiceServer) GenerateAudienceDefinition(context.Context, *GenerateAudienceDefinitionRequest) (*GenerateAudienceDefinitionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GenerateAudienceDefinition not implemented")
}
...
func _AudienceInsightsService_GenerateAudienceDefinition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateAudienceDefinitionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AudienceInsightsServiceServer).GenerateAudienceDefinition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AudienceInsightsService_GenerateAudienceDefinition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AudienceInsightsServiceServer).GenerateAudienceDefinition(ctx, req.(*GenerateAudienceDefinitionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AudienceInsightsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v25.services.AudienceInsightsService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GenerateAudienceDefinition",
			Handler:    _AudienceInsightsService_GenerateAudienceDefinition_Handler,
		},
		{
	...
	Metadata: "google/ads/googleads/v25/services/audience_insights_service.proto",
}
