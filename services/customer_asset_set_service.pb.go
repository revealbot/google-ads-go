...
const file_services_customer_asset_set_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x1eMutateCustomerAssetSetsRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12a\n" +
	"\n" +
	"operations\x18\x02 \x03(\v2<.google.ads.googleads.v19.services.CustomerAssetSetOperationB\x03\xe0A\x02R\n" +
	"operations\x12'\n" +
	"\x0fpartial_failure\x18\x03 \x01(\bR\x0epartialFailure\x12#\n" +
	"\rvalidate_only\x18\x04 \x01(\bR\fvalidateOnly\x12\x7f\n" +
	"\x15response_content_type\x18\x05 \x01(\x0e2K.google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\"\xc2\x01\n" +
	"\x19CustomerAssetSetOperation\x12N\n" +
	"\x06create\x18\x01 \x01(\v24.google.ads.googleads.v19.resources.CustomerAssetSetH\x00R\x06create\x12H\n" +
	"\x06remove\x18\x02 \x01(\tB.\xfaA+\n" +
	")googleads.googleapis.com/CustomerAssetSetH\x00R\x06removeB\v\n" +
	"\toperation\"\xc4\x01\n" +
	"\x1fMutateCustomerAssetSetsResponse\x12Y\n" +
	"\aresults\x18\x01 \x03(\v2?.google.ads.googleads.v19.services.MutateCustomerAssetSetResultR\aresults\x12F\n" +
	"\x15partial_failure_error\x18\x02 \x01(\v2\x12.google.rpc.StatusR\x13partialFailureError\"\xd7\x01\n" +
	"\x1cMutateCustomerAssetSetResult\x12S\n" +
	"\rresource_name\x18\x01 \x01(\tB.\xfaA+\n" +
	")googleads.googleapis.com/CustomerAssetSetR\fresourceName\x12b\n" +
	"\x12customer_asset_set\x18\x02 \x01(\v24.google.ads.googleads.v19.resources.CustomerAssetSetR\x10customerAssetSet2\xe0\x02\n" +
	"\x17CustomerAssetSetService\x12\xfd\x01\n" +
	"\x17MutateCustomerAssetSets\x12A.google.ads.googleads.v19.services.MutateCustomerAssetSetsRequest\x1aB.google.ads.googleads.v19.services.MutateCustomerAssetSetsResponse\"[\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02<:\x01*\"7/v19/customers/{customer_id=*}/customerAssetSets:mutate\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x88\x02\n" +
	"%com.google.ads.googleads.v19.servicesB\x1cCustomerAssetSetServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
