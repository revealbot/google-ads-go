...
// Request message for
// [CustomerAssetSetService.MutateCustomerAssetSets][google.ads.googleads.v25.services.CustomerAssetSetService.MutateCustomerAssetSets].
...
func (x *MutateCustomerAssetSetsRequest) Reset() {
	*x = MutateCustomerAssetSetsRequest{}
	mi := &file_google_ads_googleads_v25_services_customer_asset_set_service_proto_msgTypes[0]
...
func (*MutateCustomerAssetSetsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomerAssetSetOperation) Reset() {
	*x = CustomerAssetSetOperation{}
	mi := &file_google_ads_googleads_v25_services_customer_asset_set_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomerAssetSetOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomerAssetSetsResponse) Reset() {
	*x = MutateCustomerAssetSetsResponse{}
	mi := &file_google_ads_googleads_v25_services_customer_asset_set_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetSetsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomerAssetSetResult) Reset() {
	*x = MutateCustomerAssetSetResult{}
	mi := &file_google_ads_googleads_v25_services_customer_asset_set_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomerAssetSetResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v25_services_customer_asset_set_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDesc = string([]byte{
...
var (
	file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDescData
}

var file_google_ads_googleads_v25_services_customer_asset_set_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v25_services_customer_asset_set_service_proto_goTypes = []any{
	(*MutateCustomerAssetSetsRequest)(nil),                 // 0: google.ads.googleads.v25.services.MutateCustomerAssetSetsRequest
	(*CustomerAssetSetOperation)(nil),                      // 1: google.ads.googleads.v25.services.CustomerAssetSetOperation
	(*MutateCustomerAssetSetsResponse)(nil),                // 2: google.ads.googleads.v25.services.MutateCustomerAssetSetsResponse
	(*MutateCustomerAssetSetResult)(nil),                   // 3: google.ads.googleads.v25.services.MutateCustomerAssetSetResult
	...
	(*resources.CustomerAssetSet)(nil),                     // 5: google.ads.googleads.v25.resources.CustomerAssetSet
	(*status.Status)(nil),                                  // 6: google.rpc.Status
}
var file_google_ads_googleads_v25_services_customer_asset_set_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.services.MutateCustomerAssetSetsRequest.operations:type_name -> google.ads.googleads.v25.services.CustomerAssetSetOperation
	4, // 1: google.ads.googleads.v25.services.MutateCustomerAssetSetsRequest.response_content_type:type_name -> google.ads.googleads.v25.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v25.services.CustomerAssetSetOperation.create:type_name -> google.ads.googleads.v25.resources.CustomerAssetSet
	3, // 3: google.ads.googleads.v25.services.MutateCustomerAssetSetsResponse.results:type_name -> google.ads.googleads.v25.services.MutateCustomerAssetSetResult
	6, // 4: google.ads.googleads.v25.services.MutateCustomerAssetSetsResponse.partial_failure_error:type_name -> google.rpc.Status
	5, // 5: google.ads.googleads.v25.services.MutateCustomerAssetSetResult.customer_asset_set:type_name -> google.ads.googleads.v25.resources.CustomerAssetSet
	0, // 6: google.ads.googleads.v25.services.CustomerAssetSetService.MutateCustomerAssetSets:input_type -> google.ads.googleads.v25.services.MutateCustomerAssetSetsRequest
	2, // 7: google.ads.googleads.v25.services.CustomerAssetSetService.MutateCustomerAssetSets:output_type -> google.ads.googleads.v25.services.MutateCustomerAssetSetsResponse
...
func init() { file_google_ads_googleads_v25_services_customer_asset_set_service_proto_init() }
func file_google_ads_googleads_v25_services_customer_asset_set_service_proto_init() {
	if File_google_ads_googleads_v25_services_customer_asset_set_service_proto != nil {
		return
	}
	file_google_ads_googleads_v25_services_customer_asset_set_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_customer_asset_set_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v25_services_customer_asset_set_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v25_services_customer_asset_set_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v25_services_customer_asset_set_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v25_services_customer_asset_set_service_proto = out.File
	file_google_ads_googleads_v25_services_customer_asset_set_service_proto_goTypes = nil
	file_google_ads_googleads_v25_services_customer_asset_set_service_proto_depIdxs = nil
}
