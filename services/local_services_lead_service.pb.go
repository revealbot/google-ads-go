...
type SurveySatisfied struct {
	...
	SurveySatisfiedReason enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason `protobuf:"varint,1,opt,name=survey_satisfied_reason,json=surveySatisfiedReason,proto3,enum=google.ads.googleads.v23.enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason" json:"survey_satisfied_reason,omitempty"`
...
type SurveyDissatisfied struct {
	...
	SurveyDissatisfiedReason enums.LocalServicesLeadSurveyDissatisfiedReasonEnum_SurveyDissatisfiedReason `protobuf:"varint,1,opt,name=survey_dissatisfied_reason,json=surveyDissatisfiedReason,proto3,enum=google.ads.googleads.v23.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum_SurveyDissatisfiedReason" json:"survey_dissatisfied_reason,omitempty"`
	// Optional. Provider's free form comments. This field is required when
...
type ProvideLeadFeedbackRequest struct {
	...
	SurveyAnswer enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer `protobuf:"varint,2,opt,name=survey_answer,json=surveyAnswer,proto3,enum=google.ads.googleads.v23.enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer" json:"survey_answer,omitempty"`
...
type ProvideLeadFeedbackResponse struct {
	...
	CreditIssuanceDecision enums.LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision `protobuf:"varint,1,opt,name=credit_issuance_decision,json=creditIssuanceDecision,proto3,enum=google.ads.googleads.v23.enums.LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision" json:"credit_issuance_decision,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
var file_services_local_services_lead_service_proto_rawDesc = string([]byte{
	...
	0x32, 0x33, 0x2f, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2f, 0x6c, 0x6f, 0x63, 0x61, 0x6c, 0x5f, 0x73,
	...
	0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32, 0x33, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x4c,
	...
	0x76, 0x32, 0x33, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x75, 0x72,
	...
	0x32, 0x33, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x70, 0x70, 0x65,
	...
	0x3a, 0x01, 0x2a, 0x22, 0x43, 0x2f, 0x76, 0x32, 0x33, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d,
	...
	0x54, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x4e, 0x3a, 0x01, 0x2a, 0x22, 0x49, 0x2f, 0x76, 0x32, 0x33,
...
var file_services_local_services_lead_service_proto_goTypes = []any{
	(*AppendLeadConversationRequest)(nil),  // 0: google.ads.googleads.v23.services.AppendLeadConversationRequest
	(*AppendLeadConversationResponse)(nil), // 1: google.ads.googleads.v23.services.AppendLeadConversationResponse
	(*Conversation)(nil),                   // 2: google.ads.googleads.v23.services.Conversation
	(*ConversationOrError)(nil),            // 3: google.ads.googleads.v23.services.ConversationOrError
	(*SurveySatisfied)(nil),                // 4: google.ads.googleads.v23.services.SurveySatisfied
	(*SurveyDissatisfied)(nil),             // 5: google.ads.googleads.v23.services.SurveyDissatisfied
	(*ProvideLeadFeedbackRequest)(nil),     // 6: google.ads.googleads.v23.services.ProvideLeadFeedbackRequest
	(*ProvideLeadFeedbackResponse)(nil),    // 7: google.ads.googleads.v23.services.ProvideLeadFeedbackResponse
	(*status.Status)(nil),                  // 8: google.rpc.Status
	(enums.LocalServicesLeadSurveySatisfiedReasonEnum_SurveySatisfiedReason)(0),       // 9: google.ads.googleads.v23.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason
	(enums.LocalServicesLeadSurveyDissatisfiedReasonEnum_SurveyDissatisfiedReason)(0), // 10: google.ads.googleads.v23.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason
	(enums.LocalServicesLeadSurveyAnswerEnum_SurveyAnswer)(0),                         // 11: google.ads.googleads.v23.enums.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer
	(enums.LocalServicesLeadCreditIssuanceDecisionEnum_CreditIssuanceDecision)(0),     // 12: google.ads.googleads.v23.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
}
var file_services_local_services_lead_service_proto_depIdxs = []int32{
	2,  // 0: google.ads.googleads.v23.services.AppendLeadConversationRequest.conversations:type_name -> google.ads.googleads.v23.services.Conversation
	3,  // 1: google.ads.googleads.v23.services.AppendLeadConversationResponse.responses:type_name -> google.ads.googleads.v23.services.ConversationOrError
	8,  // 2: google.ads.googleads.v23.services.ConversationOrError.partial_failure_error:type_name -> google.rpc.Status
	9,  // 3: google.ads.googleads.v23.services.SurveySatisfied.survey_satisfied_reason:type_name -> google.ads.googleads.v23.enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason
	10, // 4: google.ads.googleads.v23.services.SurveyDissatisfied.survey_dissatisfied_reason:type_name -> google.ads.googleads.v23.enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason
	11, // 5: google.ads.googleads.v23.services.ProvideLeadFeedbackRequest.survey_answer:type_name -> google.ads.googleads.v23.enums.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer
	4,  // 6: google.ads.googleads.v23.services.ProvideLeadFeedbackRequest.survey_satisfied:type_name -> google.ads.googleads.v23.services.SurveySatisfied
	5,  // 7: google.ads.googleads.v23.services.ProvideLeadFeedbackRequest.survey_dissatisfied:type_name -> google.ads.googleads.v23.services.SurveyDissatisfied
	12, // 8: google.ads.googleads.v23.services.ProvideLeadFeedbackResponse.credit_issuance_decision:type_name -> google.ads.googleads.v23.enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
	0,  // 9: google.ads.googleads.v23.services.LocalServicesLeadService.AppendLeadConversation:input_type -> google.ads.googleads.v23.services.AppendLeadConversationRequest
	6,  // 10: google.ads.googleads.v23.services.LocalServicesLeadService.ProvideLeadFeedback:input_type -> google.ads.googleads.v23.services.ProvideLeadFeedbackRequest
	1,  // 11: google.ads.googleads.v23.services.LocalServicesLeadService.AppendLeadConversation:output_type -> google.ads.googleads.v23.services.AppendLeadConversationResponse
	7,  // 12: google.ads.googleads.v23.services.LocalServicesLeadService.ProvideLeadFeedback:output_type -> google.ads.googleads.v23.services.ProvideLeadFeedbackResponse
