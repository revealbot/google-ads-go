...
func init() {
	proto.RegisterType((*GetTopicConstantRequest)(nil), "google.ads.googleads.v9.services.GetTopicConstantRequest")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/topic_constant_service.proto", fileDescriptor_42e298e525493510)
}
