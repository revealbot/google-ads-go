...
const file_services_keyword_plan_idea_service_proto_rawDesc = "" +
	"\n" +
	...
	"\x14keyword_plan_network\x18\t \x01(\x0e2I.google.ads.googleads.v19.enums.KeywordPlanNetworkEnum.KeywordPlanNetworkR\x12keywordPlanNetwork\x12\x8c\x01\n" +
	"\x12keyword_annotation\x18\x11 \x03(\x0e2].google.ads.googleads.v19.enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotationR\x11keywordAnnotation\x12i\n" +
	"\x11aggregate_metrics\x18\x10 \x01(\v2<.google.ads.googleads.v19.common.KeywordPlanAggregateMetricsR\x10aggregateMetrics\x12w\n" +
	"\x1ahistorical_metrics_options\x18\x12 \x01(\v29.google.ads.googleads.v19.common.HistoricalMetricsOptionsR\x18historicalMetricsOptions\x12g\n" +
	"\x14keyword_and_url_seed\x18\x02 \x01(\v24.google.ads.googleads.v19.services.KeywordAndUrlSeedH\x00R\x11keywordAndUrlSeed\x12S\n" +
	"\fkeyword_seed\x18\x03 \x01(\v2..google.ads.googleads.v19.services.KeywordSeedH\x00R\vkeywordSeed\x12G\n" +
	"\burl_seed\x18\x05 \x01(\v2*.google.ads.googleads.v19.services.UrlSeedH\x00R\aurlSeed\x12J\n" +
	"\tsite_seed\x18\v \x01(\v2+.google.ads.googleads.v19.services.SiteSeedH\x00R\bsiteSeedB\x06\n" +
	"\x04seedB\v\n" +
	"\t_language\"N\n" +
	...
	"\aresults\x18\x01 \x03(\v2<.google.ads.googleads.v19.services.GenerateKeywordIdeaResultR\aresults\x12|\n" +
	"\x18aggregate_metric_results\x18\x04 \x01(\v2B.google.ads.googleads.v19.common.KeywordPlanAggregateMetricResultsR\x16aggregateMetricResults\x12&\n" +
	...
	"\x14keyword_idea_metrics\x18\x03 \x01(\v2=.google.ads.googleads.v19.common.KeywordPlanHistoricalMetricsR\x12keywordIdeaMetrics\x12d\n" +
	"\x13keyword_annotations\x18\x06 \x01(\v23.google.ads.googleads.v19.common.KeywordAnnotationsR\x12keywordAnnotations\x12%\n" +
	...
	"\x14keyword_plan_network\x18\a \x01(\x0e2I.google.ads.googleads.v19.enums.KeywordPlanNetworkEnum.KeywordPlanNetworkR\x12keywordPlanNetwork\x12i\n" +
	"\x11aggregate_metrics\x18\b \x01(\v2<.google.ads.googleads.v19.common.KeywordPlanAggregateMetricsR\x10aggregateMetrics\x12w\n" +
	"\x1ahistorical_metrics_options\x18\x03 \x01(\v29.google.ads.googleads.v19.common.HistoricalMetricsOptionsR\x18historicalMetricsOptionsB\v\n" +
	"\t_language\"\x8d\x02\n" +
	"(GenerateKeywordHistoricalMetricsResponse\x12c\n" +
	"\aresults\x18\x01 \x03(\v2I.google.ads.googleads.v19.services.GenerateKeywordHistoricalMetricsResultR\aresults\x12|\n" +
	"\x18aggregate_metric_results\x18\x02 \x01(\v2B.google.ads.googleads.v19.common.KeywordPlanAggregateMetricResultsR\x16aggregateMetricResults\"\xd9\x01\n" +
	...
	"\x0fkeyword_metrics\x18\x02 \x01(\v2=.google.ads.googleads.v19.common.KeywordPlanHistoricalMetricsR\x0ekeywordMetricsB\a\n" +
	"\x05_text\"\x87\x01\n" +
	...
	"\x1cad_group_keyword_suggestions\x18\x01 \x03(\v2;.google.ads.googleads.v19.services.AdGroupKeywordSuggestionR\x19adGroupKeywordSuggestions\x12`\n" +
	"\x12unusable_ad_groups\x18\x02 \x03(\v22.google.ads.googleads.v19.services.UnusableAdGroupR\x10unusableAdGroups\"\xc9\x02\n" +
	...
	"\x14suggested_match_type\x18\x03 \x01(\x0e2E.google.ads.googleads.v19.enums.KeywordMatchTypeEnum.KeywordMatchTypeR\x12suggestedMatchType\x12,\n" +
	...
	"\x0fforecast_period\x18\x03 \x01(\v2*.google.ads.googleads.v19.common.DateRangeR\x0eforecastPeriod\x12V\n" +
	"\bcampaign\x18\x04 \x01(\v25.google.ads.googleads.v19.services.CampaignToForecastB\x03\xe0A\x02R\bcampaignB\x10\n" +
	"\x0e_currency_code\"\xea\b\n" +
	"\x12CampaignToForecast\x12-\n" +
	"\x12language_constants\x18\x01 \x03(\tR\x11languageConstants\x12\\\n" +
	"\rgeo_modifiers\x18\x02 \x03(\v27.google.ads.googleads.v19.services.CriterionBidModifierR\fgeoModifiers\x12\x80\x01\n" +
	"\x14keyword_plan_network\x18\x03 \x01(\x0e2I.google.ads.googleads.v19.enums.KeywordPlanNetworkEnum.KeywordPlanNetworkB\x03\xe0A\x02R\x12keywordPlanNetwork\x12Y\n" +
	"\x11negative_keywords\x18\x04 \x03(\v2,.google.ads.googleads.v19.common.KeywordInfoR\x10negativeKeywords\x12}\n" +
	"\x10bidding_strategy\x18\x05 \x01(\v2M.google.ads.googleads.v19.services.CampaignToForecast.CampaignBiddingStrategyB\x03\xe0A\x02R\x0fbiddingStrategy\x12,\n" +
	"\x0fconversion_rate\x18\x06 \x01(\x01H\x00R\x0econversionRate\x88\x01\x01\x12O\n" +
	"\tad_groups\x18\a \x03(\v22.google.ads.googleads.v19.services.ForecastAdGroupR\badGroups\x1a\xd6\x03\n" +
	"\x17CampaignBiddingStrategy\x12|\n" +
	"\x1bmanual_cpc_bidding_strategy\x18\x01 \x01(\v2;.google.ads.googleads.v19.services.ManualCpcBiddingStrategyH\x00R\x18manualCpcBiddingStrategy\x12\x8b\x01\n" +
	" maximize_clicks_bidding_strategy\x18\x02 \x01(\v2@.google.ads.googleads.v19.services.MaximizeClicksBiddingStrategyH\x00R\x1dmaximizeClicksBiddingStrategy\x12\x9a\x01\n" +
	"%maximize_conversions_bidding_strategy\x18\x03 \x01(\v2E.google.ads.googleads.v19.services.MaximizeConversionsBiddingStrategyH\x00R\"maximizeConversionsBiddingStrategyB\x12\n" +
	...
	"\x11biddable_keywords\x18\x02 \x03(\v22.google.ads.googleads.v19.services.BiddableKeywordB\x03\xe0A\x02R\x10biddableKeywords\x12Y\n" +
	"\x11negative_keywords\x18\x03 \x03(\v2,.google.ads.googleads.v19.common.KeywordInfoR\x10negativeKeywordsB\x15\n" +
	"\x13_max_cpc_bid_micros\"\xa7\x01\n" +
	"\x0fBiddableKeyword\x12K\n" +
	"\akeyword\x18\x01 \x01(\v2,.google.ads.googleads.v19.common.KeywordInfoB\x03\xe0A\x02R\akeyword\x120\n" +
	...
	"\x19campaign_forecast_metrics\x18\x01 \x01(\v29.google.ads.googleads.v19.services.KeywordForecastMetricsH\x00R\x17campaignForecastMetrics\x88\x01\x01B\x1c\n" +
	...
	"\x14GenerateKeywordIdeas\x12>.google.ads.googleads.v19.services.GenerateKeywordIdeasRequest\x1a>.google.ads.googleads.v19.services.GenerateKeywordIdeaResponse\">\x82\xd3\xe4\x93\x028:\x01*\"3/v19/customers/{customer_id=*}:generateKeywordIdeas\x12\x87\x02\n" +
	" GenerateKeywordHistoricalMetrics\x12J.google.ads.googleads.v19.services.GenerateKeywordHistoricalMetricsRequest\x1aK.google.ads.googleads.v19.services.GenerateKeywordHistoricalMetricsResponse\"J\x82\xd3\xe4\x93\x02D:\x01*\"?/v19/customers/{customer_id=*}:generateKeywordHistoricalMetrics\x12\xfc\x01\n" +
	"\x15GenerateAdGroupThemes\x12?.google.ads.googleads.v19.services.GenerateAdGroupThemesRequest\x1a@.google.ads.googleads.v19.services.GenerateAdGroupThemesResponse\"`\xdaA\x1ecustomer_id,keywords,ad_groups\x82\xd3\xe4\x93\x029:\x01*\"4/v19/customers/{customer_id=*}:generateAdGroupThemes\x12\x8a\x02\n" +
	"\x1eGenerateKeywordForecastMetrics\x12H.google.ads.googleads.v19.services.GenerateKeywordForecastMetricsRequest\x1aI.google.ads.googleads.v19.services.GenerateKeywordForecastMetricsResponse\"S\xdaA\bcampaign\x82\xd3\xe4\x93\x02B:\x01*\"=/v19/customers/{customer_id=*}:generateKeywordForecastMetrics\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x87\x02\n" +
	"%com.google.ads.googleads.v19.servicesB\x1bKeywordPlanIdeaServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
