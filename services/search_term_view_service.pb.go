...
func init() {
	proto.RegisterType((*GetSearchTermViewRequest)(nil), "google.ads.googleads.v9.services.GetSearchTermViewRequest")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/search_term_view_service.proto", fileDescriptor_b2606b8baa50c1e2)
}
