...
// Request message for
// [CustomConversionGoalService.MutateCustomConversionGoals][google.ads.googleads.v25.services.CustomConversionGoalService.MutateCustomConversionGoals].
...
func (x *MutateCustomConversionGoalsRequest) Reset() {
	*x = MutateCustomConversionGoalsRequest{}
	mi := &file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_msgTypes[0]
...
func (*MutateCustomConversionGoalsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomConversionGoalOperation) Reset() {
	*x = CustomConversionGoalOperation{}
	mi := &file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomConversionGoalOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomConversionGoalsResponse) Reset() {
	*x = MutateCustomConversionGoalsResponse{}
	mi := &file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomConversionGoalsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomConversionGoalResult) Reset() {
	*x = MutateCustomConversionGoalResult{}
	mi := &file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomConversionGoalResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v25_services_custom_conversion_goal_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDesc = string([]byte{
	...
	0x2a, 0x22, 0x3b, 0x2f, 0x76, 0x32, 0x35, 0x2f, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72,
	...
	0x64, 0x73, 0x2e, 0x76, 0x32, 0x35, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42,
...
var (
	file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDescData
}

var file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_goTypes = []any{
	(*MutateCustomConversionGoalsRequest)(nil),             // 0: google.ads.googleads.v25.services.MutateCustomConversionGoalsRequest
	(*CustomConversionGoalOperation)(nil),                  // 1: google.ads.googleads.v25.services.CustomConversionGoalOperation
	(*MutateCustomConversionGoalsResponse)(nil),            // 2: google.ads.googleads.v25.services.MutateCustomConversionGoalsResponse
	(*MutateCustomConversionGoalResult)(nil),               // 3: google.ads.googleads.v25.services.MutateCustomConversionGoalResult
	...
	(*resources.CustomConversionGoal)(nil),                 // 6: google.ads.googleads.v25.resources.CustomConversionGoal
}
var file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.services.MutateCustomConversionGoalsRequest.operations:type_name -> google.ads.googleads.v25.services.CustomConversionGoalOperation
	4, // 1: google.ads.googleads.v25.services.MutateCustomConversionGoalsRequest.response_content_type:type_name -> google.ads.googleads.v25.enums.ResponseContentTypeEnum.ResponseContentType
	5, // 2: google.ads.googleads.v25.services.CustomConversionGoalOperation.update_mask:type_name -> google.protobuf.FieldMask
	6, // 3: google.ads.googleads.v25.services.CustomConversionGoalOperation.create:type_name -> google.ads.googleads.v25.resources.CustomConversionGoal
	6, // 4: google.ads.googleads.v25.services.CustomConversionGoalOperation.update:type_name -> google.ads.googleads.v25.resources.CustomConversionGoal
	3, // 5: google.ads.googleads.v25.services.MutateCustomConversionGoalsResponse.results:type_name -> google.ads.googleads.v25.services.MutateCustomConversionGoalResult
	6, // 6: google.ads.googleads.v25.services.MutateCustomConversionGoalResult.custom_conversion_goal:type_name -> google.ads.googleads.v25.resources.CustomConversionGoal
	0, // 7: google.ads.googleads.v25.services.CustomConversionGoalService.MutateCustomConversionGoals:input_type -> google.ads.googleads.v25.services.MutateCustomConversionGoalsRequest
	2, // 8: google.ads.googleads.v25.services.CustomConversionGoalService.MutateCustomConversionGoals:output_type -> google.ads.googleads.v25.services.MutateCustomConversionGoalsResponse
...
func init() { file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_init() }
func file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_init() {
	if File_google_ads_googleads_v25_services_custom_conversion_goal_service_proto != nil {
		return
	}
	file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v25_services_custom_conversion_goal_service_proto = out.File
	file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_goTypes = nil
	file_google_ads_googleads_v25_services_custom_conversion_goal_service_proto_depIdxs = nil
}
