...
func (c *dataLinkServiceClient) CreateDataLink(ctx context.Context, in *CreateDataLinkRequest, opts ...grpc.CallOption) (*CreateDataLinkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v18.services.DataLinkService/CreateDataLink", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDataLinkServiceServer must be embedded to have forward compatible implementations.
...
func _DataLinkService_CreateDataLink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v18.services.DataLinkService/CreateDataLink",
	}
