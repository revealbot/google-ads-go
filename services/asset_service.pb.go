...
const file_services_asset_service_proto_rawDesc = "" +
	"\n" +
	...
	"customerId\x12V\n" +
	"\n" +
	"operations\x18\x02 \x03(\v21.google.ads.googleads.v19.services.AssetOperationB\x03\xe0A\x02R\n" +
	"operations\x12'\n" +
	"\x0fpartial_failure\x18\x05 \x01(\bR\x0epartialFailure\x12\x7f\n" +
	"\x15response_content_type\x18\x03 \x01(\x0e2K.google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\x12#\n" +
	"\rvalidate_only\x18\x04 \x01(\bR\fvalidateOnly\"\xe4\x01\n" +
	"\x0eAssetOperation\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12C\n" +
	"\x06create\x18\x01 \x01(\v2).google.ads.googleads.v19.resources.AssetH\x00R\x06create\x12C\n" +
	"\x06update\x18\x02 \x01(\v2).google.ads.googleads.v19.resources.AssetH\x00R\x06updateB\v\n" +
	"\toperation\"\xae\x01\n" +
	"\x14MutateAssetsResponse\x12F\n" +
	"\x15partial_failure_error\x18\x03 \x01(\v2\x12.google.rpc.StatusR\x13partialFailureError\x12N\n" +
	"\aresults\x18\x02 \x03(\v24.google.ads.googleads.v19.services.MutateAssetResultR\aresults\"\x9e\x01\n" +
	"\x11MutateAssetResult\x12H\n" +
	"\rresource_name\x18\x01 \x01(\tB#\xfaA \n" +
	"\x1egoogleads.googleapis.com/AssetR\fresourceName\x12?\n" +
	"\x05asset\x18\x02 \x01(\v2).google.ads.googleads.v19.resources.AssetR\x05asset2\xa9\x02\n" +
	"\fAssetService\x12\xd1\x01\n" +
	"\fMutateAssets\x126.google.ads.googleads.v19.services.MutateAssetsRequest\x1a7.google.ads.googleads.v19.services.MutateAssetsResponse\"P\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x021:\x01*\",/v19/customers/{customer_id=*}/assets:mutate\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\xfd\x01\n" +
	"%com.google.ads.googleads.v19.servicesB\x11AssetServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
