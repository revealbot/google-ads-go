...
const file_services_reach_plan_service_proto_rawDesc = "" +
	...
	"\x1bconversion_rate_suggestions\x18\x01 \x03(\v2;.google.ads.googleads.v19.services.ConversionRateSuggestionR\x19conversionRateSuggestions\"\x8d\x02\n" +
	"\x18ConversionRateSuggestion\x12\x91\x01\n" +
	"\x15conversion_rate_model\x18\x01 \x01(\x0e2].google.ads.googleads.v19.enums.ReachPlanConversionRateModelEnum.ReachPlanConversionRateModelR\x13conversionRateModel\x124\n" +
	"\x16plannable_product_code\x18\x02 \x01(\tR\x14plannableProductCode\x12'\n" +
	"\x0fconversion_rate\x18\x03 \x01(\x01R\x0econversionRate\"\x1f\n" +
	"\x1dListPlannableLocationsRequest\"\x87\x01\n" +
	"\x1eListPlannableLocationsResponse\x12e\n" +
	"\x13plannable_locations\x18\x01 \x03(\v24.google.ads.googleads.v19.services.PlannableLocationR\x12plannableLocations\"\x8d\x02\n" +
	...
	"\x15plannable_location_id\x18\x02 \x01(\tB\x03\xe0A\x02R\x13plannableLocationId\"~\n" +
	"\x1dListPlannableProductsResponse\x12]\n" +
	"\x10product_metadata\x18\x01 \x03(\v22.google.ads.googleads.v19.services.ProductMetadataR\x0fproductMetadata\"\x85\x02\n" +
	...
	"\x13plannable_targeting\x18\x02 \x01(\v25.google.ads.googleads.v19.services.PlannableTargetingR\x12plannableTargetingB\x19\n" +
	"\x17_plannable_product_code\"\xc9\x04\n" +
	"\x12PlannableTargeting\x12f\n" +
	"\n" +
	"age_ranges\x18\x01 \x03(\x0e2G.google.ads.googleads.v19.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRangeR\tageRanges\x12E\n" +
	"\agenders\x18\x02 \x03(\v2+.google.ads.googleads.v19.common.GenderInfoR\agenders\x12E\n" +
	"\adevices\x18\x03 \x03(\v2+.google.ads.googleads.v19.common.DeviceInfoR\adevices\x12a\n" +
	"\bnetworks\x18\x04 \x03(\x0e2E.google.ads.googleads.v19.enums.ReachPlanNetworkEnum.ReachPlanNetworkR\bnetworks\x12l\n" +
	"\x16youtube_select_lineups\x18\x05 \x03(\v26.google.ads.googleads.v19.services.YouTubeSelectLineUpR\x14youtubeSelectLineups\x12l\n" +
	"\x11surface_targeting\x18\x06 \x01(\v2?.google.ads.googleads.v19.services.SurfaceTargetingCombinationsR\x10surfaceTargeting\"\x8e\b\n" +
	"\x1cGenerateReachForecastRequest\x12$\n" +
	"\vcustomer_id\x18\x01 \x01(\tB\x03\xe0A\x02R\n" +
	"customerId\x12(\n" +
	"\rcurrency_code\x18\t \x01(\tH\x00R\fcurrencyCode\x88\x01\x01\x12e\n" +
	"\x11campaign_duration\x18\x03 \x01(\v23.google.ads.googleads.v19.services.CampaignDurationB\x03\xe0A\x02R\x10campaignDuration\x125\n" +
	"\x14cookie_frequency_cap\x18\n" +
	" \x01(\x05H\x01R\x12cookieFrequencyCap\x88\x01\x01\x12p\n" +
	"\x1ccookie_frequency_cap_setting\x18\b \x01(\v2/.google.ads.googleads.v19.services.FrequencyCapR\x19cookieFrequencyCapSetting\x12;\n" +
	"\x17min_effective_frequency\x18\v \x01(\x05H\x02R\x15minEffectiveFrequency\x88\x01\x01\x12{\n" +
	"\x19effective_frequency_limit\x18\f \x01(\v2:.google.ads.googleads.v19.services.EffectiveFrequencyLimitH\x03R\x17effectiveFrequencyLimit\x88\x01\x01\x12J\n" +
	"\ttargeting\x18\x06 \x01(\v2,.google.ads.googleads.v19.services.TargetingR\ttargeting\x12a\n" +
	"\x10planned_products\x18\a \x03(\v21.google.ads.googleads.v19.services.PlannedProductB\x03\xe0A\x02R\x0fplannedProducts\x12p\n" +
	"\x17forecast_metric_options\x18\r \x01(\v28.google.ads.googleads.v19.services.ForecastMetricOptionsR\x15forecastMetricOptions\x125\n" +
	"\x14customer_reach_group\x18\x0e \x01(\tH\x04R\x12customerReachGroup\x88\x01\x01B\x10\n" +
	...
	"\ttime_unit\x18\x02 \x01(\x0e2M.google.ads.googleads.v19.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnitB\x03\xe0A\x02R\btimeUnit\"\xce\x04\n" +
	"\tTargeting\x127\n" +
	...
	"\tage_range\x18\x02 \x01(\x0e2G.google.ads.googleads.v19.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRangeR\bageRange\x12E\n" +
	"\agenders\x18\x03 \x03(\v2+.google.ads.googleads.v19.common.GenderInfoR\agenders\x12E\n" +
	"\adevices\x18\x04 \x03(\v2+.google.ads.googleads.v19.common.DeviceInfoR\adevices\x12_\n" +
	"\anetwork\x18\x05 \x01(\x0e2E.google.ads.googleads.v19.enums.ReachPlanNetworkEnum.ReachPlanNetworkR\anetwork\x12c\n" +
	"\x12audience_targeting\x18\a \x01(\v24.google.ads.googleads.v19.services.AudienceTargetingR\x11audienceTargetingB\x18\n" +
	...
	"\n" +
	"date_range\x18\x03 \x01(\v2*.google.ads.googleads.v19.common.DateRangeR\tdateRangeB\x13\n" +
	...
	"\x1aadvanced_product_targeting\x18\x05 \x01(\v2;.google.ads.googleads.v19.services.AdvancedProductTargetingR\x18advancedProductTargetingB\x19\n" +
	"\x17_plannable_product_codeB\x10\n" +
	"\x0e_budget_microsB\x12\n" +
	"\x10_conversion_rate\"\xe8\x01\n" +
	"\x1dGenerateReachForecastResponse\x12w\n" +
	"\x1aon_target_audience_metrics\x18\x01 \x01(\v2:.google.ads.googleads.v19.services.OnTargetAudienceMetricsR\x17onTargetAudienceMetrics\x12N\n" +
	"\vreach_curve\x18\x02 \x01(\v2-.google.ads.googleads.v19.services.ReachCurveR\n" +
	"reachCurve\"g\n" +
	"\n" +
	"ReachCurve\x12Y\n" +
	"\x0freach_forecasts\x18\x01 \x03(\v20.google.ads.googleads.v19.services.ReachForecastR\x0ereachForecasts\"\x81\x02\n" +
	"\rReachForecast\x12\x1f\n" +
	"\vcost_micros\x18\x05 \x01(\x03R\n" +
	"costMicros\x12G\n" +
	"\bforecast\x18\x02 \x01(\v2+.google.ads.googleads.v19.services.ForecastR\bforecast\x12\x85\x01\n" +
	"\x1fplanned_product_reach_forecasts\x18\x04 \x03(\v2>.google.ads.googleads.v19.services.PlannedProductReachForecastR\x1cplannedProductReachForecasts\"\xb2\a\n" +
	"\bForecast\x12+\n" +
	...
	" \x03(\v2>.google.ads.googleads.v19.services.EffectiveFrequencyBreakdownR\x1ceffectiveFrequencyBreakdowns\x128\n" +
	...
	"costMicros\x12s\n" +
	"\x18planned_product_forecast\x18\x03 \x01(\v29.google.ads.googleads.v19.services.PlannedProductForecastR\x16plannedProductForecast\"\x99\x06\n" +
	...
	"\x0einclude_coview\x18\x01 \x01(\bR\rincludeCoview\"k\n" +
	"\x11AudienceTargeting\x12V\n" +
	"\ruser_interest\x18\x01 \x03(\v21.google.ads.googleads.v19.common.UserInterestInfoR\fuserInterest\"\x8f\x03\n" +
	"\x18AdvancedProductTargeting\x12q\n" +
	"\x1asurface_targeting_settings\x18\x02 \x01(\v23.google.ads.googleads.v19.services.SurfaceTargetingR\x18surfaceTargetingSettings\x12v\n" +
	"\x19target_frequency_settings\x18\x03 \x01(\v2:.google.ads.googleads.v19.services.TargetFrequencySettingsR\x17targetFrequencySettings\x12r\n" +
	"\x17youtube_select_settings\x18\x01 \x01(\v28.google.ads.googleads.v19.services.YouTubeSelectSettingsH\x00R\x15youtubeSelectSettingsB\x14\n" +
	...
	"\x11default_targeting\x18\x01 \x01(\v23.google.ads.googleads.v19.services.SurfaceTargetingR\x10defaultTargeting\x12}\n" +
	" available_targeting_combinations\x18\x02 \x03(\v23.google.ads.googleads.v19.services.SurfaceTargetingR\x1eavailableTargetingCombinations\"u\n" +
	"\x10SurfaceTargeting\x12a\n" +
	"\bsurfaces\x18\x01 \x03(\x0e2E.google.ads.googleads.v19.enums.ReachPlanSurfaceEnum.ReachPlanSurfaceR\bsurfaces\"\xc0\x01\n" +
	"\x17TargetFrequencySettings\x12u\n" +
	"\ttime_unit\x18\x01 \x01(\x0e2S.google.ads.googleads.v19.enums.TargetFrequencyTimeUnitEnum.TargetFrequencyTimeUnitB\x03\xe0A\x02R\btimeUnit\x12.\n" +
	"\x10target_frequency\x18\x02 \x01(\x05B\x03\xe0A\x02R\x0ftargetFrequency2\xe6\a\n" +
	"\x10ReachPlanService\x12\xd7\x01\n" +
	"\x17GenerateConversionRates\x12A.google.ads.googleads.v19.services.GenerateConversionRatesRequest\x1aB.google.ads.googleads.v19.services.GenerateConversionRatesResponse\"5\xdaA\vcustomer_id\x82\xd3\xe4\x93\x02!:\x01*\"\x1c/v19:generateConversionRates\x12\xc5\x01\n" +
	"\x16ListPlannableLocations\x12@.google.ads.googleads.v19.services.ListPlannableLocationsRequest\x1aA.google.ads.googleads.v19.services.ListPlannableLocationsResponse\"&\x82\xd3\xe4\x93\x02 :\x01*\"\x1b/v19:listPlannableLocations\x12\xd9\x01\n" +
	"\x15ListPlannableProducts\x12?.google.ads.googleads.v19.services.ListPlannableProductsRequest\x1a@.google.ads.googleads.v19.services.ListPlannableProductsResponse\"=\xdaA\x15plannable_location_id\x82\xd3\xe4\x93\x02\x1f:\x01*\"\x1a/v19:listPlannableProducts\x12\x8c\x02\n" +
	"\x15GenerateReachForecast\x12?.google.ads.googleads.v19.services.GenerateReachForecastRequest\x1a@.google.ads.googleads.v19.services.GenerateReachForecastResponse\"p\xdaA.customer_id,campaign_duration,planned_products\x82\xd3\xe4\x93\x029:\x01*\"4/v19/customers/{customer_id=*}:generateReachForecast\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x81\x02\n" +
	"%com.google.ads.googleads.v19.servicesB\x15ReachPlanServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
