...
func init() {
	proto.RegisterType((*GetCampaignBudgetRequest)(nil), "google.ads.googleads.v9.services.GetCampaignBudgetRequest")
	proto.RegisterType((*MutateCampaignBudgetsRequest)(nil), "google.ads.googleads.v9.services.MutateCampaignBudgetsRequest")
	proto.RegisterType((*CampaignBudgetOperation)(nil), "google.ads.googleads.v9.services.CampaignBudgetOperation")
	proto.RegisterType((*MutateCampaignBudgetsResponse)(nil), "google.ads.googleads.v9.services.MutateCampaignBudgetsResponse")
	proto.RegisterType((*MutateCampaignBudgetResult)(nil), "google.ads.googleads.v9.services.MutateCampaignBudgetResult")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/campaign_budget_service.proto", fileDescriptor_34b8b6a01eeaad93)
}
