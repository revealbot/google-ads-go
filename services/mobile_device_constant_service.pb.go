...
func init() {
	proto.RegisterType((*GetMobileDeviceConstantRequest)(nil), "google.ads.googleads.v9.services.GetMobileDeviceConstantRequest")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/mobile_device_constant_service.proto", fileDescriptor_b4998404df0bc53d)
}
