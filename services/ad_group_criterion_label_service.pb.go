...
var file_services_ad_group_criterion_label_service_proto_rawDesc = string([]byte{
	...
	0x61, 0x64, 0x73, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x61, 0x64, 0x73, 0x2e, 0x76, 0x32,
	0x32, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x21, 0x41, 0x64, 0x47, 0x72,
	0x6f, 0x75, 0x70, 0x43, 0x72, 0x69, 0x74, 0x65, 0x72, 0x69, 0x6f, 0x6e, 0x4c, 0x61, 0x62, 0x65,
...
var (
	...
	file_services_ad_group_criterion_label_service_proto_rawDescData []byte
)
...
func file_services_ad_group_criterion_label_service_proto_rawDescGZIP() []byte {
	file_services_ad_group_criterion_label_service_proto_rawDescOnce.Do(func() {
		file_services_ad_group_criterion_label_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_services_ad_group_criterion_label_service_proto_rawDesc), len(file_services_ad_group_criterion_label_service_proto_rawDesc)))
	})
...
var file_services_ad_group_criterion_label_service_proto_goTypes = []any{
	(*MutateAdGroupCriterionLabelsRequest)(nil),  // 0: google.ads.googleads.v22.services.MutateAdGroupCriterionLabelsRequest
	(*AdGroupCriterionLabelOperation)(nil),       // 1: google.ads.googleads.v22.services.AdGroupCriterionLabelOperation
	(*MutateAdGroupCriterionLabelsResponse)(nil), // 2: google.ads.googleads.v22.services.MutateAdGroupCriterionLabelsResponse
	(*MutateAdGroupCriterionLabelResult)(nil),    // 3: google.ads.googleads.v22.services.MutateAdGroupCriterionLabelResult
	(*resources.AdGroupCriterionLabel)(nil),      // 4: google.ads.googleads.v22.resources.AdGroupCriterionLabel
	(*status.Status)(nil),                        // 5: google.rpc.Status
}
var file_services_ad_group_criterion_label_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v22.services.MutateAdGroupCriterionLabelsRequest.operations:type_name -> google.ads.googleads.v22.services.AdGroupCriterionLabelOperation
	4, // 1: google.ads.googleads.v22.services.AdGroupCriterionLabelOperation.create:type_name -> google.ads.googleads.v22.resources.AdGroupCriterionLabel
	5, // 2: google.ads.googleads.v22.services.MutateAdGroupCriterionLabelsResponse.partial_failure_error:type_name -> google.rpc.Status
	3, // 3: google.ads.googleads.v22.services.MutateAdGroupCriterionLabelsResponse.results:type_name -> google.ads.googleads.v22.services.MutateAdGroupCriterionLabelResult
	0, // 4: google.ads.googleads.v22.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:input_type -> google.ads.googleads.v22.services.MutateAdGroupCriterionLabelsRequest
	2, // 5: google.ads.googleads.v22.services.AdGroupCriterionLabelService.MutateAdGroupCriterionLabels:output_type -> google.ads.googleads.v22.services.MutateAdGroupCriterionLabelsResponse
...
func file_services_ad_group_criterion_label_service_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_services_ad_group_criterion_label_service_proto_rawDesc), len(file_services_ad_group_criterion_label_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
