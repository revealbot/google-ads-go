...
func init() {
	proto.RegisterType((*GetCustomerClientRequest)(nil), "google.ads.googleads.v9.services.GetCustomerClientRequest")
}

func init() {
	proto.RegisterFile("google/ads/googleads/v9/services/customer_client_service.proto", fileDescriptor_2b33c9cfe3e4a708)
}
