...
const file_services_conversion_custom_variable_service_proto_rawDesc = "" +
	"\n" +
	...
	"customerId\x12i\n" +
	"\n" +
	"operations\x18\x02 \x03(\v2D.google.ads.googleads.v19.services.ConversionCustomVariableOperationB\x03\xe0A\x02R\n" +
	"operations\x12'\n" +
	"\x0fpartial_failure\x18\x03 \x01(\bR\x0epartialFailure\x12#\n" +
	"\rvalidate_only\x18\x04 \x01(\bR\fvalidateOnly\x12\x7f\n" +
	"\x15response_content_type\x18\x05 \x01(\x0e2K.google.ads.googleads.v19.enums.ResponseContentTypeEnum.ResponseContentTypeR\x13responseContentType\"\x9d\x02\n" +
	"!ConversionCustomVariableOperation\x12;\n" +
	"\vupdate_mask\x18\x03 \x01(\v2\x1a.google.protobuf.FieldMaskR\n" +
	"updateMask\x12V\n" +
	"\x06create\x18\x01 \x01(\v2<.google.ads.googleads.v19.resources.ConversionCustomVariableH\x00R\x06create\x12V\n" +
	"\x06update\x18\x02 \x01(\v2<.google.ads.googleads.v19.resources.ConversionCustomVariableH\x00R\x06updateB\v\n" +
	"\toperation\"\xd4\x01\n" +
	...
	"\aresults\x18\x02 \x03(\v2G.google.ads.googleads.v19.services.MutateConversionCustomVariableResultR\aresults\"\xff\x01\n" +
	...
	"\x1aconversion_custom_variable\x18\x02 \x01(\v2<.google.ads.googleads.v19.resources.ConversionCustomVariableR\x18conversionCustomVariable2\x88\x03\n" +
	"\x1fConversionCustomVariableService\x12\x9d\x02\n" +
	"\x1fMutateConversionCustomVariables\x12I.google.ads.googleads.v19.services.MutateConversionCustomVariablesRequest\x1aJ.google.ads.googleads.v19.services.MutateConversionCustomVariablesResponse\"c\xdaA\x16customer_id,operations\x82\xd3\xe4\x93\x02D:\x01*\"?/v19/customers/{customer_id=*}/conversionCustomVariables:mutate\x1aE\xcaA\x18googleads.googleapis.com\xd2A'https://www.googleapis.com/auth/adwordsB\x90\x02\n" +
	"%com.google.ads.googleads.v19.servicesB$ConversionCustomVariableServiceProtoP\x01ZIgithub.com/revealbot/google-ads-go/services;services\xa2\x02\x03GAA\xaa\x02!Google.Ads.GoogleAds.V19.Services\xca\x02!Google\\Ads\\GoogleAds\\V19\\Services\xea\x02%Google::Ads::GoogleAds::V19::Servicesb\x06proto3"
