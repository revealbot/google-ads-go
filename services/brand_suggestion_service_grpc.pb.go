...
func (c *brandSuggestionServiceClient) SuggestBrands(ctx context.Context, in *SuggestBrandsRequest, opts ...grpc.CallOption) (*SuggestBrandsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/google.ads.googleads.v18.services.BrandSuggestionService/SuggestBrands", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _BrandSuggestionService_SuggestBrands_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/google.ads.googleads.v18.services.BrandSuggestionService/SuggestBrands",
	}
...
var BrandSuggestionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "google.ads.googleads.v18.services.BrandSuggestionService",
	...
	Metadata: "google/ads/googleads/v18/services/brand_suggestion_service.proto",
}
