...
// Request message for
// [CustomInterestService.MutateCustomInterests][google.ads.googleads.v25.services.CustomInterestService.MutateCustomInterests].
...
func (x *MutateCustomInterestsRequest) Reset() {
	*x = MutateCustomInterestsRequest{}
	mi := &file_google_ads_googleads_v25_services_custom_interest_service_proto_msgTypes[0]
...
func (*MutateCustomInterestsRequest) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescGZIP(), []int{0}
}
...
func (x *CustomInterestOperation) Reset() {
	*x = CustomInterestOperation{}
	mi := &file_google_ads_googleads_v25_services_custom_interest_service_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CustomInterestOperation) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescGZIP(), []int{1}
}
...
func (x *MutateCustomInterestsResponse) Reset() {
	*x = MutateCustomInterestsResponse{}
	mi := &file_google_ads_googleads_v25_services_custom_interest_service_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomInterestsResponse) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescGZIP(), []int{2}
}
...
func (x *MutateCustomInterestResult) Reset() {
	*x = MutateCustomInterestResult{}
	mi := &file_google_ads_googleads_v25_services_custom_interest_service_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*MutateCustomInterestResult) Descriptor() ([]byte, []int) {
	return file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescGZIP(), []int{3}
}
...
var File_google_ads_googleads_v25_services_custom_interest_service_proto protoreflect.FileDescriptor

var file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDesc = string([]byte{
	...
	0xd3, 0xe4, 0x93, 0x02, 0x3a, 0x3a, 0x01, 0x2a, 0x22, 0x35, 0x2f, 0x76, 0x32, 0x35, 0x2f, 0x63,
...
var (
	file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescOnce sync.Once
	file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescData []byte
)

func file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescGZIP() []byte {
	file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescOnce.Do(func() {
		file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDesc)))
	})
	return file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDescData
}

var file_google_ads_googleads_v25_services_custom_interest_service_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_google_ads_googleads_v25_services_custom_interest_service_proto_goTypes = []any{
	(*MutateCustomInterestsRequest)(nil),  // 0: google.ads.googleads.v25.services.MutateCustomInterestsRequest
	(*CustomInterestOperation)(nil),       // 1: google.ads.googleads.v25.services.CustomInterestOperation
	(*MutateCustomInterestsResponse)(nil), // 2: google.ads.googleads.v25.services.MutateCustomInterestsResponse
	(*MutateCustomInterestResult)(nil),    // 3: google.ads.googleads.v25.services.MutateCustomInterestResult
	(*fieldmaskpb.FieldMask)(nil),         // 4: google.protobuf.FieldMask
	(*resources.CustomInterest)(nil),      // 5: google.ads.googleads.v25.resources.CustomInterest
}
var file_google_ads_googleads_v25_services_custom_interest_service_proto_depIdxs = []int32{
	1, // 0: google.ads.googleads.v25.services.MutateCustomInterestsRequest.operations:type_name -> google.ads.googleads.v25.services.CustomInterestOperation
	4, // 1: google.ads.googleads.v25.services.CustomInterestOperation.update_mask:type_name -> google.protobuf.FieldMask
	5, // 2: google.ads.googleads.v25.services.CustomInterestOperation.create:type_name -> google.ads.googleads.v25.resources.CustomInterest
	5, // 3: google.ads.googleads.v25.services.CustomInterestOperation.update:type_name -> google.ads.googleads.v25.resources.CustomInterest
	3, // 4: google.ads.googleads.v25.services.MutateCustomInterestsResponse.results:type_name -> google.ads.googleads.v25.services.MutateCustomInterestResult
	0, // 5: google.ads.googleads.v25.services.CustomInterestService.MutateCustomInterests:input_type -> google.ads.googleads.v25.services.MutateCustomInterestsRequest
	2, // 6: google.ads.googleads.v25.services.CustomInterestService.MutateCustomInterests:output_type -> google.ads.googleads.v25.services.MutateCustomInterestsResponse
...
func init() { file_google_ads_googleads_v25_services_custom_interest_service_proto_init() }
func file_google_ads_googleads_v25_services_custom_interest_service_proto_init() {
	if File_google_ads_googleads_v25_services_custom_interest_service_proto != nil {
		return
	}
	file_google_ads_googleads_v25_services_custom_interest_service_proto_msgTypes[1].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDesc), len(file_google_ads_googleads_v25_services_custom_interest_service_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_google_ads_googleads_v25_services_custom_interest_service_proto_goTypes,
		DependencyIndexes: file_google_ads_googleads_v25_services_custom_interest_service_proto_depIdxs,
		MessageInfos:      file_google_ads_googleads_v25_services_custom_interest_service_proto_msgTypes,
	}.Build()
	File_google_ads_googleads_v25_services_custom_interest_service_proto = out.File
	file_google_ads_googleads_v25_services_custom_interest_service_proto_goTypes = nil
	file_google_ads_googleads_v25_services_custom_interest_service_proto_depIdxs = nil
}
